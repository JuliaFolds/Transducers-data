...
| `["collect", "filter-missing"]`                                |                1.47 (5%) :x: |                   1.00 (1%)  |
| `["filter_sum", "1000", "RandomFloats", "withinit", "naive"]`  |                1.55 (5%) :x: |                   1.00 (1%)  |
...
Platform Info:
  ...
  CPU: AMD EPYC 7763 64-Core Processor: 
       ...
       #1  3230 MHz       1849 s          0 s        111 s       4586 s          0 s
       #2  3237 MHz       2418 s          0 s         97 s       4026 s          0 s
       #3  3243 MHz        438 s          0 s         74 s       6042 s          0 s
       #4  3225 MHz       1707 s          0 s         93 s       4724 s          0 s
       
  Memory: 15.620681762695312 GB (8190.0859375 MB free)
  Uptime: 662.16 sec
...
Platform Info:
  ...
  CPU: AMD EPYC 7763 64-Core Processor: 
              speed         user         nice          sys         idle          irq
       #1  3242 MHz       3003 s          0 s        124 s       6012 s          0 s
       #2  3252 MHz       3698 s          0 s        125 s       5312 s          0 s
       #3  3241 MHz        566 s          0 s         92 s       8490 s          0 s
       #4  3246 MHz       1784 s          0 s        105 s       7228 s          0 s
       
  Memory: 15.620681762695312 GB (8064.83203125 MB free)
  Uptime: 921.65 sec
...
| `["cartesian", "copyto!", "xf"]`                               |   1.618 μs (5%) |         |                 |             |
| `["cat", "base"]`                                              |   1.709 μs (5%) |         |                 |             |
| `["cat", "xf"]`                                                |   1.016 μs (5%) |         |                 |             |
| `["collect", "filter-missing"]`                                | 561.506 ns (5%) |         |   9.94 KiB (1%) |           1 |
| `["collect", "identity-float"]`                                |   2.781 μs (5%) |         |  78.17 KiB (1%) |           2 |
| `["collect", "identity-union"]`                                | 103.504 μs (5%) |         | 400.53 KiB (1%) |       10003 |
...
| `["findall", "base"]`                                          | 108.393 μs (5%) |         | 797.20 KiB (1%) |           8 |
| `["findall", "xf-array"]`                                      | 986.356 μs (5%) |         |   2.94 MiB (1%) |       96426 |
| `["findall", "xf-iter"]`                                       | 690.382 μs (5%) |         |   1.83 MiB (1%) |          14 |
...
| `["groupby", "sum", "sac"]`                                    |  93.735 μs (5%) |         |   1.64 KiB (1%) |          11 |
| `["groupby", "sum", "xf-with-init"]`                           |  95.930 μs (5%) |         |   1.05 KiB (1%) |           9 |
...
| `["missing_argmax", "rf"]`                                     | 899.116 ns (5%) |         |                 |             |
| `["missing_argmax", "xf"]`                                     | 781.349 ns (5%) |         |   32 bytes (1%) |           1 |
| `["missing_dot", "equiv"]`                                     |   1.891 μs (5%) |         |   48 bytes (1%) |           3 |
| `["missing_dot", "man"]`                                       | 856.015 ns (5%) |         |   48 bytes (1%) |           3 |
| `["missing_dot", "naive"]`                                     |   2.746 μs (5%) |         |   48 bytes (1%) |           3 |
| `["missing_dot", "rf"]`                                        | 862.234 ns (5%) |         |   48 bytes (1%) |           3 |
| `["missing_dot", "rf_nota"]`                                   |   1.923 μs (5%) |         |   48 bytes (1%) |           3 |
| `["missing_dot", "xf"]`                                        |  67.596 μs (5%) |         |  72.31 KiB (1%) |        3750 |
| `["missing_dot", "xf_nota"]`                                   |  67.507 μs (5%) |         |  72.06 KiB (1%) |        3740 |
| `["overhead", "foldl"]`                                        |   3.095 ns (5%) |         |                 |             |
| `["overhead", "reduce_basecase"]`                              |  79.768 ns (5%) |         |   16 bytes (1%) |           1 |
...
| `["sum_transpose", "30", "withinit", "iter"]`                  | 867.404 ns (5%) |         |                 |             |
| `["sum_transpose", "30", "withinit", "man"]`                   | 805.121 ns (5%) |         |                 |             |
| `["sum_transpose", "30", "withinit", "xf"]`                    | 805.681 ns (5%) |         |                 |             |
| `["teerf_filter", "noinit"]`                                   | 288.734 ns (5%) |         |   80 bytes (1%) |           3 |
| `["teerf_filter", "withinit"]`                                 | 173.147 ns (5%) |         |                 |             |
...
## Job Properties
* Time of benchmark: 25 Nov 2025 - 02:12
...
| `["cartesian", "copyto!", "xf"]`                               |   1.649 μs (5%) |         |                 |             |
| `["cat", "base"]`                                              |   1.702 μs (5%) |         |                 |             |
| `["cat", "xf"]`                                                |   1.015 μs (5%) |         |                 |             |
| `["collect", "filter-missing"]`                                | 381.739 ns (5%) |         |   9.94 KiB (1%) |           1 |
| `["collect", "identity-float"]`                                |   2.721 μs (5%) |         |  78.17 KiB (1%) |           2 |
| `["collect", "identity-union"]`                                | 104.255 μs (5%) |         | 400.53 KiB (1%) |       10003 |
...
| `["filter_sum", "1000", "RandomFloats", "withinit", "base"]`   |   1.209 μs (5%) |         |                 |             |
| `["filter_sum", "1000", "RandomFloats", "withinit", "naive"]`  | 516.000 ns (5%) |         |                 |             |
| `["filter_sum", "1000", "RandomFloats", "withinit", "xf"]`     |   1.214 μs (5%) |         |                 |             |
| `["filter_sum", "1000", "UnitRange", "noinit", "base"]`        | 626.199 ns (5%) |         |                 |             |
| `["filter_sum", "1000", "UnitRange", "noinit", "naive"]`       | 626.842 ns (5%) |         |                 |             |
| `["filter_sum", "1000", "UnitRange", "noinit", "xf"]`          | 164.803 ns (5%) |         |                 |             |
...
| `["findall", "xf-array"]`                                      | 989.732 μs (5%) |         |   2.94 MiB (1%) |       96426 |
| `["findall", "xf-iter"]`                                       | 694.710 μs (5%) |         |   1.83 MiB (1%) |          14 |
...
| `["gemm", "mul", "xf", "true", "32"]`                          |   4.789 μs (5%) |         |   80 bytes (1%) |           3 |
| `["gemm", "mul", "xf", "true", "8"]`                           | 360.000 ns (5%) |         |   80 bytes (1%) |           3 |
| `["groupby", "sum", "sac"]`                                    |   6.768 ms (5%) |         |  13.14 KiB (1%) |         103 |
| `["groupby", "sum", "xf-with-init"]`                           | 100.818 μs (5%) |         |   1.05 KiB (1%) |           9 |
...
| `["missing_argmax", "rf"]`                                     | 904.721 ns (5%) |         |                 |             |
| `["missing_argmax", "xf"]`                                     | 757.337 ns (5%) |         |   32 bytes (1%) |           1 |
| `["missing_dot", "equiv"]`                                     |   1.789 μs (5%) |         |   48 bytes (1%) |           3 |
| `["missing_dot", "man"]`                                       | 854.838 ns (5%) |         |   48 bytes (1%) |           3 |
| `["missing_dot", "naive"]`                                     |   2.770 μs (5%) |         |   48 bytes (1%) |           3 |
| `["missing_dot", "rf"]`                                        | 906.688 ns (5%) |         |   48 bytes (1%) |           3 |
| `["missing_dot", "rf_nota"]`                                   |   1.881 μs (5%) |         |   48 bytes (1%) |           3 |
| `["missing_dot", "xf"]`                                        |  68.017 μs (5%) |         |  72.23 KiB (1%) |        3746 |
| `["missing_dot", "xf_nota"]`                                   |  67.526 μs (5%) |         |  72.14 KiB (1%) |        3744 |
| `["overhead", "foldl"]`                                        |   2.785 ns (5%) |         |                 |             |
| `["overhead", "reduce_basecase"]`                              |  75.424 ns (5%) |         |   16 bytes (1%) |           1 |
...
| `["teerf_filter", "noinit"]`                                   | 298.269 ns (5%) |         |   80 bytes (1%) |           3 |
