...
## Job Properties
* Time of benchmarks:
    - Target: 19 Jun 2025 - 02:11
    - Baseline: 19 Jun 2025 - 02:16
* Package commits:
    - Target: d00cbf2
    - Baseline: 2a51f8d
* Julia commits:
...
| `["collect", "filter-missing"]`                                | 0.63 (5%) :white_check_mark: |                   1.00 (1%)  |
...
Platform Info:
  ...
  CPU: AMD EPYC 7763 64-Core Processor: 
       ...
       #1  3239 MHz       1146 s          0 s         69 s       8774 s          0 s
       #2  3240 MHz        367 s          0 s         72 s       9552 s          0 s
       #3  3201 MHz       2745 s          0 s         98 s       7151 s          0 s
       #4  3244 MHz       2166 s          0 s        100 s       7726 s          0 s
       
  Memory: 15.620769500732422 GB (12900.3984375 MB free)
  Uptime: 1001.44 sec
...
Platform Info:
  ...
  CPU: AMD EPYC 7763 64-Core Processor: 
              speed         user         nice          sys         idle          irq
       #1  3244 MHz       1402 s          0 s         84 s      11114 s          0 s
       #2  3251 MHz       1823 s          0 s        112 s      10669 s          0 s
       #3  3242 MHz       3282 s          0 s        116 s       9207 s          0 s
       #4  3241 MHz       2563 s          0 s        108 s       9932 s          0 s
       
  Memory: 15.620769500732422 GB (12886.9609375 MB free)
  Uptime: 1262.79 sec
...
## Job Properties
* Time of benchmark: 19 Jun 2025 - 02:11
...
| `["cat", "base"]`                                              |   1.661 μs (5%) |         |                 |             |
| `["cat", "xf"]`                                                |   1.015 μs (5%) |         |                 |             |
| `["collect", "filter-missing"]`                                | 391.486 ns (5%) |         |   9.94 KiB (1%) |           1 |
...
| `["filter_sum", "10000", "RandomFloats", "withinit", "naive"]` |   7.992 μs (5%) |         |                 |             |
...
| `["findall", "xf-iter"]`                                       | 694.008 μs (5%) |         |   1.83 MiB (1%) |          14 |
...
| `["gemm", "fusedmul", "xf", "16"]`                             |   2.345 ms (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "fusedmul", "xf", "2"]`                              | 288.630 μs (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "fusedmul", "xf", "32"]`                             |   4.751 ms (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "fusedmul", "xf", "8"]`                              |   1.172 ms (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "mul", "linalg", "256"]`                             | 775.961 μs (5%) |         |                 |             |
| `["gemm", "mul", "linalg", "32"]`                              |   2.839 μs (5%) |         |                 |             |
| `["gemm", "mul", "linalg", "8"]`                               | 179.096 ns (5%) |         |                 |             |
| `["gemm", "mul", "man", "false", "256"]`                       |   2.055 ms (5%) |         |                 |             |
| `["gemm", "mul", "man", "false", "32"]`                        |   5.399 μs (5%) |         |                 |             |
| `["gemm", "mul", "man", "false", "8"]`                         | 291.358 ns (5%) |         |                 |             |
| `["gemm", "mul", "man", "ivdep", "256"]`                       |   2.051 ms (5%) |         |                 |             |
| `["gemm", "mul", "man", "ivdep", "32"]`                        |   4.536 μs (5%) |         |                 |             |
| `["gemm", "mul", "man", "ivdep", "8"]`                         | 280.079 ns (5%) |         |                 |             |
...
| `["gemm", "mul", "xf", "false", "8"]`                          | 349.252 ns (5%) |         |   80 bytes (1%) |           3 |
...
| `["groupby", "sum", "xf-without-init"]`                        |  97.062 μs (5%) |         |   1.05 KiB (1%) |           9 |
| `["mapcat_eduction", "base"]`                                  |  31.268 μs (5%) |         |                 |             |
| `["mapcat_eduction", "xf-eduction"]`                           |   1.016 μs (5%) |         |                 |             |
| `["mapcat_eduction", "xf-xf"]`                                 |   1.015 μs (5%) |         |                 |             |
| `["missing_argmax", "man"]`                                    |   1.093 μs (5%) |         |                 |             |
| `["missing_argmax", "rf"]`                                     | 758.491 ns (5%) |         |                 |             |
| `["missing_argmax", "xf"]`                                     | 782.645 ns (5%) |         |   32 bytes (1%) |           1 |
| `["missing_dot", "equiv"]`                                     |   1.837 μs (5%) |         |   48 bytes (1%) |           3 |
| `["missing_dot", "man"]`                                       | 852.194 ns (5%) |         |   48 bytes (1%) |           3 |
| `["missing_dot", "naive"]`                                     |   2.770 μs (5%) |         |   48 bytes (1%) |           3 |
| `["missing_dot", "rf"]`                                        | 859.224 ns (5%) |         |   48 bytes (1%) |           3 |
| `["missing_dot", "rf_nota"]`                                   |   1.803 μs (5%) |         |   48 bytes (1%) |           3 |
| `["missing_dot", "xf"]`                                        |  68.007 μs (5%) |         |  72.33 KiB (1%) |        3750 |
| `["missing_dot", "xf_nota"]`                                   |  68.177 μs (5%) |         |  72.16 KiB (1%) |        3740 |
...
## Job Properties
* Time of benchmark: 19 Jun 2025 - 02:16
...
| `["cat", "base"]`                                              |   1.696 μs (5%) |         |                 |             |
| `["cat", "xf"]`                                                |   1.016 μs (5%) |         |                 |             |
| `["collect", "filter-missing"]`                                | 618.439 ns (5%) |         |   9.94 KiB (1%) |           1 |
| `["collect", "identity-float"]`                                |   3.515 μs (5%) |         |  78.17 KiB (1%) |           2 |
| `["collect", "identity-union"]`                                | 103.664 μs (5%) |         | 400.53 KiB (1%) |       10003 |
...
| `["filter_sum", "1000", "RandomFloats", "withinit", "naive"]`  | 698.525 ns (5%) |         |                 |             |
| `["filter_sum", "1000", "RandomFloats", "withinit", "xf"]`     |   1.210 μs (5%) |         |                 |             |
...
| `["filter_sum", "10000", "RandomFloats", "noinit", "xf"]`      |  12.343 μs (5%) |         |                 |             |
| `["filter_sum", "10000", "RandomFloats", "withinit", "base"]`  |  12.343 μs (5%) |         |                 |             |
| `["filter_sum", "10000", "RandomFloats", "withinit", "naive"]` |   8.195 μs (5%) |         |                 |             |
| `["filter_sum", "10000", "RandomFloats", "withinit", "xf"]`    |  12.343 μs (5%) |         |                 |             |
...
| `["findall", "xf-array"]`                                      | 988.779 μs (5%) |         |   2.94 MiB (1%) |       96426 |
| `["findall", "xf-iter"]`                                       | 694.148 μs (5%) |         |   1.83 MiB (1%) |          14 |
| `["gemm", "fusedmul", "blas", "16"]`                           |   2.447 ms (5%) |         |                 |             |
| `["gemm", "fusedmul", "blas", "2"]`                            |   1.688 ms (5%) |         |                 |             |
| `["gemm", "fusedmul", "blas", "32"]`                           |   3.963 ms (5%) |         |                 |             |
| `["gemm", "fusedmul", "blas", "8"]`                            |   1.742 ms (5%) |         |                 |             |
| `["gemm", "fusedmul", "xf", "16"]`                             |   2.409 ms (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "fusedmul", "xf", "2"]`                              | 323.575 μs (5%) |         |  192 bytes (1%) |           4 |
...
| `["groupby", "sum", "sac"]`                                    |   7.018 ms (5%) |         |  13.14 KiB (1%) |         103 |
| `["groupby", "sum", "xf-with-init"]`                           |  99.245 μs (5%) |         |   1.05 KiB (1%) |           9 |
| `["groupby", "sum", "xf-without-init"]`                        |  93.505 μs (5%) |         |   1.05 KiB (1%) |           9 |
| `["mapcat_eduction", "base"]`                                  |  31.799 μs (5%) |         |                 |             |
| `["mapcat_eduction", "xf-eduction"]`                           |   1.016 μs (5%) |         |                 |             |
| `["mapcat_eduction", "xf-xf"]`                                 |   1.015 μs (5%) |         |                 |             |
| `["missing_argmax", "man"]`                                    |   1.094 μs (5%) |         |                 |             |
| `["missing_argmax", "rf"]`                                     | 754.811 ns (5%) |         |                 |             |
| `["missing_argmax", "xf"]`                                     | 902.118 ns (5%) |         |   32 bytes (1%) |           1 |
...
| `["missing_dot", "rf"]`                                        | 854.433 ns (5%) |         |   48 bytes (1%) |           3 |
| `["missing_dot", "rf_nota"]`                                   |   1.903 μs (5%) |         |   48 bytes (1%) |           3 |
| `["missing_dot", "xf"]`                                        |  67.606 μs (5%) |         |  71.94 KiB (1%) |        3732 |
| `["missing_dot", "xf_nota"]`                                   |  67.677 μs (5%) |         |  72.27 KiB (1%) |        3748 |
| `["overhead", "foldl"]`                                        |   2.795 ns (5%) |         |                 |             |
...
| `["teerf_filter", "noinit"]`                                   | 293.945 ns (5%) |         |   80 bytes (1%) |           3 |
| `["teerf_filter", "withinit"]`                                 | 175.423 ns (5%) |         |                 |             |
