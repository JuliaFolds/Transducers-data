...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
       ...
       #1  2593 MHz        471 s          0 s        145 s       7635 s          0 s
       #2  2593 MHz       6765 s          0 s        172 s       1318 s          0 s
       
  Memory: 6.781211853027344 GB (3691.59375 MB free)
  Uptime: 831.55 sec
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
              speed         user         nice          sys         idle          irq
       #1  2593 MHz        606 s          0 s        170 s      10341 s          0 s
       #2  2593 MHz       9520 s          0 s        222 s       1390 s          0 s
       
  Memory: 6.781211853027344 GB (3527.3671875 MB free)
  Uptime: 1119.26 sec
...
| `["collect", "identity-union"]`                                | 145.602 μs (5%) |         | 679.41 KiB (1%) |       10010 |
...
| `["filter_sum", "1000", "UnitRange", "withinit", "base"]`      | 130.515 ns (5%) |         |                 |             |
...
| `["findall", "xf-array"]`                                      |   1.332 ms (5%) |         |   2.94 MiB (1%) |       96426 |
| `["findall", "xf-iter"]`                                       | 861.107 μs (5%) |         |   1.83 MiB (1%) |          14 |
...
| `["gemm", "fusedmul", "xf", "2"]`                              | 676.206 μs (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "fusedmul", "xf", "32"]`                             |  10.879 ms (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "fusedmul", "xf", "8"]`                              |   2.715 ms (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "mul", "linalg", "256"]`                             | 511.805 μs (5%) |         |                 |             |
| `["gemm", "mul", "linalg", "32"]`                              |   1.530 μs (5%) |         |                 |             |
| `["gemm", "mul", "linalg", "8"]`                               | 218.413 ns (5%) |         |                 |             |
| `["gemm", "mul", "man", "false", "256"]`                       |   3.168 ms (5%) |         |                 |             |
| `["gemm", "mul", "man", "false", "32"]`                        |   6.260 μs (5%) |         |                 |             |
| `["gemm", "mul", "man", "false", "8"]`                         | 470.408 ns (5%) |         |                 |             |
| `["gemm", "mul", "man", "ivdep", "256"]`                       |   3.128 ms (5%) |         |                 |             |
...
| `["gemm", "mul", "man", "true", "8"]`                          | 396.535 ns (5%) |         |                 |             |
| `["gemm", "mul", "xf", "false", "256"]`                        |   3.191 ms (5%) |         |   80 bytes (1%) |           3 |
...
| `["gemm", "mul", "xf", "ivdep", "8"]`                          | 504.145 ns (5%) |         |   80 bytes (1%) |           3 |
| `["gemm", "mul", "xf", "true", "256"]`                         |   3.147 ms (5%) |         |   80 bytes (1%) |           3 |
| `["gemm", "mul", "xf", "true", "32"]`                          |   6.100 μs (5%) |         |   80 bytes (1%) |           3 |
| `["gemm", "mul", "xf", "true", "8"]`                           | 444.393 ns (5%) |         |   80 bytes (1%) |           3 |
...
| `["missing_dot", "xf"]`                                        |  95.401 μs (5%) |         |  72.12 KiB (1%) |        3742 |
| `["missing_dot", "xf_nota"]`                                   |  96.601 μs (5%) |         |  72.23 KiB (1%) |        3745 |
...
| `["teerf_filter", "noinit"]`                                   | 377.941 ns (5%) |         |   80 bytes (1%) |           3 |
| `["teerf_filter", "withinit"]`                                 | 215.579 ns (5%) |         |                 |             |
...
| `["collect", "identity-union"]`                                | 145.901 μs (5%) |         | 679.41 KiB (1%) |       10010 |
...
| `["findall", "base"]`                                          | 141.401 μs (5%) |         | 797.20 KiB (1%) |           8 |
| `["findall", "xf-array"]`                                      |   1.347 ms (5%) |         |   2.94 MiB (1%) |       96426 |
| `["findall", "xf-iter"]`                                       | 862.108 μs (5%) |         |   1.83 MiB (1%) |          14 |
| `["gemm", "fusedmul", "blas", "16"]`                           |   2.802 ms (5%) |         |                 |             |
| `["gemm", "fusedmul", "blas", "2"]`                            |   2.137 ms (5%) |         |                 |             |
| `["gemm", "fusedmul", "blas", "32"]`                           |   3.417 ms (5%) |         |                 |             |
| `["gemm", "fusedmul", "blas", "8"]`                            |   2.247 ms (5%) |         |                 |             |
| `["gemm", "fusedmul", "xf", "16"]`                             |   5.439 ms (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "fusedmul", "xf", "2"]`                              | 695.106 μs (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "fusedmul", "xf", "32"]`                             |  10.859 ms (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "fusedmul", "xf", "8"]`                              |   2.707 ms (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "mul", "linalg", "256"]`                             | 509.403 μs (5%) |         |                 |             |
...
| `["groupby", "sum", "sac"]`                                    |   8.269 ms (5%) |         |  13.14 KiB (1%) |         103 |
| `["groupby", "sum", "xf-with-init"]`                           | 143.001 μs (5%) |         |   1.05 KiB (1%) |           9 |
| `["groupby", "sum", "xf-without-init"]`                        | 138.102 μs (5%) |         |   1.05 KiB (1%) |           9 |
...
| `["missing_dot", "naive"]`                                     |   2.945 μs (5%) |         |   16 bytes (1%) |           1 |
| `["missing_dot", "rf"]`                                        |   1.380 μs (5%) |         |   16 bytes (1%) |           1 |
| `["missing_dot", "rf_nota"]`                                   |   2.344 μs (5%) |         |   16 bytes (1%) |           1 |
| `["missing_dot", "xf"]`                                        |  97.101 μs (5%) |         |  72.00 KiB (1%) |        3736 |
| `["missing_dot", "xf_nota"]`                                   |  97.401 μs (5%) |         |  72.41 KiB (1%) |        3754 |
| `["overhead", "foldl"]`                                        |   3.300 ns (5%) |         |                 |             |
| `["overhead", "reduce_basecase"]`                              | 102.225 ns (5%) |         |   16 bytes (1%) |           1 |
...
| `["sum_transpose", "30", "withinit", "man"]`                   |   1.150 μs (5%) |         |                 |             |
| `["sum_transpose", "30", "withinit", "xf"]`                    |   1.150 μs (5%) |         |                 |             |
| `["teerf_filter", "noinit"]`                                   | 376.966 ns (5%) |         |   80 bytes (1%) |           3 |
| `["teerf_filter", "withinit"]`                                 | 218.654 ns (5%) |         |                 |             |
