...
## Job Properties
* Time of benchmarks:
    - Target: 15 Apr 2023 - 01:36
    - Baseline: 15 Apr 2023 - 01:41
* Package commits:
    - Target: da6383
    - Baseline: f8d0df
* Julia commits:
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
       ...
       #1  2593 MHz       5773 s          0 s        176 s       1965 s          0 s
       #2  2593 MHz       1567 s          0 s        142 s       6171 s          0 s
       
  Memory: 6.781211853027344 GB (3715.53125 MB free)
  Uptime: 795.89 sec
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
              speed         user         nice          sys         idle          irq
       #1  2593 MHz       8518 s          0 s        220 s       2074 s          0 s
       #2  2593 MHz       1741 s          0 s        168 s       8859 s          0 s
       
  Memory: 6.781211853027344 GB (3516.8359375 MB free)
  Uptime: 1085.78 sec
...
## Job Properties
* Time of benchmark: 15 Apr 2023 - 1:36
...
| `["collect", "identity-union"]`                                | 152.102 μs (5%) |         | 679.41 KiB (1%) |       10010 |
...
| `["filter_sum", "1000", "UnitRange", "withinit", "base"]`      | 137.373 ns (5%) |         |                 |             |
| `["filter_sum", "1000", "UnitRange", "withinit", "naive"]`     | 846.377 ns (5%) |         |                 |             |
| `["filter_sum", "1000", "UnitRange", "withinit", "xf"]`        | 137.824 ns (5%) |         |                 |             |
...
| `["findall", "base"]`                                          | 137.602 μs (5%) |         | 797.20 KiB (1%) |           8 |
| `["findall", "xf-array"]`                                      |   1.342 ms (5%) |         |   2.94 MiB (1%) |       96426 |
| `["findall", "xf-iter"]`                                       | 866.011 μs (5%) |         |   1.83 MiB (1%) |          14 |
...
| `["missing_dot", "xf"]`                                        |  95.502 μs (5%) |         |  72.14 KiB (1%) |        3744 |
| `["missing_dot", "xf_nota"]`                                   |  95.401 μs (5%) |         |  72.02 KiB (1%) |        3736 |
| `["overhead", "foldl"]`                                        |   3.700 ns (5%) |         |                 |             |
| `["overhead", "reduce_basecase"]`                              |  99.365 ns (5%) |         |   16 bytes (1%) |           1 |
| `["partition_by", "man"]`                                      |   2.556 ms (5%) |         |  480 bytes (1%) |           3 |
| `["partition_by", "xf"]`                                       |   2.729 ms (5%) |         |  592 bytes (1%) |           5 |
| `["set", "base"]`                                              |   4.191 ms (5%) |         |  49.14 KiB (1%) |          17 |
| `["set", "xf"]`                                                |   4.008 ms (5%) |         |  49.17 KiB (1%) |          19 |
...
## Job Properties
* Time of benchmark: 15 Apr 2023 - 1:41
...
| `["collect", "identity-union"]`                                | 148.702 μs (5%) |         | 679.41 KiB (1%) |       10010 |
| `["dict", "base"]`                                             |   3.764 ms (5%) |         |  92.45 KiB (1%) |          22 |
...
| `["filter_sum", "1000", "UnitRange", "withinit", "base"]`      | 132.115 ns (5%) |         |                 |             |
| `["filter_sum", "1000", "UnitRange", "withinit", "naive"]`     | 847.841 ns (5%) |         |                 |             |
| `["filter_sum", "1000", "UnitRange", "withinit", "xf"]`        | 138.835 ns (5%) |         |                 |             |
| `["filter_sum", "10000", "RandomFloats", "noinit", "base"]`    |  30.300 μs (5%) |         |                 |             |
...
| `["findall", "base"]`                                          | 136.602 μs (5%) |         | 797.20 KiB (1%) |           8 |
| `["findall", "xf-array"]`                                      |   1.348 ms (5%) |         |   2.94 MiB (1%) |       96426 |
| `["findall", "xf-iter"]`                                       | 872.411 μs (5%) |         |   1.83 MiB (1%) |          14 |
...
| `["gemm", "fusedmul", "xf", "2"]`                              | 682.409 μs (5%) |         |  192 bytes (1%) |           4 |
...
| `["groupby", "sum", "sac"]`                                    |   8.279 ms (5%) |         |  13.17 KiB (1%) |         104 |
...
| `["missing_dot", "xf"]`                                        |  96.501 μs (5%) |         |  72.00 KiB (1%) |        3736 |
| `["missing_dot", "xf_nota"]`                                   |  96.302 μs (5%) |         |  72.17 KiB (1%) |        3744 |
| `["overhead", "foldl"]`                                        |   3.700 ns (5%) |         |                 |             |
| `["overhead", "reduce_basecase"]`                              |  98.942 ns (5%) |         |   16 bytes (1%) |           1 |
| `["partition_by", "man"]`                                      |   2.582 ms (5%) |         |  480 bytes (1%) |           3 |
| `["partition_by", "xf"]`                                       |   2.805 ms (5%) |         |  592 bytes (1%) |           5 |
| `["set", "base"]`                                              |   4.140 ms (5%) |         |  49.14 KiB (1%) |          17 |
