...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8370C CPU @ 2.80GHz: 
       ...
       #1  2793 MHz       5722 s          0 s        125 s       2853 s          0 s
       #2  2793 MHz       1414 s          0 s        112 s       7160 s          0 s
       
  Memory: 6.781219482421875 GB (3664.00390625 MB free)
  Uptime: 874.21 sec
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8370C CPU @ 2.80GHz: 
              speed         user         nice          sys         idle          irq
       #1  2793 MHz       5863 s          0 s        145 s       5460 s          0 s
       #2  2793 MHz       4069 s          0 s        147 s       7242 s          0 s
       
  Memory: 6.781219482421875 GB (3568.8984375 MB free)
  Uptime: 1151.38 sec
...
|----------------------------------------------------------------|----------------:|--------:|----------------:|------------:|
| `["append!!", "eduction"]`                                     |  19.399 μs (5%) |         |  53.98 KiB (1%) |           8 |
...
| `["filter_sum", "1000", "UnitRange", "withinit", "base"]`      | 167.067 ns (5%) |         |                 |             |
...
| `["findall", "xf-iter"]`                                       | 745.496 μs (5%) |         |   1.83 MiB (1%) |          14 |
...
| `["gemm", "fusedmul", "xf", "2"]`                              | 608.297 μs (5%) |         |  192 bytes (1%) |           4 |
...
| `["gemm", "mul", "man", "false", "8"]`                         | 587.217 ns (5%) |         |                 |             |
...
| `["gemm", "mul", "man", "true", "8"]`                          | 435.354 ns (5%) |         |                 |             |
| `["gemm", "mul", "xf", "false", "256"]`                        |   2.758 ms (5%) |         |   80 bytes (1%) |           3 |
...
| `["groupby", "sum", "sac"]`                                    | 141.499 μs (5%) |         |   1.64 KiB (1%) |          11 |
...
| `["missing_dot", "xf"]`                                        |  90.000 μs (5%) |         |  72.06 KiB (1%) |        3740 |
| `["missing_dot", "xf_nota"]`                                   |  89.400 μs (5%) |         |  72.19 KiB (1%) |        3744 |
| `["overhead", "foldl"]`                                        |   3.599 ns (5%) |         |                 |             |
| `["overhead", "reduce_basecase"]`                              |  94.747 ns (5%) |         |   16 bytes (1%) |           1 |
...
| `["collect", "identity-float"]`                                |  16.600 μs (5%) |         | 326.61 KiB (1%) |          10 |
| `["collect", "identity-union"]`                                | 153.699 μs (5%) |         | 679.41 KiB (1%) |       10010 |
| `["dict", "base"]`                                             |   3.652 ms (5%) |         |  92.45 KiB (1%) |          22 |
...
| `["filter_sum", "1000", "RandomFloats", "noinit", "xf"]`       |   2.489 μs (5%) |         |                 |             |
| `["filter_sum", "1000", "RandomFloats", "withinit", "base"]`   |   2.500 μs (5%) |         |                 |             |
| `["filter_sum", "1000", "RandomFloats", "withinit", "naive"]`  | 921.026 ns (5%) |         |                 |             |
...
| `["findall", "xf-array"]`                                      |   1.252 ms (5%) |         |   2.94 MiB (1%) |       96426 |
| `["findall", "xf-iter"]`                                       | 709.196 μs (5%) |         |   1.83 MiB (1%) |          14 |
...
| `["gemm", "fusedmul", "xf", "16"]`                             |   4.796 ms (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "fusedmul", "xf", "2"]`                              | 604.996 μs (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "fusedmul", "xf", "32"]`                             |   9.449 ms (5%) |         |  192 bytes (1%) |           4 |
...
| `["groupby", "sum", "sac"]`                                    |   7.311 ms (5%) |         |  13.14 KiB (1%) |         103 |
| `["groupby", "sum", "xf-with-init"]`                           | 137.401 μs (5%) |         |   1.05 KiB (1%) |           9 |
| `["groupby", "sum", "xf-without-init"]`                        | 136.798 μs (5%) |         |   1.05 KiB (1%) |           9 |
...
| `["missing_dot", "xf_nota"]`                                   |  91.399 μs (5%) |         |  72.25 KiB (1%) |        3748 |
| `["overhead", "foldl"]`                                        |   3.999 ns (5%) |         |                 |             |
| `["overhead", "reduce_basecase"]`                              |  92.226 ns (5%) |         |   16 bytes (1%) |           1 |
| `["partition_by", "man"]`                                      |   2.581 ms (5%) |         |  480 bytes (1%) |           3 |
| `["partition_by", "xf"]`                                       |   2.812 ms (5%) |         |  592 bytes (1%) |           5 |
...
| `["sum_transpose", "30", "withinit", "xf"]`                    |   1.350 μs (5%) |         |                 |             |
| `["teerf_filter", "noinit"]`                                   | 410.995 ns (5%) |         |   80 bytes (1%) |           3 |
