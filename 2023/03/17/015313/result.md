...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
       ...
       #1  2593 MHz        475 s          0 s        141 s       7126 s          0 s
       #2  2593 MHz       6699 s          0 s        172 s        872 s          0 s
       
  Memory: 6.781219482421875 GB (3632.3984375 MB free)
  Uptime: 781.08 sec
  Load Avg:  1.04  0.96  0.61
  WORD_SIZE: 64
  LIBM: libopenlibm
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
              speed         user         nice          sys         idle          irq
       #1  2593 MHz        625 s          0 s        162 s       9812 s          0 s
       #2  2593 MHz       9440 s          0 s        215 s        955 s          0 s
       
  Memory: 6.781219482421875 GB (3558.0703125 MB free)
  Uptime: 1067.84 sec
...
| `["findall", "xf-iter"]`                                       | 865.310 μs (5%) |         |   1.83 MiB (1%) |          14 |
...
| `["gemm", "fusedmul", "xf", "2"]`                              | 655.506 μs (5%) |         |  192 bytes (1%) |           4 |
...
| `["gemm", "mul", "man", "ivdep", "8"]`                         | 375.610 ns (5%) |         |                 |             |
| `["gemm", "mul", "man", "true", "256"]`                        |   2.679 ms (5%) |         |                 |             |
| `["gemm", "mul", "man", "true", "32"]`                         |   6.160 μs (5%) |         |                 |             |
| `["gemm", "mul", "man", "true", "8"]`                          | 398.505 ns (5%) |         |                 |             |
| `["gemm", "mul", "xf", "false", "256"]`                        |   2.716 ms (5%) |         |   80 bytes (1%) |           3 |
...
| `["gemm", "mul", "xf", "true", "8"]`                           | 554.551 ns (5%) |         |   80 bytes (1%) |           3 |
...
| `["missing_dot", "xf"]`                                        |  97.601 μs (5%) |         |  72.22 KiB (1%) |        3744 |
| `["missing_dot", "xf_nota"]`                                   |  96.901 μs (5%) |         |  71.89 KiB (1%) |        3730 |
...
| `["set", "xf"]`                                                |   4.055 ms (5%) |         |  49.17 KiB (1%) |          19 |
...
| `["collect", "identity-union"]`                                | 152.001 μs (5%) |         | 679.41 KiB (1%) |       10010 |
...
| `["filter_sum", "1000", "UnitRange", "noinit", "naive"]`       |   1.020 μs (5%) |         |                 |             |
| `["filter_sum", "1000", "UnitRange", "noinit", "xf"]`          | 188.052 ns (5%) |         |                 |             |
| `["filter_sum", "1000", "UnitRange", "withinit", "base"]`      | 130.475 ns (5%) |         |                 |             |
| `["filter_sum", "1000", "UnitRange", "withinit", "naive"]`     | 846.154 ns (5%) |         |                 |             |
| `["filter_sum", "1000", "UnitRange", "withinit", "xf"]`        | 137.916 ns (5%) |         |                 |             |
| `["filter_sum", "10000", "RandomFloats", "noinit", "base"]`    |  30.300 μs (5%) |         |                 |             |
...
| `["findall", "xf-array"]`                                      |   1.291 ms (5%) |         |   2.94 MiB (1%) |       96426 |
| `["findall", "xf-iter"]`                                       | 860.909 μs (5%) |         |   1.83 MiB (1%) |          14 |
...
| `["gemm", "mul", "man", "true", "256"]`                        |   2.722 ms (5%) |         |                 |             |
...
| `["gemm", "mul", "xf", "ivdep", "256"]`                        |   2.711 ms (5%) |         |   80 bytes (1%) |           3 |
| `["gemm", "mul", "xf", "ivdep", "32"]`                         |   5.700 μs (5%) |         |   80 bytes (1%) |           3 |
| `["gemm", "mul", "xf", "ivdep", "8"]`                          | 400.000 ns (5%) |         |   80 bytes (1%) |           3 |
| `["gemm", "mul", "xf", "true", "256"]`                         |   2.725 ms (5%) |         |   80 bytes (1%) |           3 |
...
| `["missing_dot", "xf"]`                                        |  93.701 μs (5%) |         |  72.02 KiB (1%) |        3736 |
| `["missing_dot", "xf_nota"]`                                   |  93.701 μs (5%) |         |  72.30 KiB (1%) |        3748 |
| `["overhead", "foldl"]`                                        |   3.700 ns (5%) |         |                 |             |
| `["overhead", "reduce_basecase"]`                              |  98.730 ns (5%) |         |   16 bytes (1%) |           1 |
| `["partition_by", "man"]`                                      |   2.528 ms (5%) |         |  480 bytes (1%) |           3 |
...
| `["sum_transpose", "30", "withinit", "man"]`                   |   1.150 μs (5%) |         |                 |             |
| `["sum_transpose", "30", "withinit", "xf"]`                    |   1.150 μs (5%) |         |                 |             |
| `["teerf_filter", "noinit"]`                                   | 372.195 ns (5%) |         |   80 bytes (1%) |           3 |
