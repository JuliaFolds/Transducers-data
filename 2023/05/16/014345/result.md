...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
       ...
       #1  2593 MHz        381 s          0 s        139 s       8614 s          0 s
       #2  2593 MHz       6746 s          0 s        193 s       2196 s          0 s
       
  Memory: 6.781208038330078 GB (3644.265625 MB free)
  Uptime: 919.14 sec
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
              speed         user         nice          sys         idle          irq
       #1  2593 MHz        529 s          0 s        164 s      11261 s          0 s
       #2  2593 MHz       9441 s          0 s        233 s       2289 s          0 s
       
  Memory: 6.781208038330078 GB (3508.13671875 MB free)
  Uptime: 1202.06 sec
...
| `["collect", "identity-float"]`                                |   6.333 μs (5%) |         |  78.17 KiB (1%) |           2 |
...
| `["findall", "xf-iter"]`                                       | 856.710 μs (5%) |         |   1.83 MiB (1%) |          14 |
...
| `["gemm", "fusedmul", "xf", "2"]`                              | 659.408 μs (5%) |         |  192 bytes (1%) |           4 |
...
| `["gemm", "mul", "linalg", "8"]`                               | 215.430 ns (5%) |         |                 |             |
...
| `["gemm", "mul", "xf", "true", "8"]`                           | 443.883 ns (5%) |         |   80 bytes (1%) |           3 |
...
| `["missing_dot", "xf"]`                                        | 101.301 μs (5%) |         |  72.14 KiB (1%) |        3742 |
| `["missing_dot", "xf_nota"]`                                   | 100.301 μs (5%) |         |  72.14 KiB (1%) |        3744 |
| `["overhead", "foldl"]`                                        |   3.300 ns (5%) |         |                 |             |
| `["overhead", "reduce_basecase"]`                              | 105.721 ns (5%) |         |   16 bytes (1%) |           1 |
...
| `["collect", "identity-float"]`                                |   6.767 μs (5%) |         |  78.17 KiB (1%) |           2 |
| `["collect", "identity-union"]`                                | 143.902 μs (5%) |         | 400.53 KiB (1%) |       10003 |
| `["dict", "base"]`                                             |   3.765 ms (5%) |         |  92.45 KiB (1%) |          22 |
...
| `["filter_sum", "1000", "UnitRange", "withinit", "base"]`      | 130.473 ns (5%) |         |                 |             |
| `["filter_sum", "1000", "UnitRange", "withinit", "naive"]`     | 847.143 ns (5%) |         |                 |             |
| `["filter_sum", "1000", "UnitRange", "withinit", "xf"]`        | 134.941 ns (5%) |         |                 |             |
| `["filter_sum", "10000", "RandomFloats", "noinit", "base"]`    |  30.300 μs (5%) |         |                 |             |
...
| `["filter_sum", "10000", "UnitRange", "withinit", "naive"]`    |   8.367 μs (5%) |         |                 |             |
| `["filter_sum", "10000", "UnitRange", "withinit", "xf"]`       |   1.240 μs (5%) |         |                 |             |
| `["findall", "base"]`                                          | 138.403 μs (5%) |         | 797.20 KiB (1%) |           8 |
| `["findall", "xf-array"]`                                      |   1.319 ms (5%) |         |   2.94 MiB (1%) |       96426 |
| `["findall", "xf-iter"]`                                       | 856.310 μs (5%) |         |   1.83 MiB (1%) |          14 |
...
| `["gemm", "mul", "man", "true", "256"]`                        |   2.712 ms (5%) |         |                 |             |
...
| `["gemm", "mul", "xf", "ivdep", "256"]`                        |   2.698 ms (5%) |         |   80 bytes (1%) |           3 |
| `["gemm", "mul", "xf", "ivdep", "32"]`                         |   5.700 μs (5%) |         |   80 bytes (1%) |           3 |
| `["gemm", "mul", "xf", "ivdep", "8"]`                          | 400.000 ns (5%) |         |   80 bytes (1%) |           3 |
| `["gemm", "mul", "xf", "true", "256"]`                         |   2.727 ms (5%) |         |   80 bytes (1%) |           3 |
...
| `["missing_dot", "xf"]`                                        | 101.201 μs (5%) |         |  72.02 KiB (1%) |        3736 |
| `["missing_dot", "xf_nota"]`                                   |  94.501 μs (5%) |         |  72.27 KiB (1%) |        3745 |
| `["overhead", "foldl"]`                                        |   3.300 ns (5%) |         |                 |             |
| `["overhead", "reduce_basecase"]`                              | 101.379 ns (5%) |         |   16 bytes (1%) |           1 |
