...
## Job Properties
* Time of benchmarks:
    - Target: 5 May 2023 - 01:35
    - Baseline: 5 May 2023 - 01:40
* Package commits:
    - Target: 64dde0
    - Baseline: f8d0df
* Julia commits:
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
       ...
       #1  2593 MHz        632 s          0 s        141 s       8343 s          0 s
       #2  2593 MHz       6568 s          0 s        172 s       2390 s          0 s
       
  Memory: 6.781208038330078 GB (3651.80078125 MB free)
  Uptime: 918.44 sec
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
              speed         user         nice          sys         idle          irq
       #1  2593 MHz        768 s          0 s        162 s      11020 s          0 s
       #2  2593 MHz       9298 s          0 s        219 s       2457 s          0 s
       
  Memory: 6.781208038330078 GB (3507.4921875 MB free)
  Uptime: 1202.95 sec
...
## Job Properties
* Time of benchmark: 5 May 2023 - 1:35
...
| `["collect", "identity-union"]`                                | 146.504 μs (5%) |         | 679.41 KiB (1%) |       10010 |
...
| `["filter_sum", "1000", "UnitRange", "noinit", "xf"]`          | 188.170 ns (5%) |         |                 |             |
| `["filter_sum", "1000", "UnitRange", "withinit", "base"]`      | 137.361 ns (5%) |         |                 |             |
...
| `["findall", "base"]`                                          | 137.403 μs (5%) |         | 797.20 KiB (1%) |           8 |
| `["findall", "xf-array"]`                                      |   1.334 ms (5%) |         |   2.94 MiB (1%) |       96426 |
| `["findall", "xf-iter"]`                                       | 862.020 μs (5%) |         |   1.83 MiB (1%) |          14 |
...
| `["gemm", "fusedmul", "xf", "2"]`                              | 656.214 μs (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "fusedmul", "xf", "32"]`                             |  10.413 ms (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "fusedmul", "xf", "8"]`                              |   2.614 ms (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "mul", "linalg", "256"]`                             | 510.410 μs (5%) |         |                 |             |
| `["gemm", "mul", "linalg", "32"]`                              |   1.550 μs (5%) |         |                 |             |
| `["gemm", "mul", "linalg", "8"]`                               | 215.623 ns (5%) |         |                 |             |
| `["gemm", "mul", "man", "false", "256"]`                       |   3.158 ms (5%) |         |                 |             |
...
| `["gemm", "mul", "man", "true", "8"]`                          | 396.045 ns (5%) |         |                 |             |
...
| `["gemm", "mul", "xf", "ivdep", "8"]`                          | 502.588 ns (5%) |         |   80 bytes (1%) |           3 |
...
| `["groupby", "sum", "sac"]`                                    | 150.404 μs (5%) |         |   1.64 KiB (1%) |          11 |
| `["groupby", "sum", "xf-with-init"]`                           | 145.203 μs (5%) |         |   1.05 KiB (1%) |           9 |
| `["groupby", "sum", "xf-without-init"]`                        | 138.403 μs (5%) |         |   1.05 KiB (1%) |           9 |
...
| `["missing_dot", "xf"]`                                        |  96.102 μs (5%) |         |  72.16 KiB (1%) |        3743 |
| `["missing_dot", "xf_nota"]`                                   |  95.501 μs (5%) |         |  72.33 KiB (1%) |        3749 |
| `["overhead", "foldl"]`                                        |   3.700 ns (5%) |         |                 |             |
| `["overhead", "reduce_basecase"]`                              | 101.811 ns (5%) |         |   16 bytes (1%) |           1 |
| `["partition_by", "man"]`                                      |   2.503 ms (5%) |         |  480 bytes (1%) |           3 |
| `["partition_by", "xf"]`                                       |   2.719 ms (5%) |         |  592 bytes (1%) |           5 |
| `["set", "base"]`                                              |   4.186 ms (5%) |         |  49.14 KiB (1%) |          17 |
...
| `["teerf_filter", "withinit"]`                                 | 214.024 ns (5%) |         |                 |             |
...
## Job Properties
* Time of benchmark: 5 May 2023 - 1:40
...
| `["collect", "identity-union"]`                                | 144.203 μs (5%) |         | 679.41 KiB (1%) |       10010 |
...
| `["gemm", "mul", "xf", "ivdep", "256"]`                        |   2.671 ms (5%) |         |   80 bytes (1%) |           3 |
...
| `["groupby", "sum", "xf-with-init"]`                           | 140.403 μs (5%) |         |   1.05 KiB (1%) |           9 |
...
| `["missing_dot", "xf"]`                                        |  99.502 μs (5%) |         |  72.05 KiB (1%) |        3736 |
| `["missing_dot", "xf_nota"]`                                   |  98.602 μs (5%) |         |  72.20 KiB (1%) |        3746 |
| `["overhead", "foldl"]`                                        |   3.700 ns (5%) |         |                 |             |
| `["overhead", "reduce_basecase"]`                              | 103.300 ns (5%) |         |   16 bytes (1%) |           1 |
...
| `["sum_transpose", "30", "withinit", "man"]`                   |   1.150 μs (5%) |         |                 |             |
| `["sum_transpose", "30", "withinit", "xf"]`                    |   1.150 μs (5%) |         |                 |             |
| `["teerf_filter", "noinit"]`                                   | 374.887 ns (5%) |         |   80 bytes (1%) |           3 |
