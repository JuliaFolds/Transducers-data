...
## Job Properties
* Time of benchmarks:
    - Target: 27 Jul 2023 - 01:30
    - Baseline: 27 Jul 2023 - 01:35
* Package commits:
    - Target: 763cb7
    - Baseline: 2a51f8
* Julia commits:
...
| `["missing_dot", "equiv"]`                                     |                1.33 (5%) :x: |                   1.00 (1%)  |
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
       ...
       #1  2593 MHz       6649 s          0 s        191 s       1155 s          0 s
       #2  2593 MHz        600 s          0 s        138 s       7205 s          0 s
       
  Memory: 6.7694854736328125 GB (3474.40625 MB free)
  Uptime: 803.62 sec
  Load Avg:  1.05  1.0  0.69
  WORD_SIZE: 64
  LIBM: libopenlibm
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
              speed         user         nice          sys         idle          irq
       #1  2593 MHz       8875 s          0 s        239 s       1729 s          0 s
       #2  2593 MHz       1238 s          0 s        163 s       9386 s          0 s
       
  Memory: 6.7694854736328125 GB (3430.78125 MB free)
  Uptime: 1088.63 sec
...
## Job Properties
* Time of benchmark: 27 Jul 2023 - 1:30
...
| `["collect", "identity-union"]`                                | 147.302 μs (5%) |         | 400.53 KiB (1%) |       10003 |
...
| `["dot", "rf"]`                                                |   1.910 μs (5%) |         |                 |             |
| `["dot", "xf"]`                                                |   1.910 μs (5%) |         |                 |             |
| `["filter_map_map!", "man"]`                                   |  53.301 μs (5%) |         |                 |             |
| `["filter_map_map!", "xf"]`                                    |  55.801 μs (5%) |         |                 |             |
...
| `["filter_sum", "1000", "UnitRange", "withinit", "base"]`      | 135.430 ns (5%) |         |                 |             |
| `["filter_sum", "1000", "UnitRange", "withinit", "naive"]`     | 847.143 ns (5%) |         |                 |             |
| `["filter_sum", "1000", "UnitRange", "withinit", "xf"]`        | 138.604 ns (5%) |         |                 |             |
...
| `["findall", "xf-iter"]`                                       | 858.012 μs (5%) |         |   1.83 MiB (1%) |          14 |
| `["gemm", "fusedmul", "blas", "16"]`                           |   2.741 ms (5%) |         |                 |             |
| `["gemm", "fusedmul", "blas", "2"]`                            |   2.074 ms (5%) |         |                 |             |
| `["gemm", "fusedmul", "blas", "32"]`                           |   3.378 ms (5%) |         |                 |             |
| `["gemm", "fusedmul", "blas", "8"]`                            |   2.188 ms (5%) |         |                 |             |
| `["gemm", "fusedmul", "xf", "16"]`                             |   5.237 ms (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "fusedmul", "xf", "2"]`                              | 651.810 μs (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "fusedmul", "xf", "32"]`                             |  10.487 ms (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "fusedmul", "xf", "8"]`                              |   2.625 ms (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "mul", "linalg", "256"]`                             | 509.207 μs (5%) |         |                 |             |
| `["gemm", "mul", "linalg", "32"]`                              |   1.550 μs (5%) |         |                 |             |
| `["gemm", "mul", "linalg", "8"]`                               | 218.186 ns (5%) |         |                 |             |
| `["gemm", "mul", "man", "false", "256"]`                       |   2.690 ms (5%) |         |                 |             |
...
| `["gemm", "mul", "man", "ivdep", "8"]`                         | 377.946 ns (5%) |         |                 |             |
...
| `["groupby", "sum", "sac"]`                                    | 152.203 μs (5%) |         |   1.64 KiB (1%) |          11 |
| `["groupby", "sum", "xf-with-init"]`                           | 148.002 μs (5%) |         |   1.05 KiB (1%) |           9 |
| `["groupby", "sum", "xf-without-init"]`                        | 145.402 μs (5%) |         |   1.05 KiB (1%) |           9 |
...
| `["missing_dot", "xf"]`                                        |  96.602 μs (5%) |         |  72.25 KiB (1%) |        3746 |
| `["missing_dot", "xf_nota"]`                                   |  96.101 μs (5%) |         |  72.12 KiB (1%) |        3740 |
| `["overhead", "foldl"]`                                        |   3.700 ns (5%) |         |                 |             |
| `["overhead", "reduce_basecase"]`                              | 104.911 ns (5%) |         |   16 bytes (1%) |           1 |
| `["partition_by", "man"]`                                      |   2.578 ms (5%) |         |  480 bytes (1%) |           3 |
...
| `["teerf_filter", "noinit"]`                                   | 379.808 ns (5%) |         |   80 bytes (1%) |           3 |
...
## Job Properties
* Time of benchmark: 27 Jul 2023 - 1:35
...
| `["collect", "identity-float"]`                                |   6.825 μs (5%) |         |  78.17 KiB (1%) |           2 |
| `["collect", "identity-union"]`                                | 145.502 μs (5%) |         | 400.53 KiB (1%) |       10003 |
...
| `["filter_sum", "1000", "UnitRange", "withinit", "xf"]`        | 135.627 ns (5%) |         |                 |             |
...
| `["gemm", "mul", "xf", "ivdep", "256"]`                        |   2.700 ms (5%) |         |   80 bytes (1%) |           3 |
| `["gemm", "mul", "xf", "ivdep", "32"]`                         |   5.600 μs (5%) |         |   80 bytes (1%) |           3 |
| `["gemm", "mul", "xf", "ivdep", "8"]`                          | 500.000 ns (5%) |         |   80 bytes (1%) |           3 |
| `["gemm", "mul", "xf", "true", "256"]`                         |   2.717 ms (5%) |         |   80 bytes (1%) |           3 |
| `["gemm", "mul", "xf", "true", "32"]`                          |   6.300 μs (5%) |         |   80 bytes (1%) |           3 |
| `["gemm", "mul", "xf", "true", "8"]`                           | 500.000 ns (5%) |         |   80 bytes (1%) |           3 |
| `["groupby", "sum", "sac"]`                                    |   8.613 ms (5%) |         |  13.17 KiB (1%) |         104 |
| `["groupby", "sum", "xf-with-init"]`                           | 147.902 μs (5%) |         |   1.05 KiB (1%) |           9 |
| `["groupby", "sum", "xf-without-init"]`                        | 145.002 μs (5%) |         |   1.05 KiB (1%) |           9 |
...
| `["missing_dot", "xf"]`                                        | 101.901 μs (5%) |         |  72.20 KiB (1%) |        3746 |
| `["missing_dot", "xf_nota"]`                                   | 100.302 μs (5%) |         |  72.11 KiB (1%) |        3741 |
| `["overhead", "foldl"]`                                        |   3.400 ns (5%) |         |                 |             |
| `["overhead", "reduce_basecase"]`                              | 103.524 ns (5%) |         |   16 bytes (1%) |           1 |
| `["partition_by", "man"]`                                      |   2.494 ms (5%) |         |  480 bytes (1%) |           3 |
| `["partition_by", "xf"]`                                       |   2.661 ms (5%) |         |  592 bytes (1%) |           5 |
| `["set", "base"]`                                              |   4.158 ms (5%) |         |  49.14 KiB (1%) |          17 |
