...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
       ...
       #1  2593 MHz       1088 s          0 s        120 s       6326 s          0 s
       #2  2593 MHz       6233 s          0 s        205 s       1088 s          0 s
       
  Memory: 6.7694854736328125 GB (3631.81640625 MB free)
  Uptime: 760.14 sec
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
              speed         user         nice          sys         idle          irq
       #1  2593 MHz       3805 s          0 s        164 s       6435 s          0 s
       #2  2593 MHz       6407 s          0 s        232 s       3749 s          0 s
       
  Memory: 6.7694854736328125 GB (3525.98828125 MB free)
  Uptime: 1047.3 sec
  Load Avg:  1.1  1.07  0.79
  WORD_SIZE: 64
  LIBM: libopenlibm
  LLVM: libLLVM-12.0.1 (ORCJIT, skylake-avx512)
```
...
## Job Properties
* Time of benchmark: 8 Jul 2023 - 2:3
...
| `["collect", "identity-float"]`                                |   8.167 μs (5%) |         |  78.17 KiB (1%) |           2 |
| `["collect", "identity-union"]`                                | 152.202 μs (5%) |         | 400.53 KiB (1%) |       10003 |
...
| `["filter_sum", "1000", "UnitRange", "withinit", "base"]`      | 130.701 ns (5%) |         |                 |             |
| `["filter_sum", "1000", "UnitRange", "withinit", "naive"]`     | 916.216 ns (5%) |         |                 |             |
| `["filter_sum", "1000", "UnitRange", "withinit", "xf"]`        | 143.091 ns (5%) |         |                 |             |
...
| `["findall", "xf-iter"]`                                       | 860.809 μs (5%) |         |   1.83 MiB (1%) |          14 |
| `["gemm", "fusedmul", "blas", "16"]`                           |   2.845 ms (5%) |         |                 |             |
| `["gemm", "fusedmul", "blas", "2"]`                            |   2.204 ms (5%) |         |                 |             |
| `["gemm", "fusedmul", "blas", "32"]`                           |   3.461 ms (5%) |         |                 |             |
| `["gemm", "fusedmul", "blas", "8"]`                            |   2.300 ms (5%) |         |                 |             |
| `["gemm", "fusedmul", "xf", "16"]`                             |   5.401 ms (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "fusedmul", "xf", "2"]`                              | 686.508 μs (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "fusedmul", "xf", "32"]`                             |  10.831 ms (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "fusedmul", "xf", "8"]`                              |   2.734 ms (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "mul", "linalg", "256"]`                             | 514.706 μs (5%) |         |                 |             |
| `["gemm", "mul", "linalg", "32"]`                              |   1.560 μs (5%) |         |                 |             |
| `["gemm", "mul", "linalg", "8"]`                               | 217.812 ns (5%) |         |                 |             |
| `["gemm", "mul", "man", "false", "256"]`                       |   3.219 ms (5%) |         |                 |             |
...
| `["gemm", "mul", "xf", "true", "256"]`                         |   3.193 ms (5%) |         |   80 bytes (1%) |           3 |
...
| `["missing_dot", "xf"]`                                        | 102.101 μs (5%) |         |  72.19 KiB (1%) |        3744 |
| `["missing_dot", "xf_nota"]`                                   |  97.101 μs (5%) |         |  72.25 KiB (1%) |        3746 |
| `["overhead", "foldl"]`                                        |   3.300 ns (5%) |         |                 |             |
| `["overhead", "reduce_basecase"]`                              | 108.432 ns (5%) |         |   16 bytes (1%) |           1 |
...
| ID                                                             | time            | GC time | memory          | allocations |
|----------------------------------------------------------------|----------------:|--------:|----------------:|------------:|
| `["append!!", "eduction"]`                                     |  19.201 μs (5%) |         |  53.98 KiB (1%) |           8 |
...
| `["collect", "identity-float"]`                                |   7.733 μs (5%) |         |  78.17 KiB (1%) |           2 |
| `["collect", "identity-union"]`                                | 149.202 μs (5%) |         | 400.53 KiB (1%) |       10003 |
...
| `["filter_sum", "1000", "UnitRange", "withinit", "xf"]`        | 131.245 ns (5%) |         |                 |             |
| `["filter_sum", "10000", "RandomFloats", "noinit", "base"]`    |  30.300 μs (5%) |         |                 |             |
...
| `["filter_sum", "10000", "UnitRange", "withinit", "base"]`     |   1.330 μs (5%) |         |                 |             |
...
| `["findall", "xf-iter"]`                                       | 866.710 μs (5%) |         |   1.83 MiB (1%) |          14 |
...
| `["gemm", "fusedmul", "xf", "32"]`                             |  10.473 ms (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "fusedmul", "xf", "8"]`                              |   2.606 ms (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "mul", "linalg", "256"]`                             | 509.506 μs (5%) |         |                 |             |
...
| `["gemm", "mul", "xf", "false", "256"]`                        |   3.169 ms (5%) |         |   80 bytes (1%) |           3 |
...
| `["groupby", "sum", "xf-with-init"]`                           | 142.801 μs (5%) |         |   1.05 KiB (1%) |           9 |
...
| `["missing_dot", "xf"]`                                        |  98.502 μs (5%) |         |  72.05 KiB (1%) |        3739 |
| `["missing_dot", "xf_nota"]`                                   |  98.001 μs (5%) |         |  71.88 KiB (1%) |        3730 |
| `["overhead", "foldl"]`                                        |   3.300 ns (5%) |         |                 |             |
