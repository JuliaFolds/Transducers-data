...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8370C CPU @ 2.80GHz: 
       ...
       #1  2793 MHz       3510 s          0 s        150 s       3907 s          0 s
       #2  2793 MHz       3563 s          0 s        175 s       3823 s          0 s
       
  Memory: 6.781219482421875 GB (3661.45703125 MB free)
  Uptime: 761.54 sec
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8370C CPU @ 2.80GHz: 
              speed         user         nice          sys         idle          irq
       #1  2793 MHz       3635 s          0 s        168 s       6500 s          0 s
       #2  2793 MHz       6200 s          0 s        214 s       3887 s          0 s
       
  Memory: 6.781219482421875 GB (3590.08203125 MB free)
  Uptime: 1035.76 sec
...
| `["collect", "identity-union"]`                                | 152.499 μs (5%) |         | 679.41 KiB (1%) |       10010 |
...
| `["filter_map_reduce", "man"]`                                 | 314.798 μs (5%) |         |                 |             |
...
| `["findall", "xf-iter"]`                                       | 765.294 μs (5%) |         |   1.83 MiB (1%) |          14 |
...
| `["gemm", "fusedmul", "xf", "16"]`                             |   4.686 ms (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "fusedmul", "xf", "2"]`                              | 600.898 μs (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "fusedmul", "xf", "32"]`                             |   9.390 ms (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "fusedmul", "xf", "8"]`                              |   2.332 ms (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "mul", "linalg", "256"]`                             |   3.934 ms (5%) |         |                 |             |
| `["gemm", "mul", "linalg", "32"]`                              |   7.950 μs (5%) |         |                 |             |
| `["gemm", "mul", "linalg", "8"]`                               | 303.918 ns (5%) |         |                 |             |
...
| `["groupby", "sum", "xf-with-init"]`                           | 135.800 μs (5%) |         |   1.05 KiB (1%) |           9 |
| `["groupby", "sum", "xf-without-init"]`                        | 134.299 μs (5%) |         |   1.05 KiB (1%) |           9 |
...
| `["missing_dot", "xf"]`                                        |  90.800 μs (5%) |         |  72.12 KiB (1%) |        3740 |
| `["missing_dot", "xf_nota"]`                                   |  89.999 μs (5%) |         |  72.23 KiB (1%) |        3746 |
| `["overhead", "foldl"]`                                        |   3.599 ns (5%) |         |                 |             |
| `["overhead", "reduce_basecase"]`                              |  98.287 ns (5%) |         |   16 bytes (1%) |           1 |
...
| `["teerf_filter", "noinit"]`                                   | 413.495 ns (5%) |         |   80 bytes (1%) |           3 |
...
## Job Properties
* Time of benchmark: 12 Jan 2023 - 1:54
...
| `["collect", "identity-union"]`                                | 151.000 μs (5%) |         | 679.41 KiB (1%) |       10010 |
...
| `["filter_sum", "1000", "RandomFloats", "withinit", "naive"]`  | 888.176 ns (5%) |         |                 |             |
| `["filter_sum", "1000", "RandomFloats", "withinit", "xf"]`     |   2.500 μs (5%) |         |                 |             |
...
| `["filter_sum", "1000", "UnitRange", "withinit", "naive"]`     | 623.518 ns (5%) |         |                 |             |
...
| `["findall", "xf-iter"]`                                       | 735.798 μs (5%) |         |   1.83 MiB (1%) |          14 |
| `["gemm", "fusedmul", "blas", "16"]`                           |   9.420 ms (5%) |         |                 |             |
| `["gemm", "fusedmul", "blas", "2"]`                            |   2.467 ms (5%) |         |                 |             |
| `["gemm", "fusedmul", "blas", "32"]`                           |  17.158 ms (5%) |         |                 |             |
| `["gemm", "fusedmul", "blas", "8"]`                            |   5.527 ms (5%) |         |                 |             |
| `["gemm", "fusedmul", "xf", "16"]`                             |   4.678 ms (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "fusedmul", "xf", "2"]`                              | 578.097 μs (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "fusedmul", "xf", "32"]`                             |   9.376 ms (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "fusedmul", "xf", "8"]`                              |   2.331 ms (5%) |         |  192 bytes (1%) |           4 |
...
| `["gemm", "mul", "xf", "false", "256"]`                        |   2.786 ms (5%) |         |   80 bytes (1%) |           3 |
...
| `["groupby", "sum", "sac"]`                                    |   7.297 ms (5%) |         |  13.14 KiB (1%) |         103 |
| `["groupby", "sum", "xf-with-init"]`                           | 135.800 μs (5%) |         |   1.05 KiB (1%) |           9 |
...
| `["missing_dot", "rf"]`                                        |   1.600 μs (5%) |         |   16 bytes (1%) |           1 |
| `["missing_dot", "rf_nota"]`                                   |   2.267 μs (5%) |         |   16 bytes (1%) |           1 |
| `["missing_dot", "xf"]`                                        |  91.200 μs (5%) |         |  72.22 KiB (1%) |        3746 |
| `["missing_dot", "xf_nota"]`                                   |  90.599 μs (5%) |         |  72.41 KiB (1%) |        3754 |
| `["overhead", "foldl"]`                                        |   3.599 ns (5%) |         |                 |             |
| `["overhead", "reduce_basecase"]`                              |  97.215 ns (5%) |         |   16 bytes (1%) |           1 |
