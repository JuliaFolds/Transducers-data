...
## Job Properties
* Time of benchmarks:
    - Target: 9 Jan 2023 - 01:47
    - Baseline: 9 Jan 2023 - 01:51
* Package commits:
    - Target: 192a4d
    - Baseline: f8d0df
* Julia commits:
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
       ...
       #1  2593 MHz       6754 s          0 s        177 s       1691 s          0 s
       #2  2593 MHz        492 s          0 s        154 s       7952 s          0 s
       
  Memory: 6.781219482421875 GB (3542.30859375 MB free)
  Uptime: 867.63 sec
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
              speed         user         nice          sys         idle          irq
       #1  2593 MHz       6926 s          0 s        202 s       4382 s          0 s
       #2  2593 MHz       3225 s          0 s        206 s       8067 s          0 s
       
  Memory: 6.781219482421875 GB (3379.59765625 MB free)
  Uptime: 1157.72 sec
...
## Job Properties
* Time of benchmark: 9 Jan 2023 - 1:47
...
| `["collect", "identity-union"]`                                | 153.402 μs (5%) |         | 679.41 KiB (1%) |       10010 |
...
| `["dot", "rf"]`                                                |   1.910 μs (5%) |         |                 |             |
| `["dot", "xf"]`                                                |   1.910 μs (5%) |         |                 |             |
| `["filter_map_map!", "man"]`                                   |  58.200 μs (5%) |         |                 |             |
...
| `["findall", "base"]`                                          | 138.301 μs (5%) |         | 797.20 KiB (1%) |           8 |
| `["findall", "xf-array"]`                                      |   1.303 ms (5%) |         |   2.94 MiB (1%) |       96426 |
| `["findall", "xf-iter"]`                                       | 870.211 μs (5%) |         |   1.83 MiB (1%) |          14 |
...
| `["gemm", "fusedmul", "xf", "2"]`                              | 673.109 μs (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "fusedmul", "xf", "32"]`                             |  10.881 ms (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "fusedmul", "xf", "8"]`                              |   2.703 ms (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "mul", "linalg", "256"]`                             | 512.006 μs (5%) |         |                 |             |
| `["gemm", "mul", "linalg", "32"]`                              |   1.550 μs (5%) |         |                 |             |
| `["gemm", "mul", "linalg", "8"]`                               | 220.932 ns (5%) |         |                 |             |
| `["gemm", "mul", "man", "false", "256"]`                       |   2.713 ms (5%) |         |                 |             |
...
| `["missing_dot", "xf"]`                                        |  95.801 μs (5%) |         |  72.17 KiB (1%) |        3746 |
| `["missing_dot", "xf_nota"]`                                   |  94.901 μs (5%) |         |  72.28 KiB (1%) |        3748 |
| `["overhead", "foldl"]`                                        |   3.300 ns (5%) |         |                 |             |
| `["overhead", "reduce_basecase"]`                              | 100.002 ns (5%) |         |   16 bytes (1%) |           1 |
...
| `["teerf_filter", "withinit"]`                                 | 212.547 ns (5%) |         |                 |             |
...
## Job Properties
* Time of benchmark: 9 Jan 2023 - 1:51
...
| `["cartesian", "copyto!", "iter"]`                             |   2.550 μs (5%) |         |                 |             |
...
| `["filter_sum", "1000", "UnitRange", "withinit", "xf"]`        | 138.909 ns (5%) |         |                 |             |
| `["filter_sum", "10000", "RandomFloats", "noinit", "base"]`    |  30.300 μs (5%) |         |                 |             |
...
| `["missing_dot", "xf"]`                                        |  97.101 μs (5%) |         |  72.17 KiB (1%) |        3744 |
| `["missing_dot", "xf_nota"]`                                   |  96.402 μs (5%) |         |  72.16 KiB (1%) |        3744 |
| `["overhead", "foldl"]`                                        |   3.700 ns (5%) |         |                 |             |
| `["overhead", "reduce_basecase"]`                              | 101.375 ns (5%) |         |   16 bytes (1%) |           1 |
| `["partition_by", "man"]`                                      |   2.504 ms (5%) |         |  480 bytes (1%) |           3 |
| `["partition_by", "xf"]`                                       |   2.667 ms (5%) |         |  592 bytes (1%) |           5 |
| `["set", "base"]`                                              |   4.257 ms (5%) |         |  49.14 KiB (1%) |          17 |
| `["set", "xf"]`                                                |   4.022 ms (5%) |         |  49.17 KiB (1%) |          19 |
| `["sum_transpose", "30", "noinit", "iter"]`                    |   2.400 μs (5%) |         |                 |             |
| `["sum_transpose", "30", "noinit", "man"]`                     |   2.833 μs (5%) |         |                 |             |
| `["sum_transpose", "30", "noinit", "xf"]`                      |   1.150 μs (5%) |         |                 |             |
| `["sum_transpose", "30", "withinit", "iter"]`                  |   1.210 μs (5%) |         |                 |             |
...
| `["teerf_filter", "withinit"]`                                 | 214.367 ns (5%) |         |                 |             |
