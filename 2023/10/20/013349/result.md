...
## Job Properties
* Time of benchmarks:
    - Target: 20 Oct 2023 - 01:26
    - Baseline: 20 Oct 2023 - 01:31
* Package commits:
    - Target: da5900
    - Baseline: 2a51f8
* Julia commits:
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
       ...
       #1  2593 MHz       5720 s          0 s        188 s       3609 s          0 s
       #2  2593 MHz       1838 s          3 s        210 s       7432 s          0 s
       
  Memory: 6.7597503662109375 GB (3554.25 MB free)
  Uptime: 959.9 sec
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
              speed         user         nice          sys         idle          irq
       #1  2593 MHz       7204 s          0 s        228 s       5110 s          0 s
       #2  2593 MHz       3404 s          3 s        274 s       8828 s          0 s
       
  Memory: 6.7597503662109375 GB (3315.76953125 MB free)
  Uptime: 1263.16 sec
...
## Job Properties
* Time of benchmark: 20 Oct 2023 - 1:26
...
| `["collect", "identity-union"]`                                | 158.403 μs (5%) |         | 400.53 KiB (1%) |       10003 |
| `["dict", "base"]`                                             |   3.771 ms (5%) |         |  92.45 KiB (1%) |          22 |
| `["dict", "xf"]`                                               |   3.899 ms (5%) |         |  91.95 KiB (1%) |          18 |
| `["dot", "blas"]`                                              |   1.200 μs (5%) |         |                 |             |
| `["dot", "man"]`                                               |   1.880 μs (5%) |         |                 |             |
| `["dot", "rf"]`                                                |   1.910 μs (5%) |         |                 |             |
| `["dot", "xf"]`                                                |   1.920 μs (5%) |         |                 |             |
...
| `["findall", "base"]`                                          | 153.304 μs (5%) |         | 797.20 KiB (1%) |           8 |
| `["findall", "xf-array"]`                                      |   1.357 ms (5%) |         |   2.94 MiB (1%) |       96426 |
| `["findall", "xf-iter"]`                                       | 880.718 μs (5%) |         |   1.83 MiB (1%) |          14 |
...
| `["gemm", "mul", "man", "ivdep", "8"]`                         | 445.460 ns (5%) |         |                 |             |
...
| `["gemm", "mul", "xf", "false", "8"]`                          | 452.045 ns (5%) |         |   80 bytes (1%) |           3 |
| `["gemm", "mul", "xf", "ivdep", "256"]`                        |   2.649 ms (5%) |         |   80 bytes (1%) |           3 |
| `["gemm", "mul", "xf", "ivdep", "32"]`                         |   5.500 μs (5%) |         |   80 bytes (1%) |           3 |
| `["gemm", "mul", "xf", "ivdep", "8"]`                          | 433.176 ns (5%) |         |   80 bytes (1%) |           3 |
...
| `["groupby", "sum", "sac"]`                                    | 153.203 μs (5%) |         |   1.64 KiB (1%) |          11 |
...
| `["missing_dot", "xf"]`                                        |  94.702 μs (5%) |         |  72.19 KiB (1%) |        3746 |
| `["missing_dot", "xf_nota"]`                                   |  94.202 μs (5%) |         |  72.33 KiB (1%) |        3750 |
| `["overhead", "foldl"]`                                        |   3.300 ns (5%) |         |                 |             |
| `["overhead", "reduce_basecase"]`                              | 106.118 ns (5%) |         |   16 bytes (1%) |           1 |
...
| `["teerf_filter", "withinit"]`                                 | 214.877 ns (5%) |         |                 |             |
...
## Job Properties
* Time of benchmark: 20 Oct 2023 - 1:31
...
| `["collect", "identity-union"]`                                | 155.803 μs (5%) |         | 400.53 KiB (1%) |       10003 |
...
| `["groupby", "sum", "sac"]`                                    |   8.650 ms (5%) |         |  13.14 KiB (1%) |         103 |
| `["groupby", "sum", "xf-with-init"]`                           | 144.103 μs (5%) |         |   1.05 KiB (1%) |           9 |
...
| `["missing_dot", "rf_nota"]`                                   |   2.362 μs (5%) |         |   16 bytes (1%) |           1 |
| `["missing_dot", "xf"]`                                        |  97.302 μs (5%) |         |  72.17 KiB (1%) |        3744 |
| `["missing_dot", "xf_nota"]`                                   | 102.702 μs (5%) |         |  72.11 KiB (1%) |        3740 |
| `["overhead", "foldl"]`                                        |   3.700 ns (5%) |         |                 |             |
| `["overhead", "reduce_basecase"]`                              | 106.547 ns (5%) |         |   16 bytes (1%) |           1 |
| `["partition_by", "man"]`                                      |   2.489 ms (5%) |         |  480 bytes (1%) |           3 |
...
| `["sum_transpose", "30", "withinit", "man"]`                   |   1.150 μs (5%) |         |                 |             |
| `["sum_transpose", "30", "withinit", "xf"]`                    |   1.150 μs (5%) |         |                 |             |
| `["teerf_filter", "noinit"]`                                   | 383.673 ns (5%) |         |   80 bytes (1%) |           3 |
| `["teerf_filter", "withinit"]`                                 | 214.681 ns (5%) |         |                 |             |
