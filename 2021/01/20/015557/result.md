...
## Job Properties
* Time of benchmarks:
    - Target: 20 Jan 2021 - 01:50
    - Baseline: 20 Jan 2021 - 01:55
* Package commits:
    - Target: 35d9ef
    - Baseline: f243dc
* Julia commits:
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
       ...
       #1  2593 MHz      55086 s          0 s       1337 s      20660 s          0 s
       #2  2593 MHz      19532 s          0 s       1393 s      56356 s          0 s
       
  Memory: 6.791393280029297 GB (3534.80078125 MB free)
  Uptime: 790.0 sec
  Load Avg:  1.0  0.99365234375  0.6826171875
  WORD_SIZE: 64
  LIBM: libopenlibm
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
              speed         user         nice          sys         idle          irq
       #1  2593 MHz      63330 s          0 s       1498 s      42925 s          0 s
       #2  2593 MHz      41820 s          0 s       1583 s      64601 s          0 s
       
  Memory: 6.791393280029297 GB (3637.1875 MB free)
  Uptime: 1098.0 sec
...
## Job Properties
* Time of benchmark: 20 Jan 2021 - 1:50
...
| `["collect", "identity-union"]`                                | 165.301 μs (5%) |         | 601.04 KiB (1%) |       10013 |
...
| `["filter_map_map!", "xf"]`                                    | 716.504 μs (5%) |         |   80 bytes (1%) |           3 |
...
| `["filter_sum", "1000", "UnitRange", "noinit", "xf"]`          | 126.229 ns (5%) |         |                 |             |
| `["filter_sum", "1000", "UnitRange", "withinit", "base"]`      | 107.282 ns (5%) |         |                 |             |
| `["filter_sum", "1000", "UnitRange", "withinit", "naive"]`     | 580.775 ns (5%) |         |                 |             |
| `["filter_sum", "1000", "UnitRange", "withinit", "xf"]`        | 125.981 ns (5%) |         |                 |             |
...
| `["findall", "base"]`                                          | 978.407 μs (5%) |         |   2.00 MiB (1%) |          18 |
| `["findall", "xf-array"]`                                      | 800.805 μs (5%) |         |   3.02 MiB (1%) |       98829 |
| `["findall", "xf-iter"]`                                       | 410.303 μs (5%) |         |   2.00 MiB (1%) |          19 |
...
| `["gemm", "fusedmul", "xf", "2"]`                              | 666.903 μs (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "fusedmul", "xf", "32"]`                             |  10.700 ms (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "fusedmul", "xf", "8"]`                              |   2.667 ms (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "mul", "linalg", "256"]`                             | 493.803 μs (5%) |         |                 |             |
| `["gemm", "mul", "linalg", "32"]`                              |   1.820 μs (5%) |         |                 |             |
| `["gemm", "mul", "linalg", "8"]`                               | 205.690 ns (5%) |         |                 |             |
| `["gemm", "mul", "man", "false", "256"]`                       |   1.623 ms (5%) |         |                 |             |
...
| `["groupby", "sum", "sac"]`                                    | 191.501 μs (5%) |         |   1.28 KiB (1%) |          14 |
| `["groupby", "sum", "xf-with-init"]`                           | 158.400 μs (5%) |         |   1.20 KiB (1%) |           9 |
...
| `["missing_dot", "xf"]`                                        |  98.301 μs (5%) |         |  72.17 KiB (1%) |        3742 |
| `["missing_dot", "xf_nota"]`                                   | 100.001 μs (5%) |         |  72.02 KiB (1%) |        3736 |
| `["overhead", "foldl"]`                                        |   5.000 ns (5%) |         |                 |             |
| `["overhead", "reduce_basecase"]`                              | 257.939 ns (5%) |         |  368 bytes (1%) |           6 |
| `["partition_by", "man"]`                                      |   2.137 ms (5%) |         |  352 bytes (1%) |           4 |
| `["partition_by", "xf"]`                                       |   2.119 ms (5%) |         |  544 bytes (1%) |           6 |
| `["set", "base"]`                                              |   4.758 ms (5%) |         |  49.56 KiB (1%) |          17 |
| `["set", "xf"]`                                                |   4.586 ms (5%) |         |  49.59 KiB (1%) |          19 |
...
## Job Properties
* Time of benchmark: 20 Jan 2021 - 1:55
...
| `["filter_map_map!", "xf"]`                                    | 729.807 μs (5%) |         |   80 bytes (1%) |           3 |
| `["filter_map_reduce", "man"]`                                 | 231.001 μs (5%) |         |                 |             |
...
| `["filter_sum", "1000", "UnitRange", "noinit", "xf"]`          | 126.786 ns (5%) |         |                 |             |
| `["filter_sum", "1000", "UnitRange", "withinit", "base"]`      | 110.385 ns (5%) |         |                 |             |
| `["filter_sum", "1000", "UnitRange", "withinit", "naive"]`     | 930.220 ns (5%) |         |                 |             |
| `["filter_sum", "1000", "UnitRange", "withinit", "xf"]`        | 126.765 ns (5%) |         |                 |             |
...
| `["filter_sum", "10000", "UnitRange", "withinit", "xf"]`       |   1.170 μs (5%) |         |                 |             |
| `["findall", "base"]`                                          | 970.605 μs (5%) |         |   2.00 MiB (1%) |          18 |
| `["findall", "xf-array"]`                                      | 773.904 μs (5%) |         |   3.02 MiB (1%) |       98829 |
| `["findall", "xf-iter"]`                                       | 473.202 μs (5%) |         |   2.00 MiB (1%) |          19 |
...
| `["gemm", "fusedmul", "xf", "2"]`                              | 654.806 μs (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "fusedmul", "xf", "32"]`                             |  10.471 ms (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "fusedmul", "xf", "8"]`                              |   2.625 ms (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "mul", "linalg", "256"]`                             | 489.602 μs (5%) |         |                 |             |
...
| `["gemm", "mul", "xf", "false", "256"]`                        |   1.717 ms (5%) |         |   80 bytes (1%) |           3 |
...
| `["gemm", "mul", "xf", "true", "256"]`                         |   1.703 ms (5%) |         |   80 bytes (1%) |           3 |
| `["gemm", "mul", "xf", "true", "32"]`                          |   4.700 μs (5%) |         |   80 bytes (1%) |           3 |
| `["gemm", "mul", "xf", "true", "8"]`                           | 400.000 ns (5%) |         |   80 bytes (1%) |           3 |
| `["groupby", "sum", "sac"]`                                    | 206.001 μs (5%) |         |  624 bytes (1%) |           5 |
| `["groupby", "sum", "xf-with-init"]`                           | 159.602 μs (5%) |         |   1.20 KiB (1%) |           9 |
| `["groupby", "sum", "xf-without-init"]`                        | 157.901 μs (5%) |         |   1.20 KiB (1%) |           9 |
...
| `["missing_dot", "rf"]`                                        |   1.590 μs (5%) |         |   16 bytes (1%) |           1 |
| `["missing_dot", "rf_nota"]`                                   |   1.500 μs (5%) |         |   16 bytes (1%) |           1 |
| `["missing_dot", "xf"]`                                        |  99.400 μs (5%) |         |  72.16 KiB (1%) |        3740 |
| `["missing_dot", "xf_nota"]`                                   |  97.100 μs (5%) |         |  72.17 KiB (1%) |        3742 |
| `["overhead", "foldl"]`                                        |   5.000 ns (5%) |         |                 |             |
| `["overhead", "reduce_basecase"]`                              | 259.610 ns (5%) |         |  368 bytes (1%) |           6 |
| `["partition_by", "man"]`                                      |   2.121 ms (5%) |         |  352 bytes (1%) |           4 |
| `["partition_by", "xf"]`                                       |   2.105 ms (5%) |         |  544 bytes (1%) |           6 |
| `["set", "base"]`                                              |   4.681 ms (5%) |         |  49.56 KiB (1%) |          17 |
| `["set", "xf"]`                                                |   4.570 ms (5%) |         |  49.59 KiB (1%) |          19 |
