...
## Job Properties
* Time of benchmarks:
    - Target: 5 Mar 2021 - 00:31
    - Baseline: 5 Mar 2021 - 00:36
* Package commits:
    - Target: 80538d
    - Baseline: eb0a9e
* Julia commits:
...
| `["teerf_filter", "noinit"]`                                   |                   1.03 (5%)  | 1.20 (1%) :x: |
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E5-2673 v3 @ 2.40GHz: 
       ...
       #1  2397 MHz      63446 s         12 s       1571 s      22276 s          0 s
       #2  2397 MHz      20986 s          4 s       1552 s      64552 s          0 s
       
  Memory: 6.7913818359375 GB (3653.6015625 MB free)
  Uptime: 884.0 sec
  Load Avg:  1.0  0.97705078125  0.677734375
  WORD_SIZE: 64
  LIBM: libopenlibm
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E5-2673 v3 @ 2.40GHz: 
              speed         user         nice          sys         idle          irq
       #1  2397 MHz      65614 s         12 s       1664 s      52037 s          0 s
       #2  2397 MHz      50671 s          4 s       1898 s      66644 s          0 s
       
  Memory: 6.7913818359375 GB (3647.01171875 MB free)
  Uptime: 1206.0 sec
  Load Avg:  1.0  1.0  0.7880859375
  WORD_SIZE: 64
  LIBM: libopenlibm
  LLVM: libLLVM-9.0.1 (ORCJIT, haswell)
```
...
## Job Properties
* Time of benchmark: 5 Mar 2021 - 0:31
...
| `["collect", "identity-union"]`                                | 172.907 μs (5%) |         | 601.16 KiB (1%) |       10014 |
| `["dict", "base"]`                                             |   5.610 ms (5%) |         |  92.91 KiB (1%) |          22 |
| `["dict", "xf"]`                                               |   5.366 ms (5%) |         |  92.31 KiB (1%) |          18 |
| `["dot", "blas"]`                                              |   2.311 μs (5%) |         |                 |             |
| `["dot", "man"]`                                               |   2.289 μs (5%) |         |                 |             |
| `["dot", "rf"]`                                                |   2.711 μs (5%) |         |                 |             |
| `["dot", "xf"]`                                                |   2.811 μs (5%) |         |   64 bytes (1%) |           3 |
| `["filter_map_map!", "man"]`                                   |  67.203 μs (5%) |         |                 |             |
| `["filter_map_map!", "xf"]`                                    | 705.428 μs (5%) |         |   80 bytes (1%) |           3 |
| `["filter_map_reduce", "man"]`                                 | 259.610 μs (5%) |         |                 |             |
| `["filter_map_reduce", "xf"]`                                  | 259.610 μs (5%) |         |                 |             |
| `["filter_sum", "1000", "RandomFloats", "noinit", "base"]`     | 961.905 ns (5%) |         |                 |             |
...
| `["filter_sum", "1000", "UnitRange", "noinit", "xf"]`          | 210.283 ns (5%) |         |                 |             |
| `["filter_sum", "1000", "UnitRange", "withinit", "base"]`      | 206.840 ns (5%) |         |                 |             |
| `["filter_sum", "1000", "UnitRange", "withinit", "naive"]`     | 638.529 ns (5%) |         |                 |             |
| `["filter_sum", "1000", "UnitRange", "withinit", "xf"]`        | 210.466 ns (5%) |         |                 |             |
| `["filter_sum", "10000", "RandomFloats", "noinit", "base"]`    |  44.702 μs (5%) |         |                 |             |
| `["filter_sum", "10000", "RandomFloats", "noinit", "naive"]`   |  51.102 μs (5%) |         |                 |             |
...
| `["findall", "base"]`                                          | 971.938 μs (5%) |         |   2.00 MiB (1%) |          18 |
| `["findall", "xf-array"]`                                      | 900.635 μs (5%) |         |   3.02 MiB (1%) |       98829 |
| `["findall", "xf-iter"]`                                       | 361.415 μs (5%) |         |   2.00 MiB (1%) |          19 |
| `["gemm", "fusedmul", "blas", "16"]`                           |   4.843 ms (5%) |         |                 |             |
| `["gemm", "fusedmul", "blas", "2"]`                            |   3.608 ms (5%) |         |                 |             |
| `["gemm", "fusedmul", "blas", "32"]`                           |   6.396 ms (5%) |         |                 |             |
| `["gemm", "fusedmul", "blas", "8"]`                            |   3.729 ms (5%) |         |                 |             |
| `["gemm", "fusedmul", "xf", "16"]`                             |   5.326 ms (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "fusedmul", "xf", "2"]`                              | 664.327 μs (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "fusedmul", "xf", "32"]`                             |  10.702 ms (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "fusedmul", "xf", "8"]`                              |   2.658 ms (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "mul", "linalg", "256"]`                             | 992.640 μs (5%) |         |                 |             |
| `["gemm", "mul", "linalg", "32"]`                              |   3.650 μs (5%) |         |                 |             |
| `["gemm", "mul", "linalg", "8"]`                               | 316.534 ns (5%) |         |                 |             |
...
| `["gemm", "mul", "man", "ivdep", "8"]`                         | 467.187 ns (5%) |         |                 |             |
| `["gemm", "mul", "man", "true", "256"]`                        |   4.338 ms (5%) |         |                 |             |
...
| `["gemm", "mul", "xf", "false", "8"]`                          | 614.966 ns (5%) |         |   80 bytes (1%) |           3 |
| `["gemm", "mul", "xf", "ivdep", "256"]`                        |   4.316 ms (5%) |         |   80 bytes (1%) |           3 |
| `["gemm", "mul", "xf", "ivdep", "32"]`                         |   5.850 μs (5%) |         |   80 bytes (1%) |           3 |
| `["gemm", "mul", "xf", "ivdep", "8"]`                          | 492.284 ns (5%) |         |   80 bytes (1%) |           3 |
| `["gemm", "mul", "xf", "true", "256"]`                         |   4.343 ms (5%) |         |   80 bytes (1%) |           3 |
| `["gemm", "mul", "xf", "true", "32"]`                          |   7.100 μs (5%) |         |   80 bytes (1%) |           3 |
| `["gemm", "mul", "xf", "true", "8"]`                           | 592.760 ns (5%) |         |   80 bytes (1%) |           3 |
| `["groupby", "sum", "sac"]`                                    | 216.309 μs (5%) |         |  624 bytes (1%) |           5 |
| `["groupby", "sum", "xf-with-init"]`                           | 175.707 μs (5%) |         |   1.20 KiB (1%) |           9 |
| `["groupby", "sum", "xf-without-init"]`                        | 175.507 μs (5%) |         |   1.20 KiB (1%) |           9 |
...
| `["missing_dot", "xf"]`                                        | 122.905 μs (5%) |         |  71.83 KiB (1%) |        3730 |
| `["missing_dot", "xf_nota"]`                                   | 124.005 μs (5%) |         |  72.09 KiB (1%) |        3742 |
| `["overhead", "foldl"]`                                        |   5.600 ns (5%) |         |                 |             |
| `["overhead", "reduce_basecase"]`                              | 174.138 ns (5%) |         |   48 bytes (1%) |           2 |
| `["partition_by", "man"]`                                      |   2.349 ms (5%) |         |  352 bytes (1%) |           4 |
| `["partition_by", "xf"]`                                       |   2.337 ms (5%) |         |  544 bytes (1%) |           6 |
| `["set", "base"]`                                              |   6.091 ms (5%) |         |  49.56 KiB (1%) |          17 |
| `["set", "xf"]`                                                |   5.779 ms (5%) |         |  49.59 KiB (1%) |          19 |
...
## Job Properties
* Time of benchmark: 5 Mar 2021 - 0:36
...
| `["cat", "base"]`                                              |   2.122 μs (5%) |         |                 |             |
| `["cat", "xf"]`                                                |   2.611 μs (5%) |         |                 |             |
| `["collect", "filter-missing"]`                                |  62.903 μs (5%) |         |  32.81 KiB (1%) |          14 |
| `["collect", "identity-float"]`                                |  33.301 μs (5%) |         | 256.66 KiB (1%) |          14 |
| `["collect", "identity-union"]`                                | 175.507 μs (5%) |         | 601.04 KiB (1%) |       10013 |
| `["dict", "base"]`                                             |   5.445 ms (5%) |         |  92.91 KiB (1%) |          22 |
...
| `["filter_map_map!", "xf"]`                                    | 688.027 μs (5%) |         |   80 bytes (1%) |           3 |
| `["filter_map_reduce", "man"]`                                 | 259.610 μs (5%) |         |                 |             |
| `["filter_map_reduce", "xf"]`                                  | 259.610 μs (5%) |         |                 |             |
...
| `["filter_sum", "1000", "UnitRange", "withinit", "naive"]`     | 643.701 ns (5%) |         |                 |             |
...
| `["findall", "base"]`                                          | 988.639 μs (5%) |         |   2.00 MiB (1%) |          18 |
| `["findall", "xf-array"]`                                      | 869.934 μs (5%) |         |   3.02 MiB (1%) |       98829 |
| `["findall", "xf-iter"]`                                       | 372.914 μs (5%) |         |   2.00 MiB (1%) |          19 |
| `["gemm", "fusedmul", "blas", "16"]`                           |   4.824 ms (5%) |         |                 |             |
| `["gemm", "fusedmul", "blas", "2"]`                            |   3.583 ms (5%) |         |                 |             |
| `["gemm", "fusedmul", "blas", "32"]`                           |   6.392 ms (5%) |         |                 |             |
| `["gemm", "fusedmul", "blas", "8"]`                            |   3.715 ms (5%) |         |                 |             |
| `["gemm", "fusedmul", "xf", "16"]`                             |   5.312 ms (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "fusedmul", "xf", "2"]`                              | 661.626 μs (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "fusedmul", "xf", "32"]`                             |  10.787 ms (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "fusedmul", "xf", "8"]`                              |   2.648 ms (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "mul", "linalg", "256"]`                             | 990.439 μs (5%) |         |                 |             |
...
| `["groupby", "sum", "xf-without-init"]`                        | 176.007 μs (5%) |         |   1.20 KiB (1%) |           9 |
...
| `["missing_dot", "xf"]`                                        | 122.904 μs (5%) |         |  72.25 KiB (1%) |        3746 |
| `["missing_dot", "xf_nota"]`                                   | 121.105 μs (5%) |         |  72.02 KiB (1%) |        3738 |
| `["overhead", "foldl"]`                                        |   5.500 ns (5%) |         |                 |             |
| `["overhead", "reduce_basecase"]`                              | 173.164 ns (5%) |         |   48 bytes (1%) |           2 |
| `["partition_by", "man"]`                                      |   2.359 ms (5%) |         |  352 bytes (1%) |           4 |
| `["partition_by", "xf"]`                                       |   2.333 ms (5%) |         |  544 bytes (1%) |           6 |
| `["set", "base"]`                                              |   6.193 ms (5%) |         |  49.56 KiB (1%) |          17 |
