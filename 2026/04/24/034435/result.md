...
## Job Properties
* Time of benchmarks:
    - Target: 24 Apr 2026 - 03:38
    - Baseline: 24 Apr 2026 - 03:42
* Package commits:
    - Target: cd11b22
    - Baseline: 2a51f8d
* Julia commits:
...
Platform Info:
  ...
  CPU: AMD EPYC 7763 64-Core Processor: 
       ...
       #1  3243 MHz       1416 s          0 s         88 s       5692 s          0 s
       #2  3221 MHz       1288 s          0 s        104 s       5792 s          0 s
       #3  3247 MHz       1808 s          0 s         66 s       5298 s          0 s
       #4  3253 MHz       1524 s          0 s         84 s       5582 s          0 s
       
  Memory: 15.61495590209961 GB (11257.1796875 MB free)
  Uptime: 722.95 sec
...
Platform Info:
  ...
  CPU: AMD EPYC 7763 64-Core Processor: 
              speed         user         nice          sys         idle          irq
       #1  3245 MHz       1477 s          0 s        104 s       8010 s          0 s
       #2  3244 MHz       1363 s          0 s        118 s       8100 s          0 s
       #3  3243 MHz       2691 s          0 s         85 s       6794 s          0 s
       #4  3245 MHz       2932 s          0 s        142 s       6517 s          0 s
       
  Memory: 15.61495590209961 GB (11246.83203125 MB free)
  Uptime: 963.09 sec
...
## Job Properties
* Time of benchmark: 24 Apr 2026 - 03:38
...
| `["cat", "base"]`                                              |   1.766 μs (5%) |         |                 |             |
| `["cat", "xf"]`                                                |   1.014 μs (5%) |         |                 |             |
| `["collect", "filter-missing"]`                                | 561.166 ns (5%) |         |   9.94 KiB (1%) |           1 |
| `["collect", "identity-float"]`                                |   3.524 μs (5%) |         |  78.17 KiB (1%) |           2 |
| `["collect", "identity-union"]`                                | 104.968 μs (5%) |         | 400.53 KiB (1%) |       10003 |
...
| `["dot", "rf"]`                                                |   1.572 μs (5%) |         |                 |             |
| `["dot", "xf"]`                                                |   1.571 μs (5%) |         |                 |             |
| `["filter_map_map!", "man"]`                                   |  46.988 μs (5%) |         |                 |             |
...
| `["filter_sum", "1000", "RandomFloats", "withinit", "naive"]`  | 604.927 ns (5%) |         |                 |             |
...
| `["filter_sum", "1000", "UnitRange", "noinit", "xf"]`          | 165.908 ns (5%) |         |                 |             |
...
| `["findall", "xf-iter"]`                                       | 693.544 μs (5%) |         |   1.83 MiB (1%) |          14 |
...
| `["missing_argmax", "rf"]`                                     | 738.121 ns (5%) |         |                 |             |
| `["missing_argmax", "xf"]`                                     | 780.516 ns (5%) |         |   32 bytes (1%) |           1 |
| `["missing_dot", "equiv"]`                                     |   1.935 μs (5%) |         |   48 bytes (1%) |           3 |
| `["missing_dot", "man"]`                                       | 852.043 ns (5%) |         |   48 bytes (1%) |           3 |
| `["missing_dot", "naive"]`                                     |   2.764 μs (5%) |         |   48 bytes (1%) |           3 |
| `["missing_dot", "rf"]`                                        | 854.788 ns (5%) |         |   48 bytes (1%) |           3 |
| `["missing_dot", "rf_nota"]`                                   |   1.891 μs (5%) |         |   48 bytes (1%) |           3 |
| `["missing_dot", "xf"]`                                        |  67.988 μs (5%) |         |  72.33 KiB (1%) |        3750 |
| `["missing_dot", "xf_nota"]`                                   |  68.198 μs (5%) |         |  72.16 KiB (1%) |        3740 |
...
| `["teerf_filter", "noinit"]`                                   | 291.587 ns (5%) |         |   80 bytes (1%) |           3 |
...
## Job Properties
* Time of benchmark: 24 Apr 2026 - 03:42
...
| `["cat", "base"]`                                              |   1.743 μs (5%) |         |                 |             |
| `["cat", "xf"]`                                                |   1.014 μs (5%) |         |                 |             |
| `["collect", "filter-missing"]`                                | 569.811 ns (5%) |         |   9.94 KiB (1%) |           1 |
| `["collect", "identity-float"]`                                |   3.887 μs (5%) |         |  78.17 KiB (1%) |           2 |
| `["collect", "identity-union"]`                                | 104.566 μs (5%) |         | 400.53 KiB (1%) |       10003 |
...
| `["filter_sum", "1000", "RandomFloats", "withinit", "naive"]`  | 669.621 ns (5%) |         |                 |             |
| `["filter_sum", "1000", "RandomFloats", "withinit", "xf"]`     |   1.209 μs (5%) |         |                 |             |
| `["filter_sum", "1000", "UnitRange", "noinit", "base"]`        | 934.152 ns (5%) |         |                 |             |
...
| `["findall", "base"]`                                          | 108.825 μs (5%) |         | 797.20 KiB (1%) |           8 |
| `["findall", "xf-array"]`                                      |   1.005 ms (5%) |         |   2.94 MiB (1%) |       96426 |
| `["findall", "xf-iter"]`                                       | 694.765 μs (5%) |         |   1.83 MiB (1%) |          14 |
...
| `["gemm", "mul", "xf", "false", "256"]`                        |   2.221 ms (5%) |         |   80 bytes (1%) |           3 |
| `["gemm", "mul", "xf", "false", "32"]`                         |   5.720 μs (5%) |         |   80 bytes (1%) |           3 |
...
| `["gemm", "mul", "xf", "true", "256"]`                         |   2.232 ms (5%) |         |   80 bytes (1%) |           3 |
| `["gemm", "mul", "xf", "true", "32"]`                          |   5.009 μs (5%) |         |   80 bytes (1%) |           3 |
| `["gemm", "mul", "xf", "true", "8"]`                           | 350.000 ns (5%) |         |   80 bytes (1%) |           3 |
| `["groupby", "sum", "sac"]`                                    |   7.253 ms (5%) |         |  13.19 KiB (1%) |         106 |
| `["groupby", "sum", "xf-with-init"]`                           |  97.644 μs (5%) |         |   1.05 KiB (1%) |           9 |
...
| `["missing_argmax", "rf"]`                                     | 779.121 ns (5%) |         |                 |             |
| `["missing_argmax", "xf"]`                                     | 799.705 ns (5%) |         |   32 bytes (1%) |           1 |
| `["missing_dot", "equiv"]`                                     |   1.806 μs (5%) |         |   48 bytes (1%) |           3 |
| `["missing_dot", "man"]`                                       | 851.171 ns (5%) |         |   48 bytes (1%) |           3 |
| `["missing_dot", "naive"]`                                     |   2.766 μs (5%) |         |   48 bytes (1%) |           3 |
| `["missing_dot", "rf"]`                                        |   1.027 μs (5%) |         |   48 bytes (1%) |           3 |
| `["missing_dot", "rf_nota"]`                                   |   1.867 μs (5%) |         |   48 bytes (1%) |           3 |
| `["missing_dot", "xf"]`                                        |  67.897 μs (5%) |         |  72.23 KiB (1%) |        3746 |
| `["missing_dot", "xf_nota"]`                                   |  67.828 μs (5%) |         |  72.14 KiB (1%) |        3744 |
| `["overhead", "foldl"]`                                        |   2.785 ns (5%) |         |                 |             |
| `["overhead", "reduce_basecase"]`                              |  75.321 ns (5%) |         |   16 bytes (1%) |           1 |
...
| `["teerf_filter", "noinit"]`                                   | 287.082 ns (5%) |         |   80 bytes (1%) |           3 |
