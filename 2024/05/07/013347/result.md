...
| `["collect", "identity-float"]`                                |                1.79 (5%) :x: |                   1.00 (1%)  |
...
Platform Info:
  ...
  CPU: AMD EPYC 7763 64-Core Processor: 
       ...
       #1  2445 MHz       2014 s          0 s        105 s       5557 s          0 s
       #2  2445 MHz       2329 s          0 s        126 s       5212 s          0 s
       #3  3285 MHz        987 s          0 s        101 s       6578 s          0 s
       #4  3241 MHz       1214 s          0 s        103 s       6364 s          0 s
       
  Memory: 15.606494903564453 GB (12485.8515625 MB free)
  Uptime: 771.49 sec
...
Platform Info:
  ...
  CPU: AMD EPYC 7763 64-Core Processor: 
              speed         user         nice          sys         idle          irq
       #1  2445 MHz       3204 s          0 s        119 s       6864 s          0 s
       #2  3242 MHz       3043 s          0 s        148 s       6987 s          0 s
       #3  2445 MHz       1378 s          0 s        132 s       8665 s          0 s
       #4  2584 MHz       1480 s          0 s        146 s       8566 s          0 s
       
  Memory: 15.606494903564453 GB (12432.8515625 MB free)
  Uptime: 1022.97 sec
...
| `["cat", "base"]`                                              |   1.712 μs (5%) |         |                 |             |
| `["cat", "xf"]`                                                |   1.015 μs (5%) |         |                 |             |
| `["collect", "filter-missing"]`                                | 764.984 ns (5%) |         |   9.94 KiB (1%) |           1 |
| `["collect", "identity-float"]`                                |   4.140 μs (5%) |         |  78.17 KiB (1%) |           2 |
| `["collect", "identity-union"]`                                | 106.209 μs (5%) |         | 400.53 KiB (1%) |       10003 |
...
| `["filter_sum", "1000", "RandomFloats", "withinit", "naive"]`  | 777.966 ns (5%) |         |                 |             |
...
| `["findall", "xf-array"]`                                      | 990.914 μs (5%) |         |   2.94 MiB (1%) |       96426 |
| `["findall", "xf-iter"]`                                       | 696.553 μs (5%) |         |   1.83 MiB (1%) |          14 |
...
| `["gemm", "mul", "man", "ivdep", "8"]`                         | 279.582 ns (5%) |         |                 |             |
| `["gemm", "mul", "man", "true", "256"]`                        |   2.086 ms (5%) |         |                 |             |
| `["gemm", "mul", "man", "true", "32"]`                         |   4.942 μs (5%) |         |                 |             |
| `["gemm", "mul", "man", "true", "8"]`                          | 293.214 ns (5%) |         |                 |             |
...
| `["gemm", "mul", "xf", "ivdep", "8"]`                          | 411.920 ns (5%) |         |   80 bytes (1%) |           3 |
| `["gemm", "mul", "xf", "true", "256"]`                         |   2.084 ms (5%) |         |   80 bytes (1%) |           3 |
| `["gemm", "mul", "xf", "true", "32"]`                          |   4.812 μs (5%) |         |   80 bytes (1%) |           3 |
| `["gemm", "mul", "xf", "true", "8"]`                           | 437.030 ns (5%) |         |   80 bytes (1%) |           3 |
| `["groupby", "sum", "sac"]`                                    |  94.447 μs (5%) |         |   1.64 KiB (1%) |          11 |
| `["groupby", "sum", "xf-with-init"]`                           | 100.158 μs (5%) |         |   1.05 KiB (1%) |           9 |
...
| `["missing_argmax", "rf"]`                                     | 898.788 ns (5%) |         |                 |             |
| `["missing_argmax", "xf"]`                                     | 785.133 ns (5%) |         |   32 bytes (1%) |           1 |
...
| `["missing_dot", "xf"]`                                        |  67.757 μs (5%) |         |  72.28 KiB (1%) |        3748 |
...
| `["teerf_filter", "noinit"]`                                   | 295.818 ns (5%) |         |   80 bytes (1%) |           3 |
| `["teerf_filter", "withinit"]`                                 | 173.755 ns (5%) |         |                 |             |
...
| `["cat", "base"]`                                              |   1.761 μs (5%) |         |                 |             |
| `["cat", "xf"]`                                                |   1.016 μs (5%) |         |                 |             |
| `["collect", "filter-missing"]`                                | 501.377 ns (5%) |         |   9.94 KiB (1%) |           1 |
| `["collect", "identity-float"]`                                |   2.309 μs (5%) |         |  78.17 KiB (1%) |           2 |
...
| `["filter_sum", "1000", "RandomFloats", "withinit", "naive"]`  | 603.275 ns (5%) |         |                 |             |
| `["filter_sum", "1000", "RandomFloats", "withinit", "xf"]`     |   1.214 μs (5%) |         |                 |             |
| `["filter_sum", "1000", "UnitRange", "noinit", "base"]`        | 626.199 ns (5%) |         |                 |             |
| `["filter_sum", "1000", "UnitRange", "noinit", "naive"]`       | 626.842 ns (5%) |         |                 |             |
| `["filter_sum", "1000", "UnitRange", "noinit", "xf"]`          | 164.318 ns (5%) |         |                 |             |
| `["filter_sum", "1000", "UnitRange", "withinit", "base"]`      | 113.956 ns (5%) |         |                 |             |
| `["filter_sum", "1000", "UnitRange", "withinit", "naive"]`     | 625.263 ns (5%) |         |                 |             |
...
| `["findall", "base"]`                                          | 109.054 μs (5%) |         | 797.20 KiB (1%) |           8 |
| `["findall", "xf-array"]`                                      | 977.509 μs (5%) |         |   2.94 MiB (1%) |       96426 |
| `["findall", "xf-iter"]`                                       | 678.530 μs (5%) |         |   1.83 MiB (1%) |          14 |
...
| `["groupby", "sum", "xf-with-init"]`                           | 100.498 μs (5%) |         |   1.05 KiB (1%) |           9 |
| `["groupby", "sum", "xf-without-init"]`                        | 100.909 μs (5%) |         |   1.05 KiB (1%) |           9 |
| `["mapcat_eduction", "base"]`                                  |  31.379 μs (5%) |         |                 |             |
| `["mapcat_eduction", "xf-eduction"]`                           |   1.015 μs (5%) |         |                 |             |
| `["mapcat_eduction", "xf-xf"]`                                 |   1.015 μs (5%) |         |                 |             |
| `["missing_argmax", "man"]`                                    |   1.093 μs (5%) |         |                 |             |
| `["missing_argmax", "rf"]`                                     | 759.758 ns (5%) |         |                 |             |
| `["missing_argmax", "xf"]`                                     | 740.156 ns (5%) |         |   32 bytes (1%) |           1 |
| `["missing_dot", "equiv"]`                                     |   1.916 μs (5%) |         |   16 bytes (1%) |           1 |
| `["missing_dot", "man"]`                                       | 836.179 ns (5%) |         |   16 bytes (1%) |           1 |
| `["missing_dot", "naive"]`                                     |   2.747 μs (5%) |         |   16 bytes (1%) |           1 |
| `["missing_dot", "rf"]`                                        | 841.442 ns (5%) |         |   16 bytes (1%) |           1 |
| `["missing_dot", "rf_nota"]`                                   |   1.897 μs (5%) |         |   16 bytes (1%) |           1 |
| `["missing_dot", "xf"]`                                        |  67.086 μs (5%) |         |  72.19 KiB (1%) |        3744 |
| `["missing_dot", "xf_nota"]`                                   |  66.965 μs (5%) |         |  72.12 KiB (1%) |        3742 |
| `["overhead", "foldl"]`                                        |   3.095 ns (5%) |         |                 |             |
| `["overhead", "reduce_basecase"]`                              |  75.187 ns (5%) |         |   16 bytes (1%) |           1 |
...
| `["sum_transpose", "30", "withinit", "xf"]`                    | 805.681 ns (5%) |         |                 |             |
| `["teerf_filter", "noinit"]`                                   | 291.947 ns (5%) |         |   80 bytes (1%) |           3 |
