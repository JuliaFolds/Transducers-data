...
Platform Info:
  ...
  CPU: AMD EPYC 7763 64-Core Processor: 
       ...
       #1  3000 MHz       1515 s          0 s        110 s       5614 s          0 s
       #2  2445 MHz       1994 s          0 s         93 s       5147 s          0 s
       #3  3242 MHz       1571 s          0 s        117 s       5559 s          0 s
       #4  3256 MHz       1398 s          0 s        106 s       5735 s          0 s
       
  Memory: 15.606491088867188 GB (12510.31640625 MB free)
  Uptime: 727.3 sec
...
Platform Info:
  ...
  CPU: AMD EPYC 7763 64-Core Processor: 
              speed         user         nice          sys         idle          irq
       #1  2625 MHz       2635 s          0 s        130 s       6996 s          0 s
       #2  2445 MHz       2491 s          0 s        116 s       7149 s          0 s
       #3  3103 MHz       2035 s          0 s        154 s       7580 s          0 s
       #4  3241 MHz       1897 s          0 s        128 s       7737 s          0 s
       
  Memory: 15.606491088867188 GB (12412.05859375 MB free)
  Uptime: 979.95 sec
...
| `["cartesian", "copyto!", "man"]`                              |   1.586 μs (5%) |         |                 |             |
| `["cartesian", "copyto!", "xf"]`                               |   1.653 μs (5%) |         |                 |             |
| `["cat", "base"]`                                              |   1.741 μs (5%) |         |                 |             |
| `["cat", "xf"]`                                                |   1.015 μs (5%) |         |                 |             |
| `["collect", "filter-missing"]`                                | 583.876 ns (5%) |         |   9.94 KiB (1%) |           1 |
| `["collect", "identity-float"]`                                |   2.834 μs (5%) |         |  78.17 KiB (1%) |           2 |
...
| `["filter_sum", "1000", "RandomFloats", "withinit", "naive"]`  | 602.783 ns (5%) |         |                 |             |
...
| `["filter_sum", "1000", "UnitRange", "withinit", "xf"]`        | 114.503 ns (5%) |         |                 |             |
| `["filter_sum", "10000", "RandomFloats", "noinit", "base"]`    |  33.923 μs (5%) |         |                 |             |
| `["filter_sum", "10000", "RandomFloats", "noinit", "naive"]`   |  15.108 μs (5%) |         |                 |             |
| `["filter_sum", "10000", "RandomFloats", "noinit", "xf"]`      |  12.343 μs (5%) |         |                 |             |
| `["filter_sum", "10000", "RandomFloats", "withinit", "base"]`  |  12.343 μs (5%) |         |                 |             |
| `["filter_sum", "10000", "RandomFloats", "withinit", "naive"]` |   8.853 μs (5%) |         |                 |             |
...
| `["findall", "base"]`                                          | 108.705 μs (5%) |         | 797.20 KiB (1%) |           8 |
| `["findall", "xf-array"]`                                      | 989.238 μs (5%) |         |   2.94 MiB (1%) |       96426 |
| `["findall", "xf-iter"]`                                       | 690.119 μs (5%) |         |   1.83 MiB (1%) |          14 |
...
| `["gemm", "fusedmul", "xf", "2"]`                              | 307.174 μs (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "fusedmul", "xf", "32"]`                             |   5.027 ms (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "fusedmul", "xf", "8"]`                              |   1.226 ms (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "mul", "linalg", "256"]`                             | 766.602 μs (5%) |         |                 |             |
| `["gemm", "mul", "linalg", "32"]`                              |   2.829 μs (5%) |         |                 |             |
| `["gemm", "mul", "linalg", "8"]`                               | 167.146 ns (5%) |         |                 |             |
| `["gemm", "mul", "man", "false", "256"]`                       |   2.235 ms (5%) |         |                 |             |
| `["gemm", "mul", "man", "false", "32"]`                        |   5.185 μs (5%) |         |                 |             |
| `["gemm", "mul", "man", "false", "8"]`                         | 289.911 ns (5%) |         |                 |             |
| `["gemm", "mul", "man", "ivdep", "256"]`                       |   2.224 ms (5%) |         |                 |             |
| `["gemm", "mul", "man", "ivdep", "32"]`                        |   4.537 μs (5%) |         |                 |             |
| `["gemm", "mul", "man", "ivdep", "8"]`                         | 277.443 ns (5%) |         |                 |             |
| `["gemm", "mul", "man", "true", "256"]`                        |   2.245 ms (5%) |         |                 |             |
| `["gemm", "mul", "man", "true", "32"]`                         |   4.923 μs (5%) |         |                 |             |
| `["gemm", "mul", "man", "true", "8"]`                          | 291.861 ns (5%) |         |                 |             |
...
| `["groupby", "sum", "sac"]`                                    |  95.368 μs (5%) |         |   1.64 KiB (1%) |          11 |
| `["groupby", "sum", "xf-with-init"]`                           |  96.680 μs (5%) |         |   1.05 KiB (1%) |           9 |
...
| `["missing_argmax", "rf"]`                                     | 750.346 ns (5%) |         |                 |             |
| `["missing_argmax", "xf"]`                                     | 757.842 ns (5%) |         |   32 bytes (1%) |           1 |
| `["missing_dot", "equiv"]`                                     |   1.784 μs (5%) |         |   16 bytes (1%) |           1 |
| `["missing_dot", "man"]`                                       | 838.627 ns (5%) |         |   16 bytes (1%) |           1 |
| `["missing_dot", "naive"]`                                     |   2.726 μs (5%) |         |   16 bytes (1%) |           1 |
| `["missing_dot", "rf"]`                                        |   1.119 μs (5%) |         |   16 bytes (1%) |           1 |
| `["missing_dot", "rf_nota"]`                                   |   1.792 μs (5%) |         |   16 bytes (1%) |           1 |
| `["missing_dot", "xf"]`                                        |  67.295 μs (5%) |         |  72.02 KiB (1%) |        3736 |
| `["missing_dot", "xf_nota"]`                                   |  67.145 μs (5%) |         |  72.03 KiB (1%) |        3738 |
| `["overhead", "foldl"]`                                        |   2.795 ns (5%) |         |                 |             |
| `["overhead", "reduce_basecase"]`                              |  75.769 ns (5%) |         |   16 bytes (1%) |           1 |
| `["partition_by", "man"]`                                      |   1.861 ms (5%) |         |  480 bytes (1%) |           3 |
| `["partition_by", "xf"]`                                       |   2.173 ms (5%) |         |  592 bytes (1%) |           5 |
| `["set", "base"]`                                              |   2.671 ms (5%) |         |  49.14 KiB (1%) |          17 |
| `["set", "xf"]`                                                |   2.720 ms (5%) |         |  49.17 KiB (1%) |          19 |
...
| `["teerf_filter", "noinit"]`                                   | 291.321 ns (5%) |         |   80 bytes (1%) |           3 |
| `["teerf_filter", "withinit"]`                                 | 172.384 ns (5%) |         |                 |             |
...
## Job Properties
* Time of benchmark: 14 Sep 2024 - 1:49
...
| `["cat", "base"]`                                              |   1.739 μs (5%) |         |                 |             |
| `["cat", "xf"]`                                                |   1.015 μs (5%) |         |                 |             |
| `["collect", "filter-missing"]`                                | 564.124 ns (5%) |         |   9.94 KiB (1%) |           1 |
| `["collect", "identity-float"]`                                |   4.090 μs (5%) |         |  78.17 KiB (1%) |           2 |
| `["collect", "identity-union"]`                                | 103.633 μs (5%) |         | 400.53 KiB (1%) |       10003 |
...
| `["filter_sum", "1000", "RandomFloats", "withinit", "naive"]`  | 800.520 ns (5%) |         |                 |             |
...
| `["findall", "xf-array"]`                                      | 985.149 μs (5%) |         |   2.94 MiB (1%) |       96426 |
| `["findall", "xf-iter"]`                                       | 693.434 μs (5%) |         |   1.83 MiB (1%) |          14 |
...
| `["gemm", "fusedmul", "xf", "2"]`                              | 308.716 μs (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "fusedmul", "xf", "32"]`                             |   5.130 ms (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "fusedmul", "xf", "8"]`                              |   1.211 ms (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "mul", "linalg", "256"]`                             | 771.801 μs (5%) |         |                 |             |
...
| `["gemm", "mul", "xf", "true", "256"]`                         |   2.145 ms (5%) |         |   80 bytes (1%) |           3 |
...
| `["missing_argmax", "rf"]`                                     | 888.010 ns (5%) |         |                 |             |
| `["missing_argmax", "xf"]`                                     | 756.833 ns (5%) |         |   32 bytes (1%) |           1 |
| `["missing_dot", "equiv"]`                                     |   1.885 μs (5%) |         |   16 bytes (1%) |           1 |
| `["missing_dot", "man"]`                                       | 834.080 ns (5%) |         |   16 bytes (1%) |           1 |
...
| `["missing_dot", "xf"]`                                        |  68.418 μs (5%) |         |  72.20 KiB (1%) |        3744 |
| `["missing_dot", "xf_nota"]`                                   |  68.267 μs (5%) |         |  72.11 KiB (1%) |        3742 |
| `["overhead", "foldl"]`                                        |   2.795 ns (5%) |         |                 |             |
...
| `["teerf_filter", "noinit"]`                                   | 289.989 ns (5%) |         |   80 bytes (1%) |           3 |
| `["teerf_filter", "withinit"]`                                 | 174.724 ns (5%) |         |                 |             |
