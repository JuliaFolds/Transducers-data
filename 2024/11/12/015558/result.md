...
Platform Info:
  ...
  CPU: AMD EPYC 7763 64-Core Processor: 
       ...
       #1  2445 MHz       1924 s          0 s         94 s       5782 s          0 s
       #2  3243 MHz       1876 s          0 s        125 s       5795 s          0 s
       #3  2445 MHz        799 s          0 s         93 s       6902 s          0 s
       #4  2722 MHz       1910 s          0 s        115 s       5773 s          0 s
       
  Memory: 15.606491088867188 GB (12506.37109375 MB free)
  Uptime: 783.3 sec
...
Platform Info:
  ...
  CPU: AMD EPYC 7763 64-Core Processor: 
              speed         user         nice          sys         idle          irq
       #1  2559 MHz       3154 s          0 s        111 s       7098 s          0 s
       #2  3199 MHz       2532 s          0 s        144 s       7682 s          0 s
       #3  2445 MHz       1495 s          0 s        138 s       8724 s          0 s
       #4  3243 MHz       1950 s          0 s        140 s       8269 s          0 s
       
  Memory: 15.606491088867188 GB (12388.0 MB free)
  Uptime: 1039.93 sec
...
| `["cat", "base"]`                                              |   1.743 μs (5%) |         |                 |             |
| `["cat", "xf"]`                                                |   1.016 μs (5%) |         |                 |             |
| `["collect", "filter-missing"]`                                | 456.216 ns (5%) |         |   9.94 KiB (1%) |           1 |
...
| `["filter_sum", "1000", "RandomFloats", "withinit", "naive"]`  | 671.617 ns (5%) |         |                 |             |
...
| `["filter_sum", "1000", "UnitRange", "withinit", "xf"]`        | 113.851 ns (5%) |         |                 |             |
...
| `["sum_transpose", "30", "noinit", "man"]`                     |   3.090 μs (5%) |         |                 |             |
| `["sum_transpose", "30", "noinit", "xf"]`                      | 805.791 ns (5%) |         |                 |             |
| `["sum_transpose", "30", "withinit", "iter"]`                  | 866.603 ns (5%) |         |                 |             |
| `["sum_transpose", "30", "withinit", "man"]`                   | 805.121 ns (5%) |         |                 |             |
| `["sum_transpose", "30", "withinit", "xf"]`                    | 805.681 ns (5%) |         |                 |             |
| `["teerf_filter", "noinit"]`                                   | 290.360 ns (5%) |         |   80 bytes (1%) |           3 |
| `["teerf_filter", "withinit"]`                                 | 174.917 ns (5%) |         |                 |             |
...
## Job Properties
* Time of benchmark: 12 Nov 2024 - 1:53
...
| `["cat", "base"]`                                              |   1.660 μs (5%) |         |                 |             |
| `["cat", "xf"]`                                                |   1.016 μs (5%) |         |                 |             |
| `["collect", "filter-missing"]`                                | 527.170 ns (5%) |         |   9.94 KiB (1%) |           1 |
| `["collect", "identity-float"]`                                |   4.063 μs (5%) |         |  78.17 KiB (1%) |           2 |
| `["collect", "identity-union"]`                                | 104.656 μs (5%) |         | 400.53 KiB (1%) |       10003 |
...
| `["dot", "rf"]`                                                |   1.574 μs (5%) |         |                 |             |
| `["dot", "xf"]`                                                |   1.575 μs (5%) |         |                 |             |
| `["filter_map_map!", "man"]`                                   |  47.790 μs (5%) |         |                 |             |
...
| `["filter_sum", "1000", "RandomFloats", "withinit", "naive"]`  | 647.257 ns (5%) |         |                 |             |
| `["filter_sum", "1000", "RandomFloats", "withinit", "xf"]`     |   1.210 μs (5%) |         |                 |             |
...
| `["findall", "xf-iter"]`                                       | 692.366 μs (5%) |         |   1.83 MiB (1%) |          14 |
| `["gemm", "fusedmul", "blas", "16"]`                           |   2.595 ms (5%) |         |                 |             |
| `["gemm", "fusedmul", "blas", "2"]`                            |   1.775 ms (5%) |         |                 |             |
| `["gemm", "fusedmul", "blas", "32"]`                           |   4.172 ms (5%) |         |                 |             |
| `["gemm", "fusedmul", "blas", "8"]`                            |   1.861 ms (5%) |         |                 |             |
| `["gemm", "fusedmul", "xf", "16"]`                             |   2.582 ms (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "fusedmul", "xf", "2"]`                              | 330.199 μs (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "fusedmul", "xf", "32"]`                             |   5.288 ms (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "fusedmul", "xf", "8"]`                              |   1.299 ms (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "mul", "linalg", "256"]`                             | 769.410 μs (5%) |         |                 |             |
...
| `["groupby", "sum", "sac"]`                                    |   7.025 ms (5%) |         |  13.14 KiB (1%) |         103 |
...
| `["missing_argmax", "rf"]`                                     | 757.585 ns (5%) |         |                 |             |
| `["missing_argmax", "xf"]`                                     | 888.792 ns (5%) |         |   32 bytes (1%) |           1 |
...
| `["missing_dot", "xf"]`                                        |  68.188 μs (5%) |         |  72.20 KiB (1%) |        3744 |
| `["missing_dot", "xf_nota"]`                                   |  68.047 μs (5%) |         |  72.11 KiB (1%) |        3742 |
| `["overhead", "foldl"]`                                        |   2.785 ns (5%) |         |                 |             |
| `["overhead", "reduce_basecase"]`                              |  78.819 ns (5%) |         |   16 bytes (1%) |           1 |
...
| `["sum_transpose", "30", "withinit", "man"]`                   | 805.121 ns (5%) |         |                 |             |
| `["sum_transpose", "30", "withinit", "xf"]`                    | 805.681 ns (5%) |         |                 |             |
| `["teerf_filter", "noinit"]`                                   | 292.901 ns (5%) |         |   80 bytes (1%) |           3 |
