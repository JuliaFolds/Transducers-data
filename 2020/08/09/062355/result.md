...
| ID                                                                                               | time            | GC time | memory          | allocations |
|--------------------------------------------------------------------------------------------------|----------------:|--------:|----------------:|------------:|
| `["append!!", "eduction"]`                                                                       |  21.703 μs (5%) |         |  64.72 KiB (1%) |          18 |
| `["append!!", "xf"]`                                                                             |  21.202 μs (5%) |         |  64.72 KiB (1%) |          18 |
| `["cat", "base"]`                                                                                |   1.922 μs (5%) |         |                 |             |
| `["cat", "xf"]`                                                                                  |   2.611 μs (5%) |         |                 |             |
| `["collect", "filter-missing"]`                                                                  | 120.813 μs (5%) |         | 345.31 KiB (1%) |       10015 |
| `["collect", "identity-float"]`                                                                  |  84.909 μs (5%) |         | 569.16 KiB (1%) |       10015 |
| `["collect", "identity-union"]`                                                                  | 347.237 μs (5%) |         | 705.34 KiB (1%) |       16681 |
| `["dict", "base"]`                                                                               |   4.710 ms (5%) |         |  92.91 KiB (1%) |          22 |
| `["dict", "xf"]`                                                                                 |   4.806 ms (5%) |         |  92.36 KiB (1%) |          21 |
| `["dot", "blas"]`                                                                                |   1.440 μs (5%) |         |                 |             |
| `["dot", "man"]`                                                                                 |   1.320 μs (5%) |         |                 |             |
| `["dot", "rf"]`                                                                                  |   2.423 μs (5%) |         |                 |             |
| `["dot", "xf"]`                                                                                  |   2.511 μs (5%) |         |   64 bytes (1%) |           3 |
| `["filter_map_map!", "man"]`                                                                     |  59.204 μs (5%) |         |                 |             |
| `["filter_map_map!", "xf"]`                                                                      | 746.856 μs (5%) |         |  304 bytes (1%) |          17 |
| `["filter_map_reduce", "man"]`                                                                   | 255.926 μs (5%) |         |                 |             |
| `["filter_map_reduce", "xf"]`                                                                    | 255.926 μs (5%) |         |                 |             |
| `["filter_sum", ":n => 1000", ":xs => :RandomFloats", ":withinit => false", ":impl => :base"]`   |   1.700 μs (5%) |         |                 |             |
| `["filter_sum", ":n => 1000", ":xs => :RandomFloats", ":withinit => false", ":impl => :naive"]`  |   1.500 μs (5%) |         |                 |             |
| `["filter_sum", ":n => 1000", ":xs => :RandomFloats", ":withinit => false", ":impl => :xf"]`     |   1.600 μs (5%) |         |                 |             |
| `["filter_sum", ":n => 1000", ":xs => :RandomFloats", ":withinit => true", ":impl => :base"]`    |   2.100 μs (5%) |         |                 |             |
...
| `["gemm", "mul", "man", "ivdep", "256"]`                                                         |   1.846 ms (5%) |         |                 |             |
