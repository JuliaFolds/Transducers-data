...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
       ...
       #1  2593 MHz       2085 s          2 s        109 s       5733 s          0 s
       #2  2593 MHz       5178 s          1 s        136 s       2632 s          0 s
       
  Memory: 6.7845458984375 GB (3751.38671875 MB free)
  Uptime: 798.46 sec
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
              speed         user         nice          sys         idle          irq
       #1  2593 MHz       4782 s          2 s        154 s       5833 s          0 s
       #2  2593 MHz       5356 s          1 s        161 s       5260 s          0 s
       
  Memory: 6.7845458984375 GB (3362.1875 MB free)
  Uptime: 1082.7 sec
...
## Job Properties
* Time of benchmark: 26 Mar 2022 - 1:39
...
| `["collect", "identity-union"]`                                | 156.601 μs (5%) |         | 679.41 KiB (1%) |       10010 |
...
| `["groupby", "sum", "sac"]`                                    | 152.000 μs (5%) |         |   1.64 KiB (1%) |          11 |
| `["groupby", "sum", "xf-with-init"]`                           | 145.401 μs (5%) |         |   1.05 KiB (1%) |           9 |
| `["groupby", "sum", "xf-without-init"]`                        | 141.800 μs (5%) |         |   1.05 KiB (1%) |           9 |
...
| `["missing_dot", "xf"]`                                        |  95.201 μs (5%) |         |  72.11 KiB (1%) |        3742 |
| `["missing_dot", "xf_nota"]`                                   |  94.900 μs (5%) |         |  72.25 KiB (1%) |        3746 |
| `["overhead", "foldl"]`                                        |   3.300 ns (5%) |         |                 |             |
| `["overhead", "reduce_basecase"]`                              |  98.623 ns (5%) |         |   16 bytes (1%) |           1 |
| `["partition_by", "man"]`                                      |   2.478 ms (5%) |         |  480 bytes (1%) |           3 |
| `["partition_by", "xf"]`                                       |   2.668 ms (5%) |         |  592 bytes (1%) |           5 |
| `["set", "base"]`                                              |   4.475 ms (5%) |         |  49.14 KiB (1%) |          17 |
...
| `["teerf_filter", "noinit"]`                                   | 382.358 ns (5%) |         |   80 bytes (1%) |           3 |
| `["teerf_filter", "withinit"]`                                 | 215.963 ns (5%) |         |                 |             |
...
| `["collect", "identity-union"]`                                | 162.201 μs (5%) |         | 679.41 KiB (1%) |       10010 |
...
| `["findall", "base"]`                                          | 143.601 μs (5%) |         | 797.20 KiB (1%) |           8 |
| `["findall", "xf-array"]`                                      |   1.299 ms (5%) |         |   2.94 MiB (1%) |       96426 |
| `["findall", "xf-iter"]`                                       | 859.804 μs (5%) |         |   1.83 MiB (1%) |          14 |
...
| `["groupby", "sum", "sac"]`                                    |   8.152 ms (5%) |         |  13.12 KiB (1%) |         102 |
| `["groupby", "sum", "xf-with-init"]`                           | 146.400 μs (5%) |         |   1.05 KiB (1%) |           9 |
...
| `["missing_dot", "xf"]`                                        |  98.601 μs (5%) |         |  72.05 KiB (1%) |        3736 |
| `["missing_dot", "xf_nota"]`                                   |  94.800 μs (5%) |         |  72.20 KiB (1%) |        3746 |
| `["overhead", "foldl"]`                                        |   3.700 ns (5%) |         |                 |             |
| `["overhead", "reduce_basecase"]`                              |  99.260 ns (5%) |         |   16 bytes (1%) |           1 |
| `["partition_by", "man"]`                                      |   2.493 ms (5%) |         |  480 bytes (1%) |           3 |
| `["partition_by", "xf"]`                                       |   2.684 ms (5%) |         |  592 bytes (1%) |           5 |
...
| `["teerf_filter", "withinit"]`                                 | 214.423 ns (5%) |         |                 |             |
