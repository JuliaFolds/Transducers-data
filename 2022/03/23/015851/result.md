...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
       ...
       #1  2593 MHz        454 s          1 s        106 s       7523 s          0 s
       #2  2593 MHz       7010 s          1 s        142 s        979 s          0 s
       
  Memory: 6.7845458984375 GB (3733.92578125 MB free)
  Uptime: 815.67 sec
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
              speed         user         nice          sys         idle          irq
       #1  2593 MHz       3235 s          1 s        150 s       7638 s          0 s
       #2  2593 MHz       7183 s          1 s        168 s       3711 s          0 s
       
  Memory: 6.7845458984375 GB (3612.7578125 MB free)
  Uptime: 1109.64 sec
...
| `["collect", "identity-union"]`                                | 161.901 μs (5%) |         | 679.41 KiB (1%) |       10010 |
...
| `["filter_sum", "1000", "RandomFloats", "withinit", "naive"]`  | 702.797 ns (5%) |         |                 |             |
...
| `["filter_sum", "1000", "UnitRange", "withinit", "xf"]`        | 138.287 ns (5%) |         |                 |             |
...
| `["gemm", "fusedmul", "blas", "16"]`                           |   2.770 ms (5%) |         |                 |             |
...
| `["gemm", "fusedmul", "xf", "2"]`                              | 656.204 μs (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "fusedmul", "xf", "32"]`                             |  10.614 ms (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "fusedmul", "xf", "8"]`                              |   2.631 ms (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "mul", "linalg", "256"]`                             | 511.903 μs (5%) |         |                 |             |
| `["gemm", "mul", "linalg", "32"]`                              |   1.560 μs (5%) |         |                 |             |
| `["gemm", "mul", "linalg", "8"]`                               | 219.765 ns (5%) |         |                 |             |
...
| `["groupby", "sum", "sac"]`                                    | 154.601 μs (5%) |         |   1.64 KiB (1%) |          11 |
...
| `["missing_dot", "xf"]`                                        |  95.901 μs (5%) |         |  72.33 KiB (1%) |        3749 |
| `["missing_dot", "xf_nota"]`                                   |  95.601 μs (5%) |         |  72.20 KiB (1%) |        3745 |
...
| `["teerf_filter", "withinit"]`                                 | 212.525 ns (5%) |         |                 |             |
...
## Job Properties
* Time of benchmark: 23 Mar 2022 - 1:57
...
| `["cat", "base"]`                                              |   2.010 μs (5%) |         |                 |             |
| `["cat", "xf"]`                                                |   1.660 μs (5%) |         |                 |             |
| `["collect", "filter-missing"]`                                |  63.600 μs (5%) |         |  41.33 KiB (1%) |          10 |
| `["collect", "identity-float"]`                                |  18.200 μs (5%) |         | 326.61 KiB (1%) |          10 |
| `["collect", "identity-union"]`                                | 158.901 μs (5%) |         | 679.41 KiB (1%) |       10010 |
...
| `["filter_sum", "1000", "UnitRange", "noinit", "naive"]`       |   1.020 μs (5%) |         |                 |             |
| `["filter_sum", "1000", "UnitRange", "noinit", "xf"]`          | 190.808 ns (5%) |         |                 |             |
| `["filter_sum", "1000", "UnitRange", "withinit", "base"]`      | 136.664 ns (5%) |         |                 |             |
| `["filter_sum", "1000", "UnitRange", "withinit", "naive"]`     | 912.500 ns (5%) |         |                 |             |
| `["filter_sum", "1000", "UnitRange", "withinit", "xf"]`        | 130.973 ns (5%) |         |                 |             |
| `["filter_sum", "10000", "RandomFloats", "noinit", "base"]`    |  30.300 μs (5%) |         |                 |             |
...
| `["groupby", "sum", "sac"]`                                    |   8.143 ms (5%) |         |  13.12 KiB (1%) |         102 |
| `["groupby", "sum", "xf-with-init"]`                           | 147.101 μs (5%) |         |   1.05 KiB (1%) |           9 |
| `["groupby", "sum", "xf-without-init"]`                        | 142.000 μs (5%) |         |   1.05 KiB (1%) |           9 |
...
| `["missing_dot", "xf"]`                                        |  94.601 μs (5%) |         |  72.00 KiB (1%) |        3736 |
| `["missing_dot", "xf_nota"]`                                   |  94.801 μs (5%) |         |  72.17 KiB (1%) |        3744 |
| `["overhead", "foldl"]`                                        |   3.300 ns (5%) |         |                 |             |
| `["overhead", "reduce_basecase"]`                              |  99.047 ns (5%) |         |   16 bytes (1%) |           1 |
| `["partition_by", "man"]`                                      |   2.485 ms (5%) |         |  480 bytes (1%) |           3 |
| `["partition_by", "xf"]`                                       |   2.652 ms (5%) |         |  592 bytes (1%) |           5 |
| `["set", "base"]`                                              |   4.271 ms (5%) |         |  49.14 KiB (1%) |          17 |
...
| `["sum_transpose", "30", "withinit", "man"]`                   |   1.150 μs (5%) |         |                 |             |
| `["sum_transpose", "30", "withinit", "xf"]`                    |   1.230 μs (5%) |         |   48 bytes (1%) |           3 |
| `["teerf_filter", "noinit"]`                                   | 400.990 ns (5%) |         |   80 bytes (1%) |           3 |
