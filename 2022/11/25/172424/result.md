...
## Job Properties
* Time of benchmarks:
    - Target: 25 Nov 2022 - 17:17
    - Baseline: 25 Nov 2022 - 17:22
* Package commits:
    - Target: 5b4056
    - Baseline: 958213
* Julia commits:
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
       ...
       #1  2593 MHz       5660 s          0 s        181 s       1812 s          0 s
       #2  2593 MHz       1852 s          0 s        136 s       5624 s          0 s
       
  Memory: 6.781219482421875 GB (3788.41796875 MB free)
  Uptime: 771.46 sec
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
              speed         user         nice          sys         idle          irq
       #1  2593 MHz       5757 s          0 s        191 s       4591 s          0 s
       #2  2593 MHz       4624 s          0 s        171 s       5714 s          0 s
       
  Memory: 6.781219482421875 GB (3703.91015625 MB free)
  Uptime: 1061.21 sec
...
## Job Properties
* Time of benchmark: 25 Nov 2022 - 17:17
...
| `["collect", "identity-union"]`                                | 156.602 μs (5%) |         | 679.41 KiB (1%) |       10010 |
...
| `["filter_sum", "1000", "UnitRange", "withinit", "xf"]`        | 134.373 ns (5%) |         |                 |             |
...
| `["findall", "base"]`                                          | 155.802 μs (5%) |         | 797.20 KiB (1%) |           8 |
| `["findall", "xf-array"]`                                      |   1.375 ms (5%) |         |   2.94 MiB (1%) |       96426 |
| `["findall", "xf-iter"]`                                       | 885.008 μs (5%) |         |   1.83 MiB (1%) |          14 |
| `["gemm", "fusedmul", "blas", "16"]`                           |   2.783 ms (5%) |         |                 |             |
| `["gemm", "fusedmul", "blas", "2"]`                            |   2.143 ms (5%) |         |                 |             |
...
| `["gemm", "mul", "linalg", "8"]`                               | 221.343 ns (5%) |         |                 |             |
...
| `["gemm", "mul", "man", "ivdep", "8"]`                         | 379.902 ns (5%) |         |                 |             |
| `["gemm", "mul", "man", "true", "256"]`                        |   3.122 ms (5%) |         |                 |             |
| `["gemm", "mul", "man", "true", "32"]`                         |   5.933 μs (5%) |         |                 |             |
| `["gemm", "mul", "man", "true", "8"]`                          | 403.483 ns (5%) |         |                 |             |
...
| `["gemm", "mul", "xf", "ivdep", "256"]`                        |   3.096 ms (5%) |         |   80 bytes (1%) |           3 |
| `["gemm", "mul", "xf", "ivdep", "32"]`                         |   5.583 μs (5%) |         |   80 bytes (1%) |           3 |
| `["gemm", "mul", "xf", "ivdep", "8"]`                          | 506.218 ns (5%) |         |   80 bytes (1%) |           3 |
| `["gemm", "mul", "xf", "true", "256"]`                         |   3.123 ms (5%) |         |   80 bytes (1%) |           3 |
| `["gemm", "mul", "xf", "true", "32"]`                          |   6.080 μs (5%) |         |   80 bytes (1%) |           3 |
| `["gemm", "mul", "xf", "true", "8"]`                           | 535.455 ns (5%) |         |   80 bytes (1%) |           3 |
| `["groupby", "sum", "sac"]`                                    |   8.300 ms (5%) |         |  13.14 KiB (1%) |         103 |
| `["groupby", "sum", "xf-with-init"]`                           | 140.201 μs (5%) |         |   1.05 KiB (1%) |           9 |
...
| `["missing_dot", "xf"]`                                        |  95.901 μs (5%) |         |  72.23 KiB (1%) |        3746 |
| `["missing_dot", "xf_nota"]`                                   |  96.501 μs (5%) |         |  72.30 KiB (1%) |        3750 |
| `["overhead", "foldl"]`                                        |   3.300 ns (5%) |         |                 |             |
| `["overhead", "reduce_basecase"]`                              |  99.472 ns (5%) |         |   16 bytes (1%) |           1 |
| `["partition_by", "man"]`                                      |   2.596 ms (5%) |         |  480 bytes (1%) |           3 |
| `["partition_by", "xf"]`                                       |   2.769 ms (5%) |         |  592 bytes (1%) |           5 |
| `["set", "base"]`                                              |   4.213 ms (5%) |         |  49.14 KiB (1%) |          17 |
| `["set", "xf"]`                                                |   4.018 ms (5%) |         |  49.17 KiB (1%) |          19 |
...
| `["teerf_filter", "noinit"]`                                   | 388.293 ns (5%) |         |   80 bytes (1%) |           3 |
...
## Job Properties
* Time of benchmark: 25 Nov 2022 - 17:22
...
| `["cat", "base"]`                                              |   2.010 μs (5%) |         |                 |             |
| `["cat", "xf"]`                                                |   1.660 μs (5%) |         |                 |             |
| `["collect", "filter-missing"]`                                |  64.101 μs (5%) |         |  41.33 KiB (1%) |          10 |
| `["collect", "identity-float"]`                                |  22.300 μs (5%) |         | 326.61 KiB (1%) |          10 |
| `["collect", "identity-union"]`                                | 154.703 μs (5%) |         | 679.41 KiB (1%) |       10010 |
...
| `["findall", "xf-iter"]`                                       | 887.814 μs (5%) |         |   1.83 MiB (1%) |          14 |
...
| `["gemm", "fusedmul", "xf", "2"]`                              | 677.111 μs (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "fusedmul", "xf", "32"]`                             |  10.914 ms (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "fusedmul", "xf", "8"]`                              |   2.715 ms (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "mul", "linalg", "256"]`                             | 514.207 μs (5%) |         |                 |             |
...
| `["groupby", "sum", "sac"]`                                    |   8.281 ms (5%) |         |  13.14 KiB (1%) |         103 |
...
| `["missing_dot", "xf"]`                                        |  95.701 μs (5%) |         |  72.17 KiB (1%) |        3744 |
| `["missing_dot", "xf_nota"]`                                   |  95.402 μs (5%) |         |  72.11 KiB (1%) |        3740 |
| `["overhead", "foldl"]`                                        |   3.300 ns (5%) |         |                 |             |
| `["overhead", "reduce_basecase"]`                              | 102.114 ns (5%) |         |   16 bytes (1%) |           1 |
