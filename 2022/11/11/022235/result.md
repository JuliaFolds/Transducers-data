...
## Job Properties
* Time of benchmarks:
    - Target: 11 Nov 2022 - 02:16
    - Baseline: 11 Nov 2022 - 02:21
* Package commits:
    - Target: d8a04e
    - Baseline: 958213
* Julia commits:
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
       ...
       #1  2593 MHz       4809 s          1 s        131 s       2384 s          0 s
       #2  2593 MHz       2360 s          1 s        175 s       4801 s          0 s
       
  Memory: 6.78125 GB (3546.55859375 MB free)
  Uptime: 738.1 sec
  Load Avg:  1.02  0.95  0.6
  WORD_SIZE: 64
  LIBM: libopenlibm
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
              speed         user         nice          sys         idle          irq
       #1  2593 MHz       4978 s          1 s        156 s       5046 s          0 s
       #2  2593 MHz       5068 s          1 s        221 s       4913 s          0 s
       
  Memory: 6.78125 GB (3401.88671875 MB free)
  Uptime: 1024.72 sec
...
## Job Properties
* Time of benchmark: 11 Nov 2022 - 2:16
...
| `["filter_map_map!", "xf"]`                                    |  60.300 μs (5%) |         |                 |             |
| `["filter_map_reduce", "man"]`                                 | 229.801 μs (5%) |         |                 |             |
...
| `["filter_sum", "1000", "UnitRange", "noinit", "base"]`        | 964.706 ns (5%) |         |                 |             |
| `["filter_sum", "1000", "UnitRange", "noinit", "naive"]`       |   1.020 μs (5%) |         |                 |             |
| `["filter_sum", "1000", "UnitRange", "noinit", "xf"]`          | 187.960 ns (5%) |         |                 |             |
| `["filter_sum", "1000", "UnitRange", "withinit", "base"]`      | 129.405 ns (5%) |         |                 |             |
...
| `["gemm", "fusedmul", "blas", "32"]`                           |   3.395 ms (5%) |         |                 |             |
...
| `["groupby", "sum", "sac"]`                                    | 144.701 μs (5%) |         |   1.64 KiB (1%) |          11 |
| `["groupby", "sum", "xf-with-init"]`                           | 145.801 μs (5%) |         |   1.05 KiB (1%) |           9 |
| `["groupby", "sum", "xf-without-init"]`                        | 137.201 μs (5%) |         |   1.05 KiB (1%) |           9 |
...
| `["missing_dot", "xf"]`                                        |  94.801 μs (5%) |         |  72.19 KiB (1%) |        3744 |
| `["missing_dot", "xf_nota"]`                                   |  94.200 μs (5%) |         |  72.25 KiB (1%) |        3746 |
| `["overhead", "foldl"]`                                        |   3.700 ns (5%) |         |                 |             |
| `["overhead", "reduce_basecase"]`                              | 103.191 ns (5%) |         |   16 bytes (1%) |           1 |
...
| `["teerf_filter", "noinit"]`                                   | 389.557 ns (5%) |         |   80 bytes (1%) |           3 |
...
## Job Properties
* Time of benchmark: 11 Nov 2022 - 2:21
...
| `["collect", "identity-union"]`                                | 150.101 μs (5%) |         | 679.41 KiB (1%) |       10010 |
...
| `["filter_sum", "1000", "UnitRange", "withinit", "naive"]`     | 916.176 ns (5%) |         |                 |             |
| `["filter_sum", "1000", "UnitRange", "withinit", "xf"]`        | 136.343 ns (5%) |         |                 |             |
...
| `["gemm", "mul", "xf", "true", "256"]`                         |   3.179 ms (5%) |         |   80 bytes (1%) |           3 |
| `["gemm", "mul", "xf", "true", "32"]`                          |   6.300 μs (5%) |         |   80 bytes (1%) |           3 |
| `["gemm", "mul", "xf", "true", "8"]`                           | 500.000 ns (5%) |         |   80 bytes (1%) |           3 |
| `["groupby", "sum", "sac"]`                                    |   8.329 ms (5%) |         |  13.12 KiB (1%) |         102 |
| `["groupby", "sum", "xf-with-init"]`                           | 148.102 μs (5%) |         |   1.05 KiB (1%) |           9 |
...
| `["missing_dot", "xf"]`                                        | 100.700 μs (5%) |         |  72.27 KiB (1%) |        3745 |
| `["missing_dot", "xf_nota"]`                                   | 101.200 μs (5%) |         |  72.31 KiB (1%) |        3750 |
...
| `["sum_transpose", "30", "withinit", "man"]`                   |   1.150 μs (5%) |         |                 |             |
| `["sum_transpose", "30", "withinit", "xf"]`                    |   1.230 μs (5%) |         |   48 bytes (1%) |           3 |
| `["teerf_filter", "noinit"]`                                   | 379.602 ns (5%) |         |   80 bytes (1%) |           3 |
