...
## Job Properties
* Time of benchmarks:
    - Target: 27 Nov 2022 - 02:03
    - Baseline: 27 Nov 2022 - 02:07
* Package commits:
    - Target: ddcffe
    - Baseline: bd958e
* Julia commits:
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8370C CPU @ 2.80GHz: 
       ...
       #1  2793 MHz       4727 s          0 s        113 s       2583 s          0 s
       #2  2793 MHz       2390 s          0 s        118 s       4888 s          0 s
       
  Memory: 6.781219482421875 GB (3791.9375 MB free)
  Uptime: 745.88 sec
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8370C CPU @ 2.80GHz: 
              speed         user         nice          sys         idle          irq
       #1  2793 MHz       7389 s          0 s        151 s       2653 s          0 s
       #2  2793 MHz       2519 s          0 s        138 s       7501 s          0 s
       
  Memory: 6.781219482421875 GB (3668.30859375 MB free)
  Uptime: 1022.96 sec
...
## Job Properties
* Time of benchmark: 27 Nov 2022 - 2:3
...
| `["collect", "identity-union"]`                                | 154.698 μs (5%) |         | 679.41 KiB (1%) |       10010 |
...
| `["filter_map_reduce", "man"]`                                 | 314.795 μs (5%) |         |                 |             |
| `["filter_map_reduce", "xf"]`                                  | 315.495 μs (5%) |         |                 |             |
...
| `["filter_sum", "1000", "UnitRange", "withinit", "base"]`      | 166.926 ns (5%) |         |                 |             |
| `["filter_sum", "1000", "UnitRange", "withinit", "naive"]`     | 817.624 ns (5%) |         |                 |             |
...
| `["findall", "xf-iter"]`                                       | 746.688 μs (5%) |         |   1.83 MiB (1%) |          14 |
| `["gemm", "fusedmul", "blas", "16"]`                           |   9.379 ms (5%) |         |                 |             |
| `["gemm", "fusedmul", "blas", "2"]`                            |   2.442 ms (5%) |         |                 |             |
| `["gemm", "fusedmul", "blas", "32"]`                           |  17.132 ms (5%) |         |                 |             |
| `["gemm", "fusedmul", "blas", "8"]`                            |   5.502 ms (5%) |         |                 |             |
| `["gemm", "fusedmul", "xf", "16"]`                             |   4.563 ms (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "fusedmul", "xf", "2"]`                              | 589.694 μs (5%) |         |  192 bytes (1%) |           4 |
...
| `["missing_dot", "xf"]`                                        |  91.399 μs (5%) |         |  72.06 KiB (1%) |        3740 |
| `["missing_dot", "xf_nota"]`                                   |  94.899 μs (5%) |         |  72.19 KiB (1%) |        3744 |
| `["overhead", "foldl"]`                                        |   3.599 ns (5%) |         |                 |             |
| `["overhead", "reduce_basecase"]`                              |  96.952 ns (5%) |         |   16 bytes (1%) |           1 |
...
## Job Properties
* Time of benchmark: 27 Nov 2022 - 2:7
...
| `["collect", "identity-float"]`                                |  17.899 μs (5%) |         | 326.61 KiB (1%) |          10 |
| `["collect", "identity-union"]`                                | 153.799 μs (5%) |         | 679.41 KiB (1%) |       10010 |
...
| `["dot", "rf"]`                                                |   2.244 μs (5%) |         |                 |             |
| `["dot", "xf"]`                                                |   2.255 μs (5%) |         |                 |             |
| `["filter_map_map!", "man"]`                                   |  47.399 μs (5%) |         |                 |             |
| `["filter_map_map!", "xf"]`                                    |  49.799 μs (5%) |         |                 |             |
| `["filter_map_reduce", "man"]`                                 | 314.497 μs (5%) |         |                 |             |
...
| `["findall", "xf-array"]`                                      |   1.240 ms (5%) |         |   2.94 MiB (1%) |       96426 |
| `["findall", "xf-iter"]`                                       | 741.594 μs (5%) |         |   1.83 MiB (1%) |          14 |
| `["gemm", "fusedmul", "blas", "16"]`                           |   9.378 ms (5%) |         |                 |             |
| `["gemm", "fusedmul", "blas", "2"]`                            |   2.454 ms (5%) |         |                 |             |
| `["gemm", "fusedmul", "blas", "32"]`                           |  17.131 ms (5%) |         |                 |             |
| `["gemm", "fusedmul", "blas", "8"]`                            |   5.507 ms (5%) |         |                 |             |
| `["gemm", "fusedmul", "xf", "16"]`                             |   4.654 ms (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "fusedmul", "xf", "2"]`                              | 572.896 μs (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "fusedmul", "xf", "32"]`                             |   9.042 ms (5%) |         |  192 bytes (1%) |           4 |
...
| `["gemm", "mul", "man", "ivdep", "256"]`                       |   3.202 ms (5%) |         |                 |             |
| `["gemm", "mul", "man", "ivdep", "32"]`                        |   5.699 μs (5%) |         |                 |             |
| `["gemm", "mul", "man", "ivdep", "8"]`                         | 399.000 ns (5%) |         |                 |             |
| `["gemm", "mul", "man", "true", "256"]`                        |   3.263 ms (5%) |         |                 |             |
| `["gemm", "mul", "man", "true", "32"]`                         |   6.200 μs (5%) |         |                 |             |
| `["gemm", "mul", "man", "true", "8"]`                          | 400.000 ns (5%) |         |                 |             |
| `["gemm", "mul", "xf", "false", "256"]`                        |   3.322 ms (5%) |         |   80 bytes (1%) |           3 |
...
| `["gemm", "mul", "xf", "true", "256"]`                         |   3.234 ms (5%) |         |   80 bytes (1%) |           3 |
...
| `["missing_dot", "xf"]`                                        |  90.699 μs (5%) |         |  72.20 KiB (1%) |        3746 |
| `["missing_dot", "xf_nota"]`                                   |  90.899 μs (5%) |         |  72.17 KiB (1%) |        3744 |
| `["overhead", "foldl"]`                                        |   3.599 ns (5%) |         |                 |             |
| `["overhead", "reduce_basecase"]`                              |  95.063 ns (5%) |         |   16 bytes (1%) |           1 |
| `["partition_by", "man"]`                                      |   2.608 ms (5%) |         |  480 bytes (1%) |           3 |
| `["partition_by", "xf"]`                                       |   2.912 ms (5%) |         |  592 bytes (1%) |           5 |
