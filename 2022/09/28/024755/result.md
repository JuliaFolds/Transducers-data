...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8370C CPU @ 2.80GHz: 
       ...
       #1  2793 MHz       6561 s          1 s        148 s       2366 s          0 s
       #2  2793 MHz        429 s          1 s        122 s       8505 s          0 s
       
  Memory: 6.781253814697266 GB (3503.078125 MB free)
  Uptime: 911.35 sec
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8370C CPU @ 2.80GHz: 
              speed         user         nice          sys         idle          irq
       #1  2793 MHz       6730 s          1 s        166 s       4930 s          0 s
       #2  2793 MHz       3049 s          1 s        153 s       8613 s          0 s
       
  Memory: 6.781253814697266 GB (3487.15234375 MB free)
  Uptime: 1187.22 sec
...
| `["collect", "identity-union"]`                                | 152.399 μs (5%) |         | 679.41 KiB (1%) |       10010 |
...
| `["dot", "rf"]`                                                |   2.222 μs (5%) |         |                 |             |
| `["dot", "xf"]`                                                |   2.222 μs (5%) |         |                 |             |
| `["filter_map_map!", "man"]`                                   |  42.900 μs (5%) |         |                 |             |
...
| `["filter_sum", "1000", "UnitRange", "noinit", "xf"]`          | 225.811 ns (5%) |         |                 |             |
| `["filter_sum", "1000", "UnitRange", "withinit", "base"]`      | 167.192 ns (5%) |         |                 |             |
| `["filter_sum", "1000", "UnitRange", "withinit", "naive"]`     | 814.596 ns (5%) |         |                 |             |
...
| `["findall", "xf-array"]`                                      |   1.207 ms (5%) |         |   2.94 MiB (1%) |       96426 |
| `["findall", "xf-iter"]`                                       | 700.995 μs (5%) |         |   1.83 MiB (1%) |          14 |
| `["gemm", "fusedmul", "blas", "16"]`                           |   9.408 ms (5%) |         |                 |             |
...
| `["gemm", "fusedmul", "xf", "2"]`                              | 590.695 μs (5%) |         |  192 bytes (1%) |           4 |
...
| `["gemm", "mul", "man", "false", "8"]`                         | 444.385 ns (5%) |         |                 |             |
| `["gemm", "mul", "man", "ivdep", "256"]`                       |   3.169 ms (5%) |         |                 |             |
| `["gemm", "mul", "man", "ivdep", "32"]`                        |   5.750 μs (5%) |         |                 |             |
| `["gemm", "mul", "man", "ivdep", "8"]`                         | 428.136 ns (5%) |         |                 |             |
| `["gemm", "mul", "man", "true", "256"]`                        |   3.210 ms (5%) |         |                 |             |
| `["gemm", "mul", "man", "true", "32"]`                         |   6.380 μs (5%) |         |                 |             |
| `["gemm", "mul", "man", "true", "8"]`                          | 422.675 ns (5%) |         |                 |             |
| `["gemm", "mul", "xf", "false", "256"]`                        |   3.263 ms (5%) |         |   80 bytes (1%) |           3 |
| `["gemm", "mul", "xf", "false", "32"]`                         |   6.860 μs (5%) |         |   80 bytes (1%) |           3 |
| `["gemm", "mul", "xf", "false", "8"]`                          | 486.906 ns (5%) |         |   80 bytes (1%) |           3 |
| `["gemm", "mul", "xf", "ivdep", "256"]`                        |   3.163 ms (5%) |         |   80 bytes (1%) |           3 |
| `["gemm", "mul", "xf", "ivdep", "32"]`                         |   5.600 μs (5%) |         |   80 bytes (1%) |           3 |
| `["gemm", "mul", "xf", "ivdep", "8"]`                          | 505.754 ns (5%) |         |   80 bytes (1%) |           3 |
...
| `["groupby", "sum", "sac"]`                                    | 139.699 μs (5%) |         |   1.64 KiB (1%) |          11 |
...
| `["missing_dot", "xf"]`                                        |  89.699 μs (5%) |         |  72.25 KiB (1%) |        3746 |
| `["missing_dot", "xf_nota"]`                                   |  91.999 μs (5%) |         |  72.30 KiB (1%) |        3750 |
| `["overhead", "foldl"]`                                        |   3.999 ns (5%) |         |                 |             |
| `["overhead", "reduce_basecase"]`                              |  94.110 ns (5%) |         |   16 bytes (1%) |           1 |
...
| `["teerf_filter", "noinit"]`                                   | 432.658 ns (5%) |         |   80 bytes (1%) |           3 |
...
## Job Properties
* Time of benchmark: 28 Sep 2022 - 2:46
...
| `["collect", "identity-float"]`                                |  17.200 μs (5%) |         | 326.61 KiB (1%) |          10 |
| `["collect", "identity-union"]`                                | 153.299 μs (5%) |         | 679.41 KiB (1%) |       10010 |
...
| `["dot", "rf"]`                                                |   2.222 μs (5%) |         |                 |             |
| `["dot", "xf"]`                                                |   2.233 μs (5%) |         |                 |             |
| `["filter_map_map!", "man"]`                                   |  45.799 μs (5%) |         |                 |             |
| `["filter_map_map!", "xf"]`                                    |  47.499 μs (5%) |         |                 |             |
| `["filter_map_reduce", "man"]`                                 | 315.297 μs (5%) |         |                 |             |
| `["filter_map_reduce", "xf"]`                                  | 315.098 μs (5%) |         |                 |             |
| `["filter_sum", "1000", "RandomFloats", "noinit", "base"]`     |   3.650 μs (5%) |         |                 |             |
| `["filter_sum", "1000", "RandomFloats", "noinit", "naive"]`    |   1.850 μs (5%) |         |                 |             |
| `["filter_sum", "1000", "RandomFloats", "noinit", "xf"]`       |   2.489 μs (5%) |         |                 |             |
...
| `["findall", "xf-iter"]`                                       | 703.495 μs (5%) |         |   1.83 MiB (1%) |          14 |
| `["gemm", "fusedmul", "blas", "16"]`                           |   9.463 ms (5%) |         |                 |             |
| `["gemm", "fusedmul", "blas", "2"]`                            |   2.544 ms (5%) |         |                 |             |
| `["gemm", "fusedmul", "blas", "32"]`                           |  17.224 ms (5%) |         |                 |             |
| `["gemm", "fusedmul", "blas", "8"]`                            |   5.583 ms (5%) |         |                 |             |
| `["gemm", "fusedmul", "xf", "16"]`                             |   5.007 ms (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "fusedmul", "xf", "2"]`                              | 637.195 μs (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "fusedmul", "xf", "32"]`                             |  10.017 ms (5%) |         |  192 bytes (1%) |           4 |
...
| `["gemm", "mul", "man", "false", "256"]`                       |   3.084 ms (5%) |         |                 |             |
...
| `["missing_dot", "xf"]`                                        |  91.100 μs (5%) |         |  72.20 KiB (1%) |        3746 |
| `["missing_dot", "xf_nota"]`                                   |  97.999 μs (5%) |         |  72.11 KiB (1%) |        3741 |
| `["overhead", "foldl"]`                                        |   3.999 ns (5%) |         |                 |             |
| `["overhead", "reduce_basecase"]`                              |  93.374 ns (5%) |         |   16 bytes (1%) |           1 |
