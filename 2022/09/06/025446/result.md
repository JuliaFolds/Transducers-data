...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
       ...
       #1  2593 MHz        663 s          1 s        113 s       8444 s          0 s
       #2  2593 MHz       6510 s          1 s        146 s       2602 s          0 s
       
  Memory: 6.781246185302734 GB (3597.4375 MB free)
  Uptime: 930.59 sec
  Load Avg:  1.12  1.01  0.64
  WORD_SIZE: 64
  LIBM: libopenlibm
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
              speed         user         nice          sys         idle          irq
       #1  2593 MHz        794 s          1 s        137 s      11205 s          0 s
       #2  2593 MHz       9338 s          1 s        184 s       2662 s          0 s
       
  Memory: 6.781246185302734 GB (3507.71484375 MB free)
  Uptime: 1223.23 sec
...
| `["collect", "identity-union"]`                                | 148.102 μs (5%) |         | 679.41 KiB (1%) |       10010 |
...
| `["filter_sum", "1000", "UnitRange", "withinit", "xf"]`        | 132.117 ns (5%) |         |                 |             |
...
| `["findall", "base"]`                                          | 156.502 μs (5%) |         | 797.20 KiB (1%) |           8 |
| `["findall", "xf-array"]`                                      |   1.358 ms (5%) |         |   2.94 MiB (1%) |       96426 |
| `["findall", "xf-iter"]`                                       | 876.510 μs (5%) |         |   1.83 MiB (1%) |          14 |
...
| `["gemm", "mul", "man", "ivdep", "256"]`                       |   3.088 ms (5%) |         |                 |             |
...
| `["gemm", "mul", "xf", "true", "256"]`                         |   3.105 ms (5%) |         |   80 bytes (1%) |           3 |
| `["gemm", "mul", "xf", "true", "32"]`                          |   6.080 μs (5%) |         |   80 bytes (1%) |           3 |
| `["gemm", "mul", "xf", "true", "8"]`                           | 443.944 ns (5%) |         |   80 bytes (1%) |           3 |
| `["groupby", "sum", "sac"]`                                    | 143.301 μs (5%) |         |   1.64 KiB (1%) |          11 |
| `["groupby", "sum", "xf-with-init"]`                           | 151.102 μs (5%) |         |   1.05 KiB (1%) |           9 |
...
| `["missing_dot", "xf"]`                                        |  95.101 μs (5%) |         |  71.89 KiB (1%) |        3730 |
| `["missing_dot", "xf_nota"]`                                   |  96.201 μs (5%) |         |  72.02 KiB (1%) |        3736 |
| `["overhead", "foldl"]`                                        |   3.300 ns (5%) |         |                 |             |
| `["overhead", "reduce_basecase"]`                              | 101.908 ns (5%) |         |   16 bytes (1%) |           1 |
| `["partition_by", "man"]`                                      |   2.545 ms (5%) |         |  480 bytes (1%) |           3 |
| `["partition_by", "xf"]`                                       |   2.735 ms (5%) |         |  592 bytes (1%) |           5 |
...
| `["teerf_filter", "noinit"]`                                   | 387.690 ns (5%) |         |   80 bytes (1%) |           3 |
...
## Job Properties
* Time of benchmark: 6 Sep 2022 - 2:53
...
| `["collect", "identity-union"]`                                | 153.102 μs (5%) |         | 679.41 KiB (1%) |       10010 |
...
| `["filter_sum", "1000", "UnitRange", "withinit", "xf"]`        | 129.830 ns (5%) |         |                 |             |
| `["filter_sum", "10000", "RandomFloats", "noinit", "base"]`    |  30.300 μs (5%) |         |                 |             |
...
| `["findall", "base"]`                                          | 158.802 μs (5%) |         | 797.20 KiB (1%) |           8 |
| `["findall", "xf-array"]`                                      |   1.349 ms (5%) |         |   2.94 MiB (1%) |       96426 |
| `["findall", "xf-iter"]`                                       | 878.111 μs (5%) |         |   1.83 MiB (1%) |          14 |
...
| `["gemm", "mul", "linalg", "256"]`                             | 504.506 μs (5%) |         |                 |             |
...
| `["groupby", "sum", "sac"]`                                    |   8.274 ms (5%) |         |  13.12 KiB (1%) |         102 |
...
| `["missing_dot", "xf"]`                                        |  94.801 μs (5%) |         |  72.31 KiB (1%) |        3750 |
| `["missing_dot", "xf_nota"]`                                   |  95.301 μs (5%) |         |  72.17 KiB (1%) |        3744 |
| `["overhead", "foldl"]`                                        |   3.700 ns (5%) |         |                 |             |
| `["overhead", "reduce_basecase"]`                              | 101.060 ns (5%) |         |   16 bytes (1%) |           1 |
| `["partition_by", "man"]`                                      |   2.558 ms (5%) |         |  480 bytes (1%) |           3 |
| `["partition_by", "xf"]`                                       |   2.771 ms (5%) |         |  592 bytes (1%) |           5 |
...
| `["sum_transpose", "30", "withinit", "man"]`                   |   1.150 μs (5%) |         |                 |             |
| `["sum_transpose", "30", "withinit", "xf"]`                    |   1.230 μs (5%) |         |   48 bytes (1%) |           3 |
| `["teerf_filter", "noinit"]`                                   | 370.941 ns (5%) |         |   80 bytes (1%) |           3 |
| `["teerf_filter", "withinit"]`                                 | 214.425 ns (5%) |         |                 |             |
