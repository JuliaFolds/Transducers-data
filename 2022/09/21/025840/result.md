...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
       ...
       #1  2593 MHz        338 s          1 s        112 s       6696 s          0 s
       #2  2593 MHz       6740 s          1 s        142 s        296 s          0 s
       
  Memory: 6.781253814697266 GB (3617.1484375 MB free)
  Uptime: 720.78 sec
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
              speed         user         nice          sys         idle          irq
       #1  2593 MHz        466 s          1 s        137 s       9407 s          0 s
       #2  2593 MHz       9505 s          1 s        189 s        357 s          0 s
       
  Memory: 6.781253814697266 GB (3536.1875 MB free)
  Uptime: 1008.15 sec
...
| `["cat", "base"]`                                              |   2.011 μs (5%) |         |                 |             |
| `["cat", "xf"]`                                                |   1.660 μs (5%) |         |                 |             |
| `["collect", "filter-missing"]`                                |  66.602 μs (5%) |         |  41.33 KiB (1%) |          10 |
| `["collect", "identity-float"]`                                |  20.400 μs (5%) |         | 326.61 KiB (1%) |          10 |
| `["collect", "identity-union"]`                                | 150.203 μs (5%) |         | 679.41 KiB (1%) |       10010 |
...
| `["filter_sum", "1000", "UnitRange", "withinit", "xf"]`        | 137.831 ns (5%) |         |                 |             |
...
| `["findall", "base"]`                                          | 139.703 μs (5%) |         | 797.20 KiB (1%) |           8 |
| `["findall", "xf-array"]`                                      |   1.344 ms (5%) |         |   2.94 MiB (1%) |       96426 |
| `["findall", "xf-iter"]`                                       | 871.216 μs (5%) |         |   1.83 MiB (1%) |          14 |
...
| `["gemm", "fusedmul", "xf", "2"]`                              | 695.413 μs (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "fusedmul", "xf", "32"]`                             |  10.644 ms (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "fusedmul", "xf", "8"]`                              |   2.652 ms (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "mul", "linalg", "256"]`                             | 511.309 μs (5%) |         |                 |             |
| `["gemm", "mul", "linalg", "32"]`                              |   1.540 μs (5%) |         |                 |             |
| `["gemm", "mul", "linalg", "8"]`                               | 219.964 ns (5%) |         |                 |             |
...
| `["gemm", "mul", "man", "true", "256"]`                        |   3.190 ms (5%) |         |                 |             |
| `["gemm", "mul", "man", "true", "32"]`                         |   6.200 μs (5%) |         |                 |             |
| `["gemm", "mul", "man", "true", "8"]`                          | 494.851 ns (5%) |         |                 |             |
| `["gemm", "mul", "xf", "false", "256"]`                        |   3.214 ms (5%) |         |   80 bytes (1%) |           3 |
| `["gemm", "mul", "xf", "false", "32"]`                         |   6.820 μs (5%) |         |   80 bytes (1%) |           3 |
| `["gemm", "mul", "xf", "false", "8"]`                          | 446.203 ns (5%) |         |   80 bytes (1%) |           3 |
| `["gemm", "mul", "xf", "ivdep", "256"]`                        |   3.161 ms (5%) |         |   80 bytes (1%) |           3 |
| `["gemm", "mul", "xf", "ivdep", "32"]`                         |   5.717 μs (5%) |         |   80 bytes (1%) |           3 |
| `["gemm", "mul", "xf", "ivdep", "8"]`                          | 430.813 ns (5%) |         |   80 bytes (1%) |           3 |
...
| `["groupby", "sum", "sac"]`                                    | 154.303 μs (5%) |         |   1.64 KiB (1%) |          11 |
...
| `["missing_dot", "xf"]`                                        | 101.602 μs (5%) |         |  72.06 KiB (1%) |        3740 |
| `["missing_dot", "xf_nota"]`                                   |  95.202 μs (5%) |         |  72.27 KiB (1%) |        3745 |
| `["overhead", "foldl"]`                                        |   3.300 ns (5%) |         |                 |             |
| `["overhead", "reduce_basecase"]`                              | 102.011 ns (5%) |         |   16 bytes (1%) |           1 |
...
| `["filter_sum", "1000", "UnitRange", "withinit", "xf"]`        | 140.117 ns (5%) |         |                 |             |
| `["filter_sum", "10000", "RandomFloats", "noinit", "base"]`    |  30.300 μs (5%) |         |                 |             |
...
| `["findall", "xf-iter"]`                                       | 866.516 μs (5%) |         |   1.83 MiB (1%) |          14 |
...
| `["groupby", "sum", "sac"]`                                    |   8.273 ms (5%) |         |  13.12 KiB (1%) |         102 |
...
| `["missing_dot", "xf_nota"]`                                   |  96.101 μs (5%) |         |  72.17 KiB (1%) |        3744 |
| `["overhead", "foldl"]`                                        |   3.700 ns (5%) |         |                 |             |
| `["overhead", "reduce_basecase"]`                              | 102.011 ns (5%) |         |   16 bytes (1%) |           1 |
| `["partition_by", "man"]`                                      |   2.548 ms (5%) |         |  480 bytes (1%) |           3 |
| `["partition_by", "xf"]`                                       |   2.770 ms (5%) |         |  592 bytes (1%) |           5 |
...
| `["sum_transpose", "30", "withinit", "man"]`                   |   1.150 μs (5%) |         |                 |             |
| `["sum_transpose", "30", "withinit", "xf"]`                    |   1.230 μs (5%) |         |   48 bytes (1%) |           3 |
| `["teerf_filter", "noinit"]`                                   | 379.213 ns (5%) |         |   80 bytes (1%) |           3 |
