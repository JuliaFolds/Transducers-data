...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
       ...
       #1  2593 MHz        476 s          2 s        146 s       6888 s          0 s
       #2  2593 MHz       6890 s          1 s        158 s        489 s          0 s
       
  Memory: 6.781253814697266 GB (3571.65625 MB free)
  Uptime: 758.19 sec
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
              speed         user         nice          sys         idle          irq
       #1  2593 MHz        608 s          2 s        170 s       9761 s          0 s
       #2  2593 MHz       9820 s          1 s        208 s        549 s          0 s
       
  Memory: 6.781253814697266 GB (3494.41796875 MB free)
  Uptime: 1062.34 sec
...
| `["collect", "identity-float"]`                                |  22.501 μs (5%) |         | 326.61 KiB (1%) |          10 |
| `["collect", "identity-union"]`                                | 162.706 μs (5%) |         | 679.41 KiB (1%) |       10010 |
...
| `["filter_sum", "1000", "UnitRange", "noinit", "base"]`        |   1.351 μs (5%) |         |                 |             |
| `["filter_sum", "1000", "UnitRange", "noinit", "naive"]`       |   1.020 μs (5%) |         |                 |             |
| `["filter_sum", "1000", "UnitRange", "noinit", "xf"]`          | 188.230 ns (5%) |         |                 |             |
| `["filter_sum", "1000", "UnitRange", "withinit", "base"]`      | 131.712 ns (5%) |         |                 |             |
| `["filter_sum", "1000", "UnitRange", "withinit", "naive"]`     | 846.391 ns (5%) |         |                 |             |
| `["filter_sum", "1000", "UnitRange", "withinit", "xf"]`        | 138.775 ns (5%) |         |                 |             |
...
| `["gemm", "mul", "linalg", "8"]`                               | 221.361 ns (5%) |         |                 |             |
| `["gemm", "mul", "man", "false", "256"]`                       |   3.198 ms (5%) |         |                 |             |
...
| `["gemm", "mul", "xf", "false", "256"]`                        |   3.209 ms (5%) |         |   80 bytes (1%) |           3 |
| `["gemm", "mul", "xf", "false", "32"]`                         |   6.620 μs (5%) |         |   80 bytes (1%) |           3 |
| `["gemm", "mul", "xf", "false", "8"]`                          | 533.168 ns (5%) |         |   80 bytes (1%) |           3 |
...
| `["groupby", "sum", "sac"]`                                    | 152.503 μs (5%) |         |   1.64 KiB (1%) |          11 |
...
| `["missing_dot", "xf"]`                                        |  97.802 μs (5%) |         |  72.12 KiB (1%) |        3742 |
| `["missing_dot", "xf_nota"]`                                   |  96.002 μs (5%) |         |  72.23 KiB (1%) |        3745 |
| `["overhead", "foldl"]`                                        |   3.300 ns (5%) |         |                 |             |
| `["overhead", "reduce_basecase"]`                              | 103.817 ns (5%) |         |   16 bytes (1%) |           1 |
...
| `["teerf_filter", "noinit"]`                                   | 379.034 ns (5%) |         |   80 bytes (1%) |           3 |
| `["teerf_filter", "withinit"]`                                 | 214.957 ns (5%) |         |                 |             |
...
| `["collect", "identity-union"]`                                | 164.604 μs (5%) |         | 679.41 KiB (1%) |       10010 |
...
| `["filter_sum", "1000", "UnitRange", "noinit", "xf"]`          | 187.186 ns (5%) |         |                 |             |
| `["filter_sum", "1000", "UnitRange", "withinit", "base"]`      | 129.334 ns (5%) |         |                 |             |
| `["filter_sum", "1000", "UnitRange", "withinit", "naive"]`     | 847.841 ns (5%) |         |                 |             |
| `["filter_sum", "1000", "UnitRange", "withinit", "xf"]`        | 131.137 ns (5%) |         |                 |             |
| `["filter_sum", "10000", "RandomFloats", "noinit", "base"]`    |  30.300 μs (5%) |         |                 |             |
...
| `["findall", "base"]`                                          | 152.103 μs (5%) |         | 797.20 KiB (1%) |           8 |
| `["findall", "xf-array"]`                                      |   1.371 ms (5%) |         |   2.94 MiB (1%) |       96426 |
| `["findall", "xf-iter"]`                                       | 888.818 μs (5%) |         |   1.83 MiB (1%) |          14 |
...
| `["groupby", "sum", "sac"]`                                    |   8.319 ms (5%) |         |  13.12 KiB (1%) |         102 |
| `["groupby", "sum", "xf-with-init"]`                           | 145.503 μs (5%) |         |   1.05 KiB (1%) |           9 |
| `["groupby", "sum", "xf-without-init"]`                        | 143.003 μs (5%) |         |   1.05 KiB (1%) |           9 |
...
| `["missing_dot", "xf"]`                                        |  96.102 μs (5%) |         |  72.00 KiB (1%) |        3736 |
| `["missing_dot", "xf_nota"]`                                   |  95.102 μs (5%) |         |  72.17 KiB (1%) |        3744 |
| `["overhead", "foldl"]`                                        |   3.700 ns (5%) |         |                 |             |
| `["overhead", "reduce_basecase"]`                              | 100.320 ns (5%) |         |   16 bytes (1%) |           1 |
...
| `["sum_transpose", "30", "withinit", "man"]`                   |   1.150 μs (5%) |         |                 |             |
| `["sum_transpose", "30", "withinit", "xf"]`                    |   1.230 μs (5%) |         |   48 bytes (1%) |           3 |
| `["teerf_filter", "noinit"]`                                   | 382.449 ns (5%) |         |   80 bytes (1%) |           3 |
