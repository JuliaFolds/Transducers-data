...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
       ...
       #1  2593 MHz       6898 s          1 s        158 s       1435 s          0 s
       #2  2593 MHz        627 s          1 s        118 s       7761 s          0 s
       
  Memory: 6.7845458984375 GB (3750.703125 MB free)
  Uptime: 856.14 sec
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
              speed         user         nice          sys         idle          irq
       #1  2593 MHz       7079 s          1 s        187 s       4230 s          0 s
       #2  2593 MHz       3484 s          1 s        158 s       7881 s          0 s
       
  Memory: 6.7845458984375 GB (3541.5859375 MB free)
  Uptime: 1157.96 sec
...
| `["cat", "base"]`                                              |   2.020 μs (5%) |         |                 |             |
| `["cat", "xf"]`                                                |   1.660 μs (5%) |         |                 |             |
| `["collect", "filter-missing"]`                                |  65.201 μs (5%) |         |  41.33 KiB (1%) |          10 |
| `["collect", "identity-float"]`                                |  22.200 μs (5%) |         | 326.61 KiB (1%) |          10 |
| `["collect", "identity-union"]`                                | 172.102 μs (5%) |         | 679.41 KiB (1%) |       10010 |
...
| `["filter_sum", "1000", "UnitRange", "withinit", "xf"]`        | 136.703 ns (5%) |         |                 |             |
...
| `["findall", "xf-array"]`                                      |   1.408 ms (5%) |         |   2.94 MiB (1%) |       96426 |
| `["findall", "xf-iter"]`                                       | 873.600 μs (5%) |         |   1.83 MiB (1%) |          14 |
...
| `["gemm", "fusedmul", "xf", "2"]`                              | 656.709 μs (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "fusedmul", "xf", "32"]`                             |  10.498 ms (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "fusedmul", "xf", "8"]`                              |   2.615 ms (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "mul", "linalg", "256"]`                             | 510.905 μs (5%) |         |                 |             |
| `["gemm", "mul", "linalg", "32"]`                              |   1.560 μs (5%) |         |                 |             |
| `["gemm", "mul", "linalg", "8"]`                               | 231.211 ns (5%) |         |                 |             |
...
| `["gemm", "mul", "xf", "false", "8"]`                          | 449.751 ns (5%) |         |   80 bytes (1%) |           3 |
...
| `["missing_dot", "xf"]`                                        |  96.400 μs (5%) |         |  71.89 KiB (1%) |        3730 |
| `["missing_dot", "xf_nota"]`                                   |  95.700 μs (5%) |         |  72.02 KiB (1%) |        3736 |
| `["overhead", "foldl"]`                                        |   3.300 ns (5%) |         |                 |             |
| `["overhead", "reduce_basecase"]`                              | 103.178 ns (5%) |         |   16 bytes (1%) |           1 |
...
| `["findall", "xf-iter"]`                                       | 878.311 μs (5%) |         |   1.83 MiB (1%) |          14 |
...
| `["groupby", "sum", "sac"]`                                    |   8.150 ms (5%) |         |  13.12 KiB (1%) |         102 |
...
| `["missing_dot", "xf"]`                                        |  95.401 μs (5%) |         |  72.00 KiB (1%) |        3736 |
| `["missing_dot", "xf_nota"]`                                   |  95.001 μs (5%) |         |  72.17 KiB (1%) |        3744 |
| `["overhead", "foldl"]`                                        |   3.700 ns (5%) |         |                 |             |
| `["overhead", "reduce_basecase"]`                              |  99.048 ns (5%) |         |   16 bytes (1%) |           1 |
| `["partition_by", "man"]`                                      |   2.500 ms (5%) |         |  480 bytes (1%) |           3 |
