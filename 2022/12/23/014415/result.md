...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8370C CPU @ 2.80GHz: 
       ...
       #1  2793 MHz        589 s          0 s        126 s       8177 s          0 s
       #2  2793 MHz       6458 s          0 s        170 s       2289 s          0 s
       
  Memory: 6.781219482421875 GB (3694.81640625 MB free)
  Uptime: 896.09 sec
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8370C CPU @ 2.80GHz: 
              speed         user         nice          sys         idle          irq
       #1  2793 MHz        717 s          0 s        147 s      10778 s          0 s
       #2  2793 MHz       9112 s          0 s        205 s       2357 s          0 s
       
  Memory: 6.781219482421875 GB (3559.75390625 MB free)
  Uptime: 1171.82 sec
...
## Job Properties
* Time of benchmark: 23 Dec 2022 - 1:38
...
| `["findall", "base"]`                                          | 133.900 μs (5%) |         | 797.20 KiB (1%) |           8 |
| `["findall", "xf-array"]`                                      |   1.211 ms (5%) |         |   2.94 MiB (1%) |       96426 |
| `["findall", "xf-iter"]`                                       | 705.602 μs (5%) |         |   1.83 MiB (1%) |          14 |
...
| `["groupby", "sum", "xf-without-init"]`                        | 136.413 μs (5%) |         |   1.05 KiB (1%) |           9 |
...
| `["missing_dot", "xf"]`                                        |  92.000 μs (5%) |         |  72.20 KiB (1%) |        3746 |
| `["missing_dot", "xf_nota"]`                                   |  94.600 μs (5%) |         |  72.19 KiB (1%) |        3744 |
| `["overhead", "foldl"]`                                        |   4.000 ns (5%) |         |                 |             |
| `["overhead", "reduce_basecase"]`                              |  98.312 ns (5%) |         |   16 bytes (1%) |           1 |
...
| `["collect", "identity-union"]`                                | 152.901 μs (5%) |         | 679.41 KiB (1%) |       10010 |
| `["dict", "base"]`                                             |   3.616 ms (5%) |         |  92.45 KiB (1%) |          22 |
...
| `["filter_sum", "1000", "RandomFloats", "withinit", "naive"]`  | 891.566 ns (5%) |         |                 |             |
| `["filter_sum", "1000", "RandomFloats", "withinit", "xf"]`     |   2.500 μs (5%) |         |                 |             |
| `["filter_sum", "1000", "UnitRange", "noinit", "base"]`        |   1.240 μs (5%) |         |                 |             |
...
| `["filter_sum", "1000", "UnitRange", "withinit", "naive"]`     | 621.839 ns (5%) |         |                 |             |
...
| `["findall", "xf-iter"]`                                       | 724.303 μs (5%) |         |   1.83 MiB (1%) |          14 |
...
| `["gemm", "fusedmul", "xf", "2"]`                              | 596.102 μs (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "fusedmul", "xf", "32"]`                             |   9.469 ms (5%) |         |  192 bytes (1%) |           4 |
...
| `["gemm", "mul", "xf", "true", "256"]`                         |   3.207 ms (5%) |         |   80 bytes (1%) |           3 |
...
| `["missing_dot", "xf"]`                                        |  90.401 μs (5%) |         |  72.00 KiB (1%) |        3736 |
| `["missing_dot", "xf_nota"]`                                   |  90.301 μs (5%) |         |  72.17 KiB (1%) |        3744 |
| `["overhead", "foldl"]`                                        |   3.600 ns (5%) |         |                 |             |
| `["overhead", "reduce_basecase"]`                              |  97.360 ns (5%) |         |   16 bytes (1%) |           1 |
