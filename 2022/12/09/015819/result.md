...
## Job Properties
* Time of benchmarks:
    - Target: 9 Dec 2022 - 01:52
    - Baseline: 9 Dec 2022 - 01:57
* Package commits:
    - Target: 793b96
    - Baseline: f8d0df
* Julia commits:
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8370C CPU @ 2.80GHz: 
       ...
       #1  2793 MHz       6579 s          0 s        127 s       1956 s          0 s
       #2  2793 MHz        524 s          0 s        116 s       7984 s          0 s
       
  Memory: 6.781219482421875 GB (3606.046875 MB free)
  Uptime: 871.96 sec
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8370C CPU @ 2.80GHz: 
              speed         user         nice          sys         idle          irq
       #1  2793 MHz       9210 s          0 s        172 s       2030 s          0 s
       #2  2793 MHz        664 s          0 s        136 s      10568 s          0 s
       
  Memory: 6.781219482421875 GB (3484.7890625 MB free)
  Uptime: 1146.96 sec
...
## Job Properties
* Time of benchmark: 9 Dec 2022 - 1:52
...
| `["dot", "rf"]`                                                |   2.222 μs (5%) |         |                 |             |
| `["dot", "xf"]`                                                |   2.222 μs (5%) |         |                 |             |
| `["filter_map_map!", "man"]`                                   |  43.300 μs (5%) |         |                 |             |
...
| `["gemm", "mul", "xf", "ivdep", "8"]`                          | 583.978 ns (5%) |         |   80 bytes (1%) |           3 |
...
| `["groupby", "sum", "sac"]`                                    | 141.300 μs (5%) |         |   1.64 KiB (1%) |          11 |
...
| `["missing_dot", "xf"]`                                        |  96.100 μs (5%) |         |  71.98 KiB (1%) |        3737 |
| `["missing_dot", "xf_nota"]`                                   |  96.500 μs (5%) |         |  72.28 KiB (1%) |        3748 |
| `["overhead", "foldl"]`                                        |   3.599 ns (5%) |         |                 |             |
| `["overhead", "reduce_basecase"]`                              |  94.654 ns (5%) |         |   16 bytes (1%) |           1 |
| `["partition_by", "man"]`                                      |   2.622 ms (5%) |         |  480 bytes (1%) |           3 |
| `["partition_by", "xf"]`                                       |   2.854 ms (5%) |         |  592 bytes (1%) |           5 |
| `["set", "base"]`                                              |   3.808 ms (5%) |         |  49.14 KiB (1%) |          17 |
...
| `["teerf_filter", "withinit"]`                                 | 248.705 ns (5%) |         |                 |             |
...
## Job Properties
* Time of benchmark: 9 Dec 2022 - 1:57
...
| `["dot", "rf"]`                                                |   2.222 μs (5%) |         |                 |             |
| `["dot", "xf"]`                                                |   2.244 μs (5%) |         |                 |             |
| `["filter_map_map!", "man"]`                                   |  45.900 μs (5%) |         |                 |             |
| `["filter_map_map!", "xf"]`                                    |  48.100 μs (5%) |         |                 |             |
| `["filter_map_reduce", "man"]`                                 | 315.100 μs (5%) |         |                 |             |
| `["filter_map_reduce", "xf"]`                                  | 315.400 μs (5%) |         |                 |             |
| `["filter_sum", "1000", "RandomFloats", "noinit", "base"]`     |   3.650 μs (5%) |         |                 |             |
| `["filter_sum", "1000", "RandomFloats", "noinit", "naive"]`    |   1.850 μs (5%) |         |                 |             |
| `["filter_sum", "1000", "RandomFloats", "noinit", "xf"]`       |   2.489 μs (5%) |         |                 |             |
| `["filter_sum", "1000", "RandomFloats", "withinit", "base"]`   |   2.489 μs (5%) |         |                 |             |
| `["filter_sum", "1000", "RandomFloats", "withinit", "naive"]`  | 890.674 ns (5%) |         |                 |             |
...
| `["filter_sum", "10000", "UnitRange", "withinit", "xf"]`       |   1.600 μs (5%) |         |                 |             |
| `["findall", "base"]`                                          | 134.200 μs (5%) |         | 797.20 KiB (1%) |           8 |
| `["findall", "xf-array"]`                                      |   1.240 ms (5%) |         |   2.94 MiB (1%) |       96426 |
| `["findall", "xf-iter"]`                                       | 745.300 μs (5%) |         |   1.83 MiB (1%) |          14 |
...
| `["gemm", "fusedmul", "xf", "2"]`                              | 590.800 μs (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "fusedmul", "xf", "32"]`                             |   9.504 ms (5%) |         |  192 bytes (1%) |           4 |
...
| `["groupby", "sum", "sac"]`                                    |   7.374 ms (5%) |         |  13.14 KiB (1%) |         103 |
| `["groupby", "sum", "xf-with-init"]`                           | 135.299 μs (5%) |         |   1.05 KiB (1%) |           9 |
...
| `["missing_dot", "xf"]`                                        |  90.600 μs (5%) |         |  72.00 KiB (1%) |        3736 |
| `["missing_dot", "xf_nota"]`                                   |  91.100 μs (5%) |         |  72.41 KiB (1%) |        3754 |
| `["overhead", "foldl"]`                                        |   3.599 ns (5%) |         |                 |             |
| `["overhead", "reduce_basecase"]`                              |  94.130 ns (5%) |         |   16 bytes (1%) |           1 |
| `["partition_by", "man"]`                                      |   2.678 ms (5%) |         |  480 bytes (1%) |           3 |
| `["partition_by", "xf"]`                                       |   2.940 ms (5%) |         |  592 bytes (1%) |           5 |
...
| `["sum_transpose", "30", "withinit", "man"]`                   |   1.350 μs (5%) |         |                 |             |
| `["sum_transpose", "30", "withinit", "xf"]`                    |   1.350 μs (5%) |         |                 |             |
| `["teerf_filter", "noinit"]`                                   | 399.500 ns (5%) |         |   80 bytes (1%) |           3 |
