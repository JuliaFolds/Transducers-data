...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8370C CPU @ 2.80GHz: 
       ...
       #1  2793 MHz       1880 s          0 s        127 s       5374 s          0 s
       #2  2793 MHz       5268 s          0 s        158 s       1957 s          0 s
       
  Memory: 6.781219482421875 GB (3665.32421875 MB free)
  Uptime: 742.57 sec
  Load Avg:  1.04  0.99  0.64
  WORD_SIZE: 64
  LIBM: libopenlibm
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8370C CPU @ 2.80GHz: 
              speed         user         nice          sys         idle          irq
       #1  2793 MHz       4544 s          0 s        163 s       5458 s          0 s
       #2  2793 MHz       5411 s          0 s        179 s       4570 s          0 s
       
  Memory: 6.781219482421875 GB (3525.5 MB free)
  Uptime: 1020.99 sec
  Load Avg:  1.06  1.05  0.77
  WORD_SIZE: 64
  LIBM: libopenlibm
  LLVM: libLLVM-12.0.1 (ORCJIT, icelake-server)
```
...
| `["cat", "base"]`                                              |   1.930 μs (5%) |         |                 |             |
| `["cat", "xf"]`                                                |   1.550 μs (5%) |         |                 |             |
| `["collect", "filter-missing"]`                                |  62.501 μs (5%) |         |  41.33 KiB (1%) |          10 |
| `["collect", "identity-float"]`                                |  19.500 μs (5%) |         | 326.61 KiB (1%) |          10 |
| `["collect", "identity-union"]`                                | 159.700 μs (5%) |         | 679.41 KiB (1%) |       10010 |
...
| `["filter_map_map!", "xf"]`                                    |  43.400 μs (5%) |         |                 |             |
| `["filter_map_reduce", "man"]`                                 | 315.302 μs (5%) |         |                 |             |
| `["filter_map_reduce", "xf"]`                                  | 315.209 μs (5%) |         |                 |             |
...
| `["filter_sum", "1000", "UnitRange", "withinit", "xf"]`        | 168.545 ns (5%) |         |                 |             |
...
| `["filter_sum", "10000", "RandomFloats", "withinit", "naive"]` |   9.600 μs (5%) |         |                 |             |
...
| `["gemm", "mul", "xf", "ivdep", "8"]`                          | 582.320 ns (5%) |         |   80 bytes (1%) |           3 |
| `["gemm", "mul", "xf", "true", "256"]`                         |   3.226 ms (5%) |         |   80 bytes (1%) |           3 |
| `["gemm", "mul", "xf", "true", "32"]`                          |   6.220 μs (5%) |         |   80 bytes (1%) |           3 |
| `["gemm", "mul", "xf", "true", "8"]`                           | 466.842 ns (5%) |         |   80 bytes (1%) |           3 |
...
| `["missing_dot", "xf"]`                                        |  91.500 μs (5%) |         |  71.98 KiB (1%) |        3737 |
| `["missing_dot", "xf_nota"]`                                   |  90.400 μs (5%) |         |  72.28 KiB (1%) |        3748 |
...
| `["set", "base"]`                                              |   3.814 ms (5%) |         |  49.14 KiB (1%) |          17 |
...
| `["cat", "base"]`                                              |   1.930 μs (5%) |         |                 |             |
| `["cat", "xf"]`                                                |   1.550 μs (5%) |         |                 |             |
| `["collect", "filter-missing"]`                                |  63.301 μs (5%) |         |  41.33 KiB (1%) |          10 |
...
| `["filter_sum", "1000", "RandomFloats", "withinit", "naive"]`  | 976.744 ns (5%) |         |                 |             |
...
| `["findall", "base"]`                                          | 136.401 μs (5%) |         | 797.20 KiB (1%) |           8 |
| `["findall", "xf-array"]`                                      |   1.255 ms (5%) |         |   2.94 MiB (1%) |       96426 |
| `["findall", "xf-iter"]`                                       | 712.803 μs (5%) |         |   1.83 MiB (1%) |          14 |
| `["gemm", "fusedmul", "blas", "16"]`                           |   9.433 ms (5%) |         |                 |             |
| `["gemm", "fusedmul", "blas", "2"]`                            |   2.529 ms (5%) |         |                 |             |
| `["gemm", "fusedmul", "blas", "32"]`                           |  17.243 ms (5%) |         |                 |             |
| `["gemm", "fusedmul", "blas", "8"]`                            |   5.537 ms (5%) |         |                 |             |
| `["gemm", "fusedmul", "xf", "16"]`                             |   4.744 ms (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "fusedmul", "xf", "2"]`                              | 599.303 μs (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "fusedmul", "xf", "32"]`                             |   9.486 ms (5%) |         |  192 bytes (1%) |           4 |
...
| `["missing_dot", "xf"]`                                        |  90.401 μs (5%) |         |  72.05 KiB (1%) |        3739 |
| `["missing_dot", "xf_nota"]`                                   |  89.401 μs (5%) |         |  72.11 KiB (1%) |        3741 |
| `["overhead", "foldl"]`                                        |   4.000 ns (5%) |         |                 |             |
| `["overhead", "reduce_basecase"]`                              |  92.138 ns (5%) |         |   16 bytes (1%) |           1 |
...
| `["teerf_filter", "withinit"]`                                 | 248.974 ns (5%) |         |                 |             |
