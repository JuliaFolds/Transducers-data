...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
       ...
       #1  2593 MHz       6704 s          2 s        126 s       2725 s          0 s
       #2  2593 MHz        389 s          0 s        122 s       9038 s          0 s
       
  Memory: 6.781246185302734 GB (3391.359375 MB free)
  Uptime: 960.4 sec
  Load Avg:  1.04  0.95  0.59
  WORD_SIZE: 64
  LIBM: libopenlibm
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
              speed         user         nice          sys         idle          irq
       #1  2593 MHz       6856 s          2 s        150 s       5374 s          0 s
       #2  2593 MHz       3099 s          0 s        158 s       9128 s          0 s
       
  Memory: 6.781246185302734 GB (3264.95703125 MB free)
  Uptime: 1243.92 sec
...
| `["collect", "identity-union"]`                                | 141.803 μs (5%) |         | 679.41 KiB (1%) |       10010 |
...
| `["filter_map_reduce", "xf"]`                                  | 230.904 μs (5%) |         |                 |             |
...
| `["findall", "base"]`                                          | 138.003 μs (5%) |         | 797.20 KiB (1%) |           8 |
| `["findall", "xf-array"]`                                      |   1.313 ms (5%) |         |   2.94 MiB (1%) |       96426 |
| `["findall", "xf-iter"]`                                       | 859.416 μs (5%) |         |   1.83 MiB (1%) |          14 |
...
| `["gemm", "mul", "xf", "false", "256"]`                        |   2.769 ms (5%) |         |   80 bytes (1%) |           3 |
...
| `["groupby", "sum", "sac"]`                                    | 143.202 μs (5%) |         |   1.64 KiB (1%) |          11 |
...
| `["missing_dot", "xf"]`                                        |  96.402 μs (5%) |         |  72.11 KiB (1%) |        3742 |
| `["missing_dot", "xf_nota"]`                                   |  96.202 μs (5%) |         |  72.23 KiB (1%) |        3746 |
| `["overhead", "foldl"]`                                        |   3.300 ns (5%) |         |                 |             |
| `["overhead", "reduce_basecase"]`                              | 102.226 ns (5%) |         |   16 bytes (1%) |           1 |
...
| `["teerf_filter", "withinit"]`                                 | 214.004 ns (5%) |         |                 |             |
...
| `["collect", "identity-union"]`                                | 143.803 μs (5%) |         | 679.41 KiB (1%) |       10010 |
...
| `["filter_sum", "1000", "RandomFloats", "withinit", "base"]`   |   1.780 μs (5%) |         |                 |             |
| `["filter_sum", "1000", "RandomFloats", "withinit", "naive"]`  | 695.309 ns (5%) |         |                 |             |
...
| `["filter_sum", "1000", "UnitRange", "withinit", "base"]`      | 130.536 ns (5%) |         |                 |             |
| `["filter_sum", "1000", "UnitRange", "withinit", "naive"]`     | 847.368 ns (5%) |         |                 |             |
| `["filter_sum", "1000", "UnitRange", "withinit", "xf"]`        | 137.705 ns (5%) |         |                 |             |
| `["filter_sum", "10000", "RandomFloats", "noinit", "base"]`    |  30.300 μs (5%) |         |                 |             |
| `["filter_sum", "10000", "RandomFloats", "noinit", "naive"]`   |  41.301 μs (5%) |         |                 |             |
| `["filter_sum", "10000", "RandomFloats", "noinit", "xf"]`      |  18.000 μs (5%) |         |                 |             |
| `["filter_sum", "10000", "RandomFloats", "withinit", "base"]`  |  18.000 μs (5%) |         |                 |             |
...
| `["findall", "base"]`                                          | 138.902 μs (5%) |         | 797.20 KiB (1%) |           8 |
| `["findall", "xf-array"]`                                      |   1.331 ms (5%) |         |   2.94 MiB (1%) |       96426 |
| `["findall", "xf-iter"]`                                       | 857.216 μs (5%) |         |   1.83 MiB (1%) |          14 |
...
| `["gemm", "mul", "man", "true", "256"]`                        |   2.701 ms (5%) |         |                 |             |
...
| `["groupby", "sum", "sac"]`                                    |   8.263 ms (5%) |         |  13.12 KiB (1%) |         102 |
| `["groupby", "sum", "xf-with-init"]`                           | 140.603 μs (5%) |         |   1.05 KiB (1%) |           9 |
...
| `["missing_dot", "xf"]`                                        |  96.101 μs (5%) |         |  72.19 KiB (1%) |        3744 |
| `["missing_dot", "xf_nota"]`                                   |  95.402 μs (5%) |         |  72.20 KiB (1%) |        3746 |
| `["overhead", "foldl"]`                                        |   3.300 ns (5%) |         |                 |             |
...
| `["sum_transpose", "30", "withinit", "man"]`                   |   1.150 μs (5%) |         |                 |             |
| `["sum_transpose", "30", "withinit", "xf"]`                    |   1.230 μs (5%) |         |   48 bytes (1%) |           3 |
| `["teerf_filter", "noinit"]`                                   | 383.907 ns (5%) |         |   80 bytes (1%) |           3 |
| `["teerf_filter", "withinit"]`                                 | 217.276 ns (5%) |         |                 |             |
