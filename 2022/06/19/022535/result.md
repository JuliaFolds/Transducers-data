...
## Job Properties
* Time of benchmarks:
    - Target: 19 Jun 2022 - 02:20
    - Baseline: 19 Jun 2022 - 02:25
* Package commits:
    - Target: 5c9a4a
    - Baseline: 6125fe
* Julia commits:
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
       ...
       #1  2593 MHz       3269 s          2 s        110 s       5282 s          0 s
       #2  2593 MHz       3750 s          1 s        124 s       4800 s          0 s
       
  Memory: 6.783603668212891 GB (3686.3125 MB free)
  Uptime: 872.09 sec
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
              speed         user         nice          sys         idle          irq
       #1  2593 MHz       3400 s          2 s        131 s       7985 s          0 s
       #2  2593 MHz       6511 s          1 s        163 s       4863 s          0 s
       
  Memory: 6.783603668212891 GB (3641.6328125 MB free)
  Uptime: 1158.46 sec
  Load Avg:  1.05  1.02  0.74
  WORD_SIZE: 64
  LIBM: libopenlibm
  LLVM: libLLVM-12.0.1 (ORCJIT, skylake-avx512)
```
...
## Job Properties
* Time of benchmark: 19 Jun 2022 - 2:20
...
| `["collect", "identity-union"]`                                | 154.502 μs (5%) |         | 679.41 KiB (1%) |       10010 |
...
| `["findall", "base"]`                                          | 138.901 μs (5%) |         | 797.20 KiB (1%) |           8 |
| `["findall", "xf-array"]`                                      |   1.299 ms (5%) |         |   2.94 MiB (1%) |       96426 |
| `["findall", "xf-iter"]`                                       | 871.908 μs (5%) |         |   1.83 MiB (1%) |          14 |
...
| `["gemm", "fusedmul", "xf", "2"]`                              | 657.006 μs (5%) |         |  192 bytes (1%) |           4 |
...
| `["gemm", "mul", "linalg", "8"]`                               | 224.221 ns (5%) |         |                 |             |
...
| `["gemm", "mul", "xf", "true", "8"]`                           | 555.620 ns (5%) |         |   80 bytes (1%) |           3 |
| `["groupby", "sum", "sac"]`                                    | 152.101 μs (5%) |         |   1.64 KiB (1%) |          11 |
...
| `["missing_dot", "xf"]`                                        |  95.701 μs (5%) |         |  72.25 KiB (1%) |        3746 |
| `["missing_dot", "xf_nota"]`                                   |  95.700 μs (5%) |         |  72.30 KiB (1%) |        3748 |
| `["overhead", "foldl"]`                                        |   3.700 ns (5%) |         |                 |             |
| `["overhead", "reduce_basecase"]`                              | 101.275 ns (5%) |         |   16 bytes (1%) |           1 |
...
| `["teerf_filter", "noinit"]`                                   | 392.123 ns (5%) |         |   80 bytes (1%) |           3 |
...
## Job Properties
* Time of benchmark: 19 Jun 2022 - 2:25
...
| `["cat", "base"]`                                              |   2.011 μs (5%) |         |                 |             |
| `["cat", "xf"]`                                                |   1.660 μs (5%) |         |                 |             |
| `["collect", "filter-missing"]`                                |  66.300 μs (5%) |         |  41.33 KiB (1%) |          10 |
| `["collect", "identity-float"]`                                |  20.200 μs (5%) |         | 326.61 KiB (1%) |          10 |
| `["collect", "identity-union"]`                                | 145.902 μs (5%) |         | 679.41 KiB (1%) |       10010 |
...
| `["filter_sum", "1000", "UnitRange", "withinit", "xf"]`        | 137.587 ns (5%) |         |                 |             |
| `["filter_sum", "10000", "RandomFloats", "noinit", "base"]`    |  30.300 μs (5%) |         |                 |             |
| `["filter_sum", "10000", "RandomFloats", "noinit", "naive"]`   |  40.901 μs (5%) |         |                 |             |
| `["filter_sum", "10000", "RandomFloats", "noinit", "xf"]`      |  18.000 μs (5%) |         |                 |             |
| `["filter_sum", "10000", "RandomFloats", "withinit", "base"]`  |  18.000 μs (5%) |         |                 |             |
...
| `["missing_dot", "xf"]`                                        |  99.601 μs (5%) |         |  72.27 KiB (1%) |        3745 |
| `["missing_dot", "xf_nota"]`                                   |  96.100 μs (5%) |         |  72.31 KiB (1%) |        3750 |
| `["overhead", "foldl"]`                                        |   3.300 ns (5%) |         |                 |             |
| `["overhead", "reduce_basecase"]`                              | 103.610 ns (5%) |         |   16 bytes (1%) |           1 |
...
| `["teerf_filter", "withinit"]`                                 | 214.953 ns (5%) |         |                 |             |
