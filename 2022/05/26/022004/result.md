...
## Job Properties
* Time of benchmarks:
    - Target: 26 May 2022 - 02:14
    - Baseline: 26 May 2022 - 02:19
* Package commits:
    - Target: 068b56
    - Baseline: 6125fe
* Julia commits:
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
       ...
       #1  2593 MHz       6834 s          1 s        119 s       1452 s          0 s
       #2  2593 MHz        490 s          1 s        127 s       7768 s          0 s
       
  Memory: 6.783603668212891 GB (3559.44140625 MB free)
  Uptime: 845.45 sec
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
              speed         user         nice          sys         idle          irq
       #1  2593 MHz       7203 s          1 s        148 s       4063 s          0 s
       #2  2593 MHz       3168 s          1 s        166 s       8069 s          0 s
       
  Memory: 6.783603668212891 GB (3424.7890625 MB free)
  Uptime: 1147.42 sec
...
## Job Properties
* Time of benchmark: 26 May 2022 - 2:14
...
| `["collect", "identity-union"]`                                | 162.303 μs (5%) |         | 679.41 KiB (1%) |       10010 |
...
| `["filter_sum", "1000", "UnitRange", "withinit", "base"]`      | 131.830 ns (5%) |         |                 |             |
| `["filter_sum", "1000", "UnitRange", "withinit", "naive"]`     | 913.514 ns (5%) |         |                 |             |
| `["filter_sum", "1000", "UnitRange", "withinit", "xf"]`        | 136.354 ns (5%) |         |                 |             |
...
| `["findall", "base"]`                                          | 150.302 μs (5%) |         | 797.20 KiB (1%) |           8 |
| `["findall", "xf-array"]`                                      |   1.414 ms (5%) |         |   2.94 MiB (1%) |       96426 |
| `["findall", "xf-iter"]`                                       | 885.311 μs (5%) |         |   1.83 MiB (1%) |          14 |
...
| `["gemm", "mul", "xf", "ivdep", "8"]`                          | 429.653 ns (5%) |         |   80 bytes (1%) |           3 |
...
| `["missing_dot", "xf"]`                                        |  99.601 μs (5%) |         |  72.14 KiB (1%) |        3744 |
| `["missing_dot", "xf_nota"]`                                   |  97.202 μs (5%) |         |  72.02 KiB (1%) |        3736 |
| `["overhead", "foldl"]`                                        |   3.300 ns (5%) |         |                 |             |
| `["overhead", "reduce_basecase"]`                              | 100.747 ns (5%) |         |   16 bytes (1%) |           1 |
...
## Job Properties
* Time of benchmark: 26 May 2022 - 2:19
...
| `["collect", "identity-union"]`                                | 165.202 μs (5%) |         | 679.41 KiB (1%) |       10010 |
...
| `["filter_sum", "1000", "UnitRange", "withinit", "xf"]`        | 137.749 ns (5%) |         |                 |             |
| `["filter_sum", "10000", "RandomFloats", "noinit", "base"]`    |  30.300 μs (5%) |         |                 |             |
...
| `["groupby", "sum", "sac"]`                                    |   8.315 ms (5%) |         |  13.16 KiB (1%) |         103 |
...
| `["missing_dot", "xf"]`                                        |  93.901 μs (5%) |         |  72.05 KiB (1%) |        3739 |
| `["missing_dot", "xf_nota"]`                                   |  93.901 μs (5%) |         |  72.11 KiB (1%) |        3741 |
| `["overhead", "foldl"]`                                        |   3.700 ns (5%) |         |                 |             |
| `["overhead", "reduce_basecase"]`                              | 102.239 ns (5%) |         |   16 bytes (1%) |           1 |
| `["partition_by", "man"]`                                      |   2.487 ms (5%) |         |  480 bytes (1%) |           3 |
| `["partition_by", "xf"]`                                       |   2.719 ms (5%) |         |  592 bytes (1%) |           5 |
| `["set", "base"]`                                              |   4.162 ms (5%) |         |  49.14 KiB (1%) |          17 |
...
| `["teerf_filter", "withinit"]`                                 | 213.718 ns (5%) |         |                 |             |
