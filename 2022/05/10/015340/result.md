...
## Job Properties
* Time of benchmarks:
    - Target: 10 May 2022 - 01:48
    - Baseline: 10 May 2022 - 01:53
* Package commits:
    - Target: 92ef45
    - Baseline: 6125fe
* Julia commits:
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
       ...
       #1  2593 MHz       6855 s          1 s        122 s        951 s          0 s
       #2  2593 MHz        416 s          1 s        129 s       7376 s          0 s
       
  Memory: 6.783607482910156 GB (3728.1875 MB free)
  Uptime: 797.34 sec
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
              speed         user         nice          sys         idle          irq
       #1  2593 MHz       8963 s          1 s        156 s       1802 s          0 s
       #2  2593 MHz       1335 s          1 s        154 s       9422 s          0 s
       
  Memory: 6.783607482910156 GB (3675.09765625 MB free)
  Uptime: 1097.01 sec
...
## Job Properties
* Time of benchmark: 10 May 2022 - 1:48
...
| `["collect", "identity-union"]`                                | 168.101 μs (5%) |         | 679.41 KiB (1%) |       10010 |
...
| `["findall", "base"]`                                          | 158.402 μs (5%) |         | 797.20 KiB (1%) |           8 |
| `["findall", "xf-array"]`                                      |   1.450 ms (5%) |         |   2.94 MiB (1%) |       96426 |
| `["findall", "xf-iter"]`                                       | 881.506 μs (5%) |         |   1.83 MiB (1%) |          14 |
...
| `["groupby", "sum", "xf-without-init"]`                        | 137.401 μs (5%) |         |   1.05 KiB (1%) |           9 |
...
| `["missing_dot", "xf"]`                                        |  95.500 μs (5%) |         |  72.11 KiB (1%) |        3742 |
| `["missing_dot", "xf_nota"]`                                   |  95.200 μs (5%) |         |  72.25 KiB (1%) |        3746 |
| `["overhead", "foldl"]`                                        |   3.700 ns (5%) |         |                 |             |
| `["overhead", "reduce_basecase"]`                              | 100.001 ns (5%) |         |   16 bytes (1%) |           1 |
| `["partition_by", "man"]`                                      |   2.440 ms (5%) |         |  480 bytes (1%) |           3 |
| `["partition_by", "xf"]`                                       |   2.638 ms (5%) |         |  592 bytes (1%) |           5 |
| `["set", "base"]`                                              |   4.282 ms (5%) |         |  49.14 KiB (1%) |          17 |
| `["set", "xf"]`                                                |   4.275 ms (5%) |         |  49.17 KiB (1%) |          19 |
...
| `["teerf_filter", "noinit"]`                                   | 386.070 ns (5%) |         |   80 bytes (1%) |           3 |
...
## Job Properties
* Time of benchmark: 10 May 2022 - 1:53
...
| `["collect", "identity-union"]`                                | 167.402 μs (5%) |         | 679.41 KiB (1%) |       10010 |
...
| `["findall", "base"]`                                          | 156.701 μs (5%) |         | 797.20 KiB (1%) |           8 |
| `["findall", "xf-array"]`                                      |   1.366 ms (5%) |         |   2.94 MiB (1%) |       96426 |
| `["findall", "xf-iter"]`                                       | 884.608 μs (5%) |         |   1.83 MiB (1%) |          14 |
...
| `["gemm", "fusedmul", "xf", "2"]`                              | 658.905 μs (5%) |         |  192 bytes (1%) |           4 |
...
| `["groupby", "sum", "xf-with-init"]`                           | 145.801 μs (5%) |         |   1.05 KiB (1%) |           9 |
...
| `["missing_dot", "xf"]`                                        |  96.201 μs (5%) |         |  72.19 KiB (1%) |        3744 |
| `["missing_dot", "xf_nota"]`                                   |  97.300 μs (5%) |         |  72.20 KiB (1%) |        3746 |
| `["overhead", "foldl"]`                                        |   3.300 ns (5%) |         |                 |             |
| `["overhead", "reduce_basecase"]`                              |  98.941 ns (5%) |         |   16 bytes (1%) |           1 |
...
| `["sum_transpose", "30", "withinit", "man"]`                   |   1.150 μs (5%) |         |                 |             |
| `["sum_transpose", "30", "withinit", "xf"]`                    |   1.230 μs (5%) |         |   48 bytes (1%) |           3 |
| `["teerf_filter", "noinit"]`                                   | 380.597 ns (5%) |         |   80 bytes (1%) |           3 |
| `["teerf_filter", "withinit"]`                                 | 214.365 ns (5%) |         |                 |             |
