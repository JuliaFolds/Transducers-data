...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
       ...
       #1  2593 MHz       6422 s          2 s        116 s        970 s          0 s
       #2  2593 MHz        732 s          0 s        120 s       6647 s          0 s
       
  Memory: 6.783603668212891 GB (3714.515625 MB free)
  Uptime: 755.0 sec
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
              speed         user         nice          sys         idle          irq
       #1  2593 MHz       7603 s          2 s        146 s       2665 s          0 s
       #2  2593 MHz       2484 s          0 s        150 s       7773 s          0 s
       
  Memory: 6.783603668212891 GB (3694.546875 MB free)
  Uptime: 1046.19 sec
...
| `["filter_sum", "1000", "UnitRange", "noinit", "xf"]`          | 187.445 ns (5%) |         |                 |             |
| `["filter_sum", "1000", "UnitRange", "withinit", "base"]`      | 131.731 ns (5%) |         |                 |             |
| `["filter_sum", "1000", "UnitRange", "withinit", "naive"]`     | 847.826 ns (5%) |         |                 |             |
| `["filter_sum", "1000", "UnitRange", "withinit", "xf"]`        | 129.911 ns (5%) |         |                 |             |
...
| `["findall", "base"]`                                          | 160.102 μs (5%) |         | 797.20 KiB (1%) |           8 |
| `["findall", "xf-array"]`                                      |   1.381 ms (5%) |         |   2.94 MiB (1%) |       96426 |
| `["findall", "xf-iter"]`                                       | 864.011 μs (5%) |         |   1.83 MiB (1%) |          14 |
| `["gemm", "fusedmul", "blas", "16"]`                           |   2.781 ms (5%) |         |                 |             |
| `["gemm", "fusedmul", "blas", "2"]`                            |   2.105 ms (5%) |         |                 |             |
| `["gemm", "fusedmul", "blas", "32"]`                           |   3.393 ms (5%) |         |                 |             |
...
| `["gemm", "mul", "linalg", "256"]`                             | 510.606 μs (5%) |         |                 |             |
| `["gemm", "mul", "linalg", "32"]`                              |   1.580 μs (5%) |         |                 |             |
| `["gemm", "mul", "linalg", "8"]`                               | 226.091 ns (5%) |         |                 |             |
...
| `["gemm", "mul", "xf", "false", "256"]`                        |   2.682 ms (5%) |         |   80 bytes (1%) |           3 |
...
| `["gemm", "mul", "xf", "ivdep", "8"]`                          | 506.223 ns (5%) |         |   80 bytes (1%) |           3 |
...
| `["groupby", "sum", "sac"]`                                    | 144.402 μs (5%) |         |   1.64 KiB (1%) |          11 |
| `["groupby", "sum", "xf-with-init"]`                           | 146.501 μs (5%) |         |   1.05 KiB (1%) |           9 |
| `["groupby", "sum", "xf-without-init"]`                        | 137.601 μs (5%) |         |   1.05 KiB (1%) |           9 |
...
| `["missing_dot", "xf"]`                                        |  96.002 μs (5%) |         |  72.23 KiB (1%) |        3746 |
| `["missing_dot", "xf_nota"]`                                   |  95.401 μs (5%) |         |  71.98 KiB (1%) |        3737 |
| `["overhead", "foldl"]`                                        |   3.700 ns (5%) |         |                 |             |
| `["overhead", "reduce_basecase"]`                              |  97.347 ns (5%) |         |   16 bytes (1%) |           1 |
| `["partition_by", "man"]`                                      |   2.442 ms (5%) |         |  480 bytes (1%) |           3 |
| `["partition_by", "xf"]`                                       |   2.669 ms (5%) |         |  592 bytes (1%) |           5 |
| `["set", "base"]`                                              |   4.307 ms (5%) |         |  49.14 KiB (1%) |          17 |
| `["set", "xf"]`                                                |   4.435 ms (5%) |         |  49.17 KiB (1%) |          19 |
...
| `["teerf_filter", "noinit"]`                                   | 383.668 ns (5%) |         |   80 bytes (1%) |           3 |
...
| `["append!!", "xf"]`                                           |  17.601 μs (5%) |         |  53.98 KiB (1%) |           8 |
...
| `["collect", "identity-union"]`                                | 152.702 μs (5%) |         | 679.41 KiB (1%) |       10010 |
...
| `["filter_sum", "1000", "UnitRange", "withinit", "base"]`      | 132.189 ns (5%) |         |                 |             |
...
| `["findall", "xf-array"]`                                      |   1.410 ms (5%) |         |   2.94 MiB (1%) |       96426 |
| `["findall", "xf-iter"]`                                       | 867.711 μs (5%) |         |   1.83 MiB (1%) |          14 |
