...
| `["filter_sum", "10000", "RandomFloats", "withinit", "naive"]` |                1.58 (5%) :x: |                   1.00 (1%)  |
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
       ...
       #1  2593 MHz       5253 s          1 s        103 s       2114 s          0 s
       #2  2593 MHz       1888 s          1 s        129 s       5454 s          0 s
       
  Memory: 6.783603668212891 GB (3706.7265625 MB free)
  Uptime: 754.14 sec
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
              speed         user         nice          sys         idle          irq
       #1  2593 MHz       5605 s          1 s        127 s       4650 s          0 s
       #2  2593 MHz       4482 s          1 s        165 s       5744 s          0 s
       
  Memory: 6.783603668212891 GB (3651.08984375 MB free)
  Uptime: 1046.39 sec
...
## Job Properties
* Time of benchmark: 22 May 2022 - 2:1
...
| `["filter_sum", "1000", "UnitRange", "noinit", "xf"]`          | 193.857 ns (5%) |         |                 |             |
| `["filter_sum", "1000", "UnitRange", "withinit", "base"]`      | 132.229 ns (5%) |         |                 |             |
| `["filter_sum", "1000", "UnitRange", "withinit", "naive"]`     | 913.158 ns (5%) |         |                 |             |
| `["filter_sum", "1000", "UnitRange", "withinit", "xf"]`        | 136.553 ns (5%) |         |                 |             |
...
| `["findall", "xf-iter"]`                                       | 860.707 μs (5%) |         |   1.83 MiB (1%) |          14 |
...
| `["gemm", "mul", "linalg", "256"]`                             | 531.704 μs (5%) |         |                 |             |
| `["gemm", "mul", "linalg", "32"]`                              |   1.600 μs (5%) |         |                 |             |
| `["gemm", "mul", "linalg", "8"]`                               | 218.184 ns (5%) |         |                 |             |
| `["gemm", "mul", "man", "false", "256"]`                       |   3.152 ms (5%) |         |                 |             |
...
| `["missing_dot", "xf"]`                                        |  98.301 μs (5%) |         |  72.19 KiB (1%) |        3744 |
| `["missing_dot", "xf_nota"]`                                   |  95.500 μs (5%) |         |  72.31 KiB (1%) |        3750 |
| `["overhead", "foldl"]`                                        |   3.300 ns (5%) |         |                 |             |
| `["overhead", "reduce_basecase"]`                              |  97.788 ns (5%) |         |   16 bytes (1%) |           1 |
| `["partition_by", "man"]`                                      |   2.479 ms (5%) |         |  480 bytes (1%) |           3 |
| `["partition_by", "xf"]`                                       |   2.673 ms (5%) |         |  592 bytes (1%) |           5 |
| `["set", "base"]`                                              |   4.306 ms (5%) |         |  49.14 KiB (1%) |          17 |
| `["set", "xf"]`                                                |   4.177 ms (5%) |         |  49.17 KiB (1%) |          19 |
...
| `["teerf_filter", "noinit"]`                                   | 388.557 ns (5%) |         |   80 bytes (1%) |           3 |
...
| `["collect", "identity-union"]`                                | 157.501 μs (5%) |         | 679.41 KiB (1%) |       10010 |
...
| `["filter_sum", "1000", "UnitRange", "withinit", "base"]`      | 131.315 ns (5%) |         |                 |             |
| `["filter_sum", "1000", "UnitRange", "withinit", "naive"]`     | 847.368 ns (5%) |         |                 |             |
| `["filter_sum", "1000", "UnitRange", "withinit", "xf"]`        | 141.149 ns (5%) |         |                 |             |
| `["filter_sum", "10000", "RandomFloats", "noinit", "base"]`    |  30.300 μs (5%) |         |                 |             |
...
| `["filter_sum", "10000", "UnitRange", "withinit", "xf"]`       |   1.230 μs (5%) |         |                 |             |
| `["findall", "base"]`                                          | 157.101 μs (5%) |         | 797.20 KiB (1%) |           8 |
| `["findall", "xf-array"]`                                      |   1.413 ms (5%) |         |   2.94 MiB (1%) |       96426 |
| `["findall", "xf-iter"]`                                       | 859.206 μs (5%) |         |   1.83 MiB (1%) |          14 |
...
| `["gemm", "fusedmul", "xf", "2"]`                              | 673.606 μs (5%) |         |  192 bytes (1%) |           4 |
...
| `["groupby", "sum", "sac"]`                                    |   8.160 ms (5%) |         |  13.12 KiB (1%) |         102 |
...
| `["missing_dot", "xf_nota"]`                                   |  96.900 μs (5%) |         |  72.33 KiB (1%) |        3750 |
| `["overhead", "foldl"]`                                        |   3.300 ns (5%) |         |                 |             |
| `["overhead", "reduce_basecase"]`                              |  97.577 ns (5%) |         |   16 bytes (1%) |           1 |
| `["partition_by", "man"]`                                      |   2.491 ms (5%) |         |  480 bytes (1%) |           3 |
| `["partition_by", "xf"]`                                       |   2.690 ms (5%) |         |  592 bytes (1%) |           5 |
| `["set", "base"]`                                              |   4.350 ms (5%) |         |  49.14 KiB (1%) |          17 |
| `["set", "xf"]`                                                |   4.264 ms (5%) |         |  49.17 KiB (1%) |          19 |
| `["sum_transpose", "30", "noinit", "iter"]`                    |   2.400 μs (5%) |         |                 |             |
...
| `["sum_transpose", "30", "withinit", "man"]`                   |   1.150 μs (5%) |         |                 |             |
| `["sum_transpose", "30", "withinit", "xf"]`                    |   1.230 μs (5%) |         |   48 bytes (1%) |           3 |
| `["teerf_filter", "noinit"]`                                   | 383.085 ns (5%) |         |   80 bytes (1%) |           3 |
