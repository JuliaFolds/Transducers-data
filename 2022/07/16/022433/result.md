...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8370C CPU @ 2.80GHz: 
       ...
       #1  2793 MHz        358 s          2 s        112 s       9060 s          0 s
       #2  2793 MHz       6625 s          1 s        129 s       2807 s          0 s
       
  Memory: 6.783607482910156 GB (3719.890625 MB free)
  Uptime: 961.05 sec
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8370C CPU @ 2.80GHz: 
              speed         user         nice          sys         idle          irq
       #1  2793 MHz       2759 s          2 s        147 s       9434 s          0 s
       #2  2793 MHz       7059 s          1 s        149 s       5160 s          0 s
       
  Memory: 6.783607482910156 GB (3501.5234375 MB free)
  Uptime: 1242.17 sec
...
| `["collect", "identity-union"]`                                | 156.200 μs (5%) |         | 679.41 KiB (1%) |       10010 |
...
| `["filter_map_reduce", "man"]`                                 | 314.200 μs (5%) |         |                 |             |
...
| `["filter_sum", "1000", "UnitRange", "withinit", "base"]`      | 166.933 ns (5%) |         |                 |             |
...
| `["findall", "xf-iter"]`                                       | 723.599 μs (5%) |         |   1.83 MiB (1%) |          14 |
| `["gemm", "fusedmul", "blas", "16"]`                           |   9.415 ms (5%) |         |                 |             |
| `["gemm", "fusedmul", "blas", "2"]`                            |   2.475 ms (5%) |         |                 |             |
| `["gemm", "fusedmul", "blas", "32"]`                           |  17.261 ms (5%) |         |                 |             |
| `["gemm", "fusedmul", "blas", "8"]`                            |   5.538 ms (5%) |         |                 |             |
| `["gemm", "fusedmul", "xf", "16"]`                             |   4.748 ms (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "fusedmul", "xf", "2"]`                              | 591.401 μs (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "fusedmul", "xf", "32"]`                             |   9.488 ms (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "fusedmul", "xf", "8"]`                              |   2.370 ms (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "mul", "linalg", "256"]`                             |   3.936 ms (5%) |         |                 |             |
| `["gemm", "mul", "linalg", "32"]`                              |   8.000 μs (5%) |         |                 |             |
| `["gemm", "mul", "linalg", "8"]`                               | 305.725 ns (5%) |         |                 |             |
| `["gemm", "mul", "man", "false", "256"]`                       |   3.086 ms (5%) |         |                 |             |
| `["gemm", "mul", "man", "false", "32"]`                        |   7.150 μs (5%) |         |                 |             |
| `["gemm", "mul", "man", "false", "8"]`                         | 496.373 ns (5%) |         |                 |             |
| `["gemm", "mul", "man", "ivdep", "256"]`                       |   2.990 ms (5%) |         |                 |             |
| `["gemm", "mul", "man", "ivdep", "32"]`                        |   5.683 μs (5%) |         |                 |             |
| `["gemm", "mul", "man", "ivdep", "8"]`                         | 426.531 ns (5%) |         |                 |             |
| `["gemm", "mul", "man", "true", "256"]`                        |   3.050 ms (5%) |         |                 |             |
...
| `["gemm", "mul", "xf", "false", "8"]`                          | 488.660 ns (5%) |         |   80 bytes (1%) |           3 |
| `["gemm", "mul", "xf", "ivdep", "256"]`                        |   2.983 ms (5%) |         |   80 bytes (1%) |           3 |
| `["gemm", "mul", "xf", "ivdep", "32"]`                         |   5.517 μs (5%) |         |   80 bytes (1%) |           3 |
| `["gemm", "mul", "xf", "ivdep", "8"]`                          | 482.051 ns (5%) |         |   80 bytes (1%) |           3 |
| `["gemm", "mul", "xf", "true", "256"]`                         |   3.042 ms (5%) |         |   80 bytes (1%) |           3 |
| `["gemm", "mul", "xf", "true", "32"]`                          |   6.240 μs (5%) |         |   80 bytes (1%) |           3 |
| `["gemm", "mul", "xf", "true", "8"]`                           | 460.914 ns (5%) |         |   80 bytes (1%) |           3 |
| `["groupby", "sum", "sac"]`                                    | 140.200 μs (5%) |         |   1.64 KiB (1%) |          11 |
| `["groupby", "sum", "xf-with-init"]`                           | 135.699 μs (5%) |         |   1.05 KiB (1%) |           9 |
| `["groupby", "sum", "xf-without-init"]`                        | 134.300 μs (5%) |         |   1.05 KiB (1%) |           9 |
...
| `["missing_dot", "xf"]`                                        |  92.200 μs (5%) |         |  72.25 KiB (1%) |        3746 |
| `["missing_dot", "xf_nota"]`                                   |  94.200 μs (5%) |         |  72.30 KiB (1%) |        3750 |
| `["overhead", "foldl"]`                                        |   3.599 ns (5%) |         |                 |             |
| `["overhead", "reduce_basecase"]`                              |  96.523 ns (5%) |         |   16 bytes (1%) |           1 |
...
| `["filter_sum", "1000", "RandomFloats", "withinit", "naive"]`  | 914.118 ns (5%) |         |                 |             |
...
| `["findall", "xf-iter"]`                                       | 722.000 μs (5%) |         |   1.83 MiB (1%) |          14 |
...
| `["gemm", "fusedmul", "xf", "2"]`                              | 601.400 μs (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "fusedmul", "xf", "32"]`                             |   9.535 ms (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "fusedmul", "xf", "8"]`                              |   2.378 ms (5%) |         |  192 bytes (1%) |           4 |
...
| `["groupby", "sum", "sac"]`                                    |   7.305 ms (5%) |         |  13.16 KiB (1%) |         103 |
...
| `["missing_dot", "xf"]`                                        |  91.600 μs (5%) |         |  72.20 KiB (1%) |        3746 |
| `["missing_dot", "xf_nota"]`                                   |  91.600 μs (5%) |         |  72.11 KiB (1%) |        3741 |
| `["overhead", "foldl"]`                                        |   3.600 ns (5%) |         |                 |             |
| `["overhead", "reduce_basecase"]`                              |  96.312 ns (5%) |         |   16 bytes (1%) |           1 |
