...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
       ...
       #1  2593 MHz       6249 s        188 s        165 s       1084 s          0 s
       #2  2593 MHz        879 s       1259 s        192 s       5319 s          0 s
       
  Memory: 6.780967712402344 GB (1145.15625 MB free)
  Uptime: 773.81 sec
  Load Avg:  1.25  1.28  0.87
  WORD_SIZE: 64
  LIBM: libopenlibm
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
              speed         user         nice          sys         idle          irq
       #1  2593 MHz       8887 s        215 s        215 s       1190 s          0 s
       #2  2593 MHz       1084 s       1754 s        271 s       7150 s          0 s
       
  Memory: 6.780967712402344 GB (1177.875 MB free)
  Uptime: 1057.05 sec
  Load Avg:  1.17  1.32  1.01
  WORD_SIZE: 64
  LIBM: libopenlibm
  LLVM: libLLVM-12.0.1 (ORCJIT, skylake-avx512)
```
...
| `["collect", "identity-union"]`                                | 146.202 μs (5%) |         | 679.41 KiB (1%) |       10010 |
...
| `["filter_sum", "1000", "UnitRange", "noinit", "xf"]`          | 187.349 ns (5%) |         |                 |             |
| `["filter_sum", "1000", "UnitRange", "withinit", "base"]`      | 129.387 ns (5%) |         |                 |             |
| `["filter_sum", "1000", "UnitRange", "withinit", "naive"]`     | 847.826 ns (5%) |         |                 |             |
| `["filter_sum", "1000", "UnitRange", "withinit", "xf"]`        | 138.230 ns (5%) |         |                 |             |
...
| `["findall", "xf-iter"]`                                       | 849.611 μs (5%) |         |   1.83 MiB (1%) |          14 |
| `["gemm", "fusedmul", "blas", "16"]`                           |   2.757 ms (5%) |         |                 |             |
...
| `["gemm", "mul", "xf", "ivdep", "8"]`                          | 502.078 ns (5%) |         |   80 bytes (1%) |           3 |
...
| `["groupby", "sum", "sac"]`                                    | 144.102 μs (5%) |         |   1.64 KiB (1%) |          11 |
...
| `["teerf_filter", "noinit"]`                                   | 378.054 ns (5%) |         |   80 bytes (1%) |           3 |
...
| `["cartesian", "copyto!", "iter"]`                             |   4.050 μs (5%) |         |                 |             |
...
| `["collect", "identity-union"]`                                | 148.502 μs (5%) |         | 679.41 KiB (1%) |       10010 |
...
| `["filter_sum", "1000", "UnitRange", "withinit", "base"]`      | 130.981 ns (5%) |         |                 |             |
| `["filter_sum", "1000", "UnitRange", "withinit", "naive"]`     | 847.826 ns (5%) |         |                 |             |
| `["filter_sum", "1000", "UnitRange", "withinit", "xf"]`        | 138.346 ns (5%) |         |                 |             |
| `["filter_sum", "10000", "RandomFloats", "noinit", "base"]`    |  30.300 μs (5%) |         |                 |             |
...
| `["findall", "base"]`                                          | 136.402 μs (5%) |         | 797.20 KiB (1%) |           8 |
| `["findall", "xf-array"]`                                      |   1.287 ms (5%) |         |   2.94 MiB (1%) |       96426 |
| `["findall", "xf-iter"]`                                       | 845.611 μs (5%) |         |   1.83 MiB (1%) |          14 |
| `["gemm", "fusedmul", "blas", "16"]`                           |   2.743 ms (5%) |         |                 |             |
| `["gemm", "fusedmul", "blas", "2"]`                            |   2.072 ms (5%) |         |                 |             |
| `["gemm", "fusedmul", "blas", "32"]`                           |   3.379 ms (5%) |         |                 |             |
| `["gemm", "fusedmul", "blas", "8"]`                            |   2.200 ms (5%) |         |                 |             |
| `["gemm", "fusedmul", "xf", "16"]`                             |   5.249 ms (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "fusedmul", "xf", "2"]`                              | 663.808 μs (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "fusedmul", "xf", "32"]`                             |  10.514 ms (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "fusedmul", "xf", "8"]`                              |   2.620 ms (5%) |         |  192 bytes (1%) |           4 |
| `["gemm", "mul", "linalg", "256"]`                             | 509.206 μs (5%) |         |                 |             |
...
| `["groupby", "sum", "sac"]`                                    |   8.295 ms (5%) |         |  13.12 KiB (1%) |         102 |
| `["groupby", "sum", "xf-with-init"]`                           | 150.101 μs (5%) |         |   1.05 KiB (1%) |           9 |
...
| `["missing_dot", "xf"]`                                        |  96.101 μs (5%) |         |  72.27 KiB (1%) |        3745 |
| `["missing_dot", "xf_nota"]`                                   |  96.902 μs (5%) |         |  72.31 KiB (1%) |        3750 |
| `["overhead", "foldl"]`                                        |   3.700 ns (5%) |         |                 |             |
| `["overhead", "reduce_basecase"]`                              | 103.937 ns (5%) |         |   16 bytes (1%) |           1 |
| `["partition_by", "man"]`                                      |   2.488 ms (5%) |         |  480 bytes (1%) |           3 |
| `["partition_by", "xf"]`                                       |   2.711 ms (5%) |         |  592 bytes (1%) |           5 |
| `["set", "base"]`                                              |   4.184 ms (5%) |         |  49.14 KiB (1%) |          17 |
| `["set", "xf"]`                                                |   4.079 ms (5%) |         |  49.17 KiB (1%) |          19 |
| `["sum_transpose", "30", "noinit", "iter"]`                    |   2.400 μs (5%) |         |                 |             |
| `["sum_transpose", "30", "noinit", "man"]`                     |   2.833 μs (5%) |         |                 |             |
| `["sum_transpose", "30", "noinit", "xf"]`                      |   1.220 μs (5%) |         |   32 bytes (1%) |           2 |
...
| `["sum_transpose", "30", "withinit", "man"]`                   |   1.150 μs (5%) |         |                 |             |
| `["sum_transpose", "30", "withinit", "xf"]`                    |   1.230 μs (5%) |         |   48 bytes (1%) |           3 |
| `["teerf_filter", "noinit"]`                                   | 390.737 ns (5%) |         |   80 bytes (1%) |           3 |
